...
pub fn x00401000(m: &mut Machine) -> Cont {
    ...
    m.cpu.regs.esp = sub(m.cpu.regs.esp, 0x408u32, &mut m.cpu.flags);
...
pub fn x0040101e(m: &mut Machine) -> Cont {
    ...
    m.cpu.regs.ebp = m.cpu.regs.esi;
    // 00401022 push dword ptr [esi+8]
    push(m, m.memory.read::<u32>(m.cpu.regs.esi.wrapping_add(0x8u32)));
...
pub fn x0040102b(m: &mut Machine) -> Cont {
    ...
    m.memory.write::<u32>(m.cpu.regs.esp, m.cpu.regs.eax);
    // 0040102e mov dword ptr [esp+404h],0
    m.memory
        .write::<u32>(m.cpu.regs.esp.wrapping_add(0x404u32), 0x0u32);
    // 00401039 mov eax,0FFFFFFF6h
    m.cpu.regs.eax = 0xfffffff6u32;
    // 0040103e mov cl,[eax+402112h]
    m.cpu.regs.set_cl(
        m.memory
            .read::<u8>(m.cpu.regs.eax.wrapping_add(0x402112u32)),
    );
    // 00401044 mov edx,[esp+404h]
    m.cpu.regs.edx = m.memory.read::<u32>(m.cpu.regs.esp.wrapping_add(0x404u32));
    // 0040104b lea esi,[edx+1]
    m.cpu.regs.esi = m.cpu.regs.edx.wrapping_add(0x1u32);
    // 0040104e mov [esp+404h],esi
    m.memory
        .write::<u32>(m.cpu.regs.esp.wrapping_add(0x404u32), m.cpu.regs.esi);
...
pub fn x0040105c(m: &mut Machine) -> Cont {
    ...
    m.cpu.regs.ecx = m.cpu.regs.esp.wrapping_add(0x4u32);
...
pub fn x00401067(m: &mut Machine) -> Cont {
    ...
    m.cpu.regs.eax = 0xfffffffau32;
    // 0040106c mov cl,[eax+402107h]
    m.cpu.regs.set_cl(
        m.memory
            .read::<u8>(m.cpu.regs.eax.wrapping_add(0x402107u32)),
    );
...
pub fn x0040108a(m: &mut Machine) -> Cont {
    ...
    m.cpu.regs.eax = m.memory.read::<u32>(m.cpu.regs.ebp);
...
pub fn x00401092(m: &mut Machine) -> Cont {
    ...
    m.cpu.regs.edi = m.cpu.regs.edi.wrapping_add(0x1u32);
    // 004010a2 lea edx,[edx+1]
    m.cpu.regs.edx = m.cpu.regs.edx.wrapping_add(0x1u32);
...
pub fn x004010a7(m: &mut Machine) -> Cont {
    ...
    m.cpu.regs.esi = m.memory.read::<u32>(m.cpu.regs.esp.wrapping_add(0x404u32));
    // 004010b0 lea edi,[esi+1]
    m.cpu.regs.edi = m.cpu.regs.esi.wrapping_add(0x1u32);
    // 004010b3 mov [esp+404h],edi
    m.memory
        .write::<u32>(m.cpu.regs.esp.wrapping_add(0x404u32), m.cpu.regs.edi);
...
pub fn x004010c2(m: &mut Machine) -> Cont {
    ...
    m.cpu.regs.eax = 0xfffffffbu32;
    // 004010c7 mov cl,[eax+4020FCh]
    m.cpu.regs.set_cl(
        m.memory
            .read::<u8>(m.cpu.regs.eax.wrapping_add(0x4020fcu32)),
    );
...
pub fn x004010e5(m: &mut Machine) -> Cont {
    ...
    m.cpu.regs.edx = m.memory.read::<u32>(m.cpu.regs.esp);
...
pub fn x004010f1(m: &mut Machine) -> Cont {
    ...
    m.cpu.regs.set_cl(
        m.memory
            .read::<u8>(m.cpu.regs.eax.wrapping_add(0x402100u32)),
    );
...
pub fn x00401114(m: &mut Machine) -> Cont {
    ...
    m.cpu.regs.edi = m.cpu.regs.esp.wrapping_add(0x4u32);
...
pub fn x00401121(m: &mut Machine) -> Cont {
    ...
    m.cpu.regs.eax = m.memory.read::<u32>(m.cpu.regs.esp.wrapping_add(0x404u32));
    // 00401128 lea ecx,[eax+1]
    m.cpu.regs.ecx = m.cpu.regs.eax.wrapping_add(0x1u32);
    // 0040112b mov [esp+404h],ecx
    m.memory
        .write::<u32>(m.cpu.regs.esp.wrapping_add(0x404u32), m.cpu.regs.ecx);
...
pub fn x00401153(m: &mut Machine) -> Cont {
    ...
    m.cpu.regs.eax = 0x3e8u32;
    // 00401158 xor edx,edx
    m.cpu.regs.edx = xor(m.cpu.regs.edx, m.cpu.regs.edx, &mut m.cpu.flags);
    // 0040115a mov esi,ebp
    m.cpu.regs.esi = m.cpu.regs.ebp;
    // 0040115c idiv dword ptr [ebp+4]
    let x = (((m.cpu.regs.edx as u64) << 32) | (m.cpu.regs.eax as u64)) as i64;
    let y = m.memory.read::<u32>(m.cpu.regs.ebp.wrapping_add(0x4u32)) as i64;
    m.cpu.regs.eax = (x / y) as i32 as u32;
    m.cpu.regs.edx = (x % y) as i32 as u32;
    // 0040115f push eax
    push(m, m.cpu.regs.eax);
...
pub fn x00401166(m: &mut Machine) -> Cont {
    ...
    sub(
        m.cpu.regs.ebx,
        m.memory.read::<u32>(m.cpu.regs.ebp.wrapping_add(0x4u32)),
        &mut m.cpu.flags,
    );
...
pub fn x00401181(m: &mut Machine) -> Cont {
    ...
    m.cpu.regs.ebp = m.cpu.regs.edx.wrapping_add(0x1u32);
    // 004011a3 mov [esp+404h],ebp
    m.memory
        .write::<u32>(m.cpu.regs.esp.wrapping_add(0x404u32), m.cpu.regs.ebp);
...
pub fn x004011bc(m: &mut Machine) -> Cont {
    ...
    m.cpu.regs.ebx = m.cpu.regs.edx.wrapping_add(0x1u32);
    // 004011d1 mov [esp+404h],ebx
    m.memory
        .write::<u32>(m.cpu.regs.esp.wrapping_add(0x404u32), m.cpu.regs.ebx);
...
pub fn x004011e6(m: &mut Machine) -> Cont {
    ...
    m.cpu.regs.ecx = m.cpu.regs.ecx.wrapping_add(0x1u32);
...
pub fn x004011f3(m: &mut Machine) -> Cont {
    ...
    m.cpu.regs.ebp = m.cpu.regs.esi.wrapping_add(0x1u32);
...
pub fn x00401237(m: &mut Machine) -> Cont {
    ...
    m.cpu.regs.esi = m.cpu.regs.esp.wrapping_add(0x4u32);
...
pub fn x00401244(m: &mut Machine) -> Cont {
    ...
    m.cpu.regs.set_cl(
        m.memory
            .read::<u8>(m.cpu.regs.eax.wrapping_add(0x4020eau32)),
    );
    // 0040124f mov edx,[esp+404h]
    m.cpu.regs.edx = m.memory.read::<u32>(m.cpu.regs.esp.wrapping_add(0x404u32));
    // 00401256 lea edi,[edx+1]
    m.cpu.regs.edi = m.cpu.regs.edx.wrapping_add(0x1u32);
...
pub fn x00401267(m: &mut Machine) -> Cont {
    ...
    m.cpu.regs.edi = m.memory.read::<u32>(m.cpu.regs.esp.wrapping_add(0x404u32));
...
pub fn x00401299(m: &mut Machine) -> Cont {
    ...
    m.cpu.regs.esp = add(m.cpu.regs.esp, 0x408u32, &mut m.cpu.flags);
    // 0040129f pop esi
...
pub fn x004012ae(m: &mut Machine) -> Cont {
    ...
    m.cpu.regs.eax = m.memory.read::<u32>(m.cpu.regs.ecx.wrapping_add(0x400u32));
    // 004012b4 lea edx,[eax+1]
    m.cpu.regs.edx = m.cpu.regs.eax.wrapping_add(0x1u32);
    // 004012b7 mov [ecx+400h],edx
    m.memory
        .write::<u32>(m.cpu.regs.ecx.wrapping_add(0x400u32), m.cpu.regs.edx);
    // 004012bd mov byte ptr [ecx+eax],2Dh
    m.memory
        .write::<u8>(m.cpu.regs.ecx.wrapping_add(m.cpu.regs.eax), 0x2du8);
    // 004012c1 neg esi
    m.cpu.regs.esi = neg(m.cpu.regs.esi, &mut m.cpu.flags);
    // 004012c3 mov edi,[ecx+400h]
    m.cpu.regs.edi = m.memory.read::<u32>(m.cpu.regs.ecx.wrapping_add(0x400u32));
    // 004012c9 mov eax,esi
    m.cpu.regs.eax = m.cpu.regs.esi;
    // 004012cb mov edx,0CCCCCCCDh
    m.cpu.regs.edx = 0xcccccccdu32;
    // 004012d0 mul edx
    todo!();
    // 004012d2 shr edx,3
    m.cpu.regs.edx = shr(m.cpu.regs.edx, 0x3u8, &mut m.cpu.flags);
    // 004012d5 lea eax,[edx+edx]
    m.cpu.regs.eax = m.cpu.regs.edx.wrapping_add(m.cpu.regs.edx);
    // 004012d8 lea ebp,[eax+eax*4]
    m.cpu.regs.ebp = m.cpu.regs.eax.wrapping_add((m.cpu.regs.eax * 4));
    // 004012db mov eax,esi
    m.cpu.regs.eax = m.cpu.regs.esi;
    // 004012dd sub eax,ebp
    m.cpu.regs.eax = sub(m.cpu.regs.eax, m.cpu.regs.ebp, &mut m.cpu.flags);
    // 004012df or al,30h
    m.cpu
        .regs
        .set_al(or(m.cpu.regs.get_al(), 0x30u8, &mut m.cpu.flags));
    // 004012e1 mov ebp,[ecx+400h]
    m.cpu.regs.ebp = m.memory.read::<u32>(m.cpu.regs.ecx.wrapping_add(0x400u32));
    // 004012e7 lea ebx,[ebp+1]
    m.cpu.regs.ebx = m.cpu.regs.ebp.wrapping_add(0x1u32);
    // 004012ea mov [ecx+400h],ebx
    m.memory
        .write::<u32>(m.cpu.regs.ecx.wrapping_add(0x400u32), m.cpu.regs.ebx);
    // 004012f0 mov [ecx+ebp],al
    m.memory.write::<u8>(
        m.cpu.regs.ecx.wrapping_add(m.cpu.regs.ebp),
        m.cpu.regs.get_al(),
    );
    // 004012f3 cmp esi,9
    sub(m.cpu.regs.esi, 0x9u32, &mut m.cpu.flags);
...
pub fn x00401305(m: &mut Machine) -> Cont {
    ...
    m.cpu.regs.set_dh(
        m.memory
            .read::<u8>(m.cpu.regs.ecx.wrapping_add(m.cpu.regs.eax)),
    );
    ...
    m.memory.write::<u8>(
        m.cpu.regs.ecx.wrapping_add(m.cpu.regs.eax),
        m.cpu.regs.get_dl(),
    );
    // 00401314 inc edi
    m.cpu.regs.edi = inc(m.cpu.regs.edi, &mut m.cpu.flags);
    // 00401315 lea edx,[eax-1]
    m.cpu.regs.edx = m.cpu.regs.eax.wrapping_add(0xffffffffu32);
...
pub fn x004013e8(m: &mut Machine) -> Cont {
    ...
    m.cpu.regs.edi = m.memory.read::<u32>(0x402184u32);
    // 004013f6 push ebx
    push(m, m.cpu.regs.ebx);
    // 004013f7 push ebx
    push(m, m.cpu.regs.ebx);
...
pub fn x00401417(m: &mut Machine) -> Cont {
    ...
    m.memory.write::<u32>(m.cpu.regs.eax, 0x4020ebu32);
    // 00401421 mov dword ptr [eax+4],5
    m.memory
        .write::<u32>(m.cpu.regs.eax.wrapping_add(0x4u32), 0x5u32);
    // 00401428 mov [eax+8],esi
    m.memory
        .write::<u32>(m.cpu.regs.eax.wrapping_add(0x8u32), m.cpu.regs.esi);
    // 0040142b push ebx
    push(m, m.cpu.regs.ebx);
    // 0040142c push ebx
    push(m, m.cpu.regs.ebx);
...
pub fn x0040143b(m: &mut Machine) -> Cont {
    ...
    m.cpu.regs.ecx = m.cpu.regs.esp;
    // 0040143d mov dword ptr [ecx],4020C0h
    m.memory.write::<u32>(m.cpu.regs.ecx, 0x4020c0u32);
    // 00401443 mov dword ptr [ecx+4],0Ah
    m.memory
        .write::<u32>(m.cpu.regs.ecx.wrapping_add(0x4u32), 0xau32);
