...
pub fn x00401040(m: &mut Machine) -> Cont {
    ...
    m.cpu.regs.ecx = m.memory.read::<u32>(m.cpu.regs.esp.wrapping_add(0x10u32));
    // 00401044 mov eax,[esp+4]
    m.cpu.regs.eax = m.memory.read::<u32>(m.cpu.regs.esp.wrapping_add(0x4u32));
    // 00401048 sub esp,1Ch
    m.cpu.regs.esp = sub(m.cpu.regs.esp, 0x1cu32, &mut m.cpu.flags);
    // 0040104b mov ds:[40957Ch],eax
    m.memory.write::<u32>(0x40957cu32, m.cpu.regs.eax);
    // 00401050 push ecx
...
pub fn x00401056(m: &mut Machine) -> Cont {
    // 00401056 add esp,4
    m.cpu.regs.esp = add(m.cpu.regs.esp, 0x4u32, &mut m.cpu.flags);
    // 00401059 mov ds:[409580h],eax
    m.memory.write::<u32>(0x409580u32, m.cpu.regs.eax);
    // 0040105e test eax,eax
    and(m.cpu.regs.eax, m.cpu.regs.eax, &mut m.cpu.flags);
...
pub fn x00401062(m: &mut Machine) -> Cont {
    ...
    m.cpu.regs.eax = or(m.cpu.regs.eax, 0xffffffffu32, &mut m.cpu.flags);
    // 00401065 add esp,1Ch
    m.cpu.regs.esp = add(m.cpu.regs.esp, 0x1cu32, &mut m.cpu.flags);
    // 00401068 ret 10h
    ret(m, 16)
}
...
pub fn x00401079(m: &mut Machine) -> Cont {
    ...
    m.cpu.regs.edx = m.memory.read::<u32>(0x409580u32);
    // 0040107f push 30h
    push(m, 0x30u32);
...
pub fn x00401092(m: &mut Machine) -> Cont {
    ...
    m.cpu.regs.eax = xor(m.cpu.regs.eax, m.cpu.regs.eax, &mut m.cpu.flags);
...
pub fn x0040109a(m: &mut Machine) -> Cont {
    ...
    m.cpu.regs.eax = m.memory.read::<u32>(0x409584u32);
    // 0040109f push ebx
...
pub fn x004010b9(m: &mut Machine) -> Cont {
    ...
    m.cpu.regs.ecx = m.memory.read::<u32>(0x40957cu32);
    // 004010bf push 118h
    push(m, 0x118u32);
    // 004010c4 push 5DCh
    push(m, 0x5dcu32);
...
pub fn x004010da(m: &mut Machine) -> Cont {
    ...
    m.cpu.regs.esi = m.memory.read::<u32>(0x4060d4u32);
    // 004010e0 mov edi,ds:[4060D0h]
    m.cpu.regs.edi = m.memory.read::<u32>(0x4060d0u32);
    // 004010e6 mov ebx,ds:[4060CCh]
    m.cpu.regs.ebx = m.memory.read::<u32>(0x4060ccu32);
    // 004010ec push 1
    push(m, 0x1u32);
    // 004010ee push 0
    push(m, 0x0u32);
    ...
    m.cpu.regs.edx = m.cpu.regs.esp.wrapping_add(0x18u32);
    // 004010f6 push 0
    push(m, 0x0u32);
    // 004010f8 push edx
    push(m, m.cpu.regs.edx);
    // 004010f9 call esi
    let dst = indirect(m, m.cpu.regs.esi);
    call(m, 0x4010fb, dst)
}
...
pub fn x004010ff(m: &mut Machine) -> Cont {
    ...
    sub(
        m.memory.read::<u32>(m.cpu.regs.esp.wrapping_add(0x10u32)),
        0x12u32,
        &mut m.cpu.flags,
    );
...
pub fn x00401106(m: &mut Machine) -> Cont {
    ...
    m.cpu.regs.eax = m.cpu.regs.esp.wrapping_add(0xcu32);
    // 0040110a push eax
    push(m, m.cpu.regs.eax);
    // 0040110b call edi
    let dst = indirect(m, m.cpu.regs.edi);
    call(m, 0x40110d, dst)
}
...
pub fn x0040110d(m: &mut Machine) -> Cont {
    ...
    m.cpu.regs.ecx = m.cpu.regs.esp.wrapping_add(0xcu32);
    // 00401111 push ecx
    push(m, m.cpu.regs.ecx);
    // 00401112 call ebx
    let dst = indirect(m, m.cpu.regs.ebx);
    call(m, 0x401114, dst)
}
...
pub fn x00401130(m: &mut Machine) -> Cont {
    ...
    m.cpu.regs.edi = m.memory.read::<u32>(0x406080u32);
    // 00401137 call edi
    let dst = indirect(m, m.cpu.regs.edi);
    call(m, 0x401139, dst)
}
...
pub fn x00401139(m: &mut Machine) -> Cont {
    ...
    m.cpu.regs.eax = sub(
        m.cpu.regs.eax,
        m.memory.read::<u32>(0x409548u32),
        &mut m.cpu.flags,
    );
    // 0040113f cmp eax,32h
    sub(m.cpu.regs.eax, 0x32u32, &mut m.cpu.flags);
...
pub fn x00401148(m: &mut Machine) -> Cont {
    ...
    m.cpu.regs.eax = m.memory.read::<u32>(0x409594u32);
    // 0040114d mov ecx,ds:[409590h]
    m.cpu.regs.ecx = m.memory.read::<u32>(0x409590u32);
    // 00401153 mov edx,ds:[40958Ch]
    m.cpu.regs.edx = m.memory.read::<u32>(0x40958cu32);
    // 00401159 push 8Ch
    push(m, 0x8cu32);
    // 0040115e push 96h
    push(m, 0x96u32);
...
pub fn x0040117a(m: &mut Machine) -> Cont {
    ...
    m.cpu.regs.eax = m.memory.read::<u32>(0x409588u32);
    // 0040117f push 0
    push(m, 0x0u32);
    // 00401181 push 0
    push(m, 0x0u32);
    ...
    m.cpu.regs.ecx = m.memory.read::<u32>(m.cpu.regs.eax);
    // 00401186 call dword ptr [ecx+2Ch]
    let dst = indirect(m, m.memory.read(m.cpu.regs.ecx.wrapping_add(0x2cu32)));
    call(m, 0x401189, dst)
}
...
pub fn x0040118d(m: &mut Machine) -> Cont {
    ...
    sub(m.cpu.regs.eax, 0x887601c2u32, &mut m.cpu.flags);
...
pub fn x00401194(m: &mut Machine) -> Cont {
    ...
    sub(m.cpu.regs.eax, 0x8876021cu32, &mut m.cpu.flags);
...
pub fn x0040119d(m: &mut Machine) -> Cont {
    ...
    m.cpu.regs.edx = m.memory.read::<u32>(m.cpu.regs.eax);
    // 004011a5 call dword ptr [edx+6Ch]
    let dst = indirect(m, m.memory.read(m.cpu.regs.edx.wrapping_add(0x6cu32)));
    call(m, 0x4011a8, dst)
}
...
pub fn x004011a8(m: &mut Machine) -> Cont {
    ...
    m.cpu.regs.eax = m.memory.read::<u32>(0x409590u32);
    // 004011ad add eax,96h
    m.cpu.regs.eax = add(m.cpu.regs.eax, 0x96u32, &mut m.cpu.flags);
    // 004011b2 cmp eax,5DCh
    sub(m.cpu.regs.eax, 0x5dcu32, &mut m.cpu.flags);
    // 004011b7 mov ds:[409590h],eax
    m.memory.write::<u32>(0x409590u32, m.cpu.regs.eax);
...
pub fn x004011be(m: &mut Machine) -> Cont {
    ...
    m.memory.write::<u32>(0x409590u32, 0x0u32);
    // 004011cd add eax,8Ch
    m.cpu.regs.eax = add(m.cpu.regs.eax, 0x8cu32, &mut m.cpu.flags);
    // 004011d2 cmp eax,118h
    sub(m.cpu.regs.eax, 0x118u32, &mut m.cpu.flags);
    // 004011d7 mov ds:[409594h],eax
    m.memory.write::<u32>(0x409594u32, m.cpu.regs.eax);
...
pub fn x004011ea(m: &mut Machine) -> Cont {
    ...
    m.memory.write::<u32>(0x409548u32, m.cpu.regs.eax);
    // 004011ef pop edi
    m.cpu.regs.edi = pop(m);
    // 004011f0 ret
    ret(m, 0)
...
pub fn x00401200(m: &mut Machine) -> Cont {
    ...
    m.cpu.regs.esp = sub(m.cpu.regs.esp, 0x28u32, &mut m.cpu.flags);
    // 00401203 mov eax,ds:[40957Ch]
    m.cpu.regs.eax = m.memory.read::<u32>(0x40957cu32);
    // 00401208 push esi
    push(m, m.cpu.regs.esi);
    // 00401209 push 7F00h
    push(m, 0x7f00u32);
    ...
    m.memory
        .write::<u32>(m.cpu.regs.esp.wrapping_add(0xcu32), 0x3u32);
    // 00401217 mov dword ptr [esp+10h],4012D0h
    m.memory
        .write::<u32>(m.cpu.regs.esp.wrapping_add(0x10u32), 0x4012d0u32);
    // 0040121f mov dword ptr [esp+14h],0
    m.memory
        .write::<u32>(m.cpu.regs.esp.wrapping_add(0x14u32), 0x0u32);
    // 00401227 mov dword ptr [esp+18h],0
    m.memory
        .write::<u32>(m.cpu.regs.esp.wrapping_add(0x18u32), 0x0u32);
    // 0040122f mov [esp+1Ch],eax
    m.memory
        .write::<u32>(m.cpu.regs.esp.wrapping_add(0x1cu32), m.cpu.regs.eax);
...
pub fn x00401239(m: &mut Machine) -> Cont {
    ...
    m.memory
        .write::<u32>(m.cpu.regs.esp.wrapping_add(0x20u32), m.cpu.regs.eax);
...
pub fn x00401256(m: &mut Machine) -> Cont {
    ...
    m.cpu.regs.eax = m.cpu.regs.esp.wrapping_add(0x4u32);
    // 0040125e push eax
    push(m, m.cpu.regs.eax);
    // 0040125f mov dword ptr [esp+28h],409598h
    m.memory
        .write::<u32>(m.cpu.regs.esp.wrapping_add(0x28u32), 0x409598u32);
    // 00401267 mov dword ptr [esp+2Ch],4070A4h
    m.memory
        .write::<u32>(m.cpu.regs.esp.wrapping_add(0x2cu32), 0x4070a4u32);
...
pub fn x00401275(m: &mut Machine) -> Cont {
    ...
    m.cpu.regs.esi = m.memory.read::<u32>(0x4060ecu32);
    // 00401281 push 0
    push(m, 0x0u32);
    // 00401283 push ecx
    push(m, m.cpu.regs.ecx);
...
pub fn x004012ad(m: &mut Machine) -> Cont {
    ...
    m.cpu.regs.edx = m.memory.read::<u32>(m.cpu.regs.esp.wrapping_add(0x30u32));
    // 004012b1 mov esi,eax
    m.cpu.regs.esi = m.cpu.regs.eax;
    // 004012b3 push edx
    push(m, m.cpu.regs.edx);
    // 004012b4 push esi
    push(m, m.cpu.regs.esi);
...
pub fn x004012c9(m: &mut Machine) -> Cont {
    ...
    m.cpu.regs.eax = m.cpu.regs.esi;
    // 004012cb pop esi
    m.cpu.regs.esi = pop(m);
    // 004012cc add esp,28h
    m.cpu.regs.esp = add(m.cpu.regs.esp, 0x28u32, &mut m.cpu.flags);
    // 004012cf ret
    ret(m, 0)
}
...
pub fn x00401310(m: &mut Machine) -> Cont {
    ...
    m.cpu.regs.esp = sub(m.cpu.regs.esp, 0x8cu32, &mut m.cpu.flags);
    // 00401316 push 0
    push(m, 0x0u32);
...
pub fn x0040132d(m: &mut Machine) -> Cont {
    ...
    m.cpu.regs.esp = add(m.cpu.regs.esp, 0x8cu32, &mut m.cpu.flags);
    // 00401336 ret
    ret(m, 0)
}
...
pub fn x00401337(m: &mut Machine) -> Cont {
    ...
    let dst = indirect(m, m.memory.read(m.cpu.regs.ecx.wrapping_add(0x50u32)));
    call(m, 0x40134b, dst)
}
...
pub fn x0040135b(m: &mut Machine) -> Cont {
    ...
    let dst = indirect(m, m.memory.read(m.cpu.regs.ecx.wrapping_add(0x54u32)));
    call(m, 0x401376, dst)
}
...
pub fn x00401386(m: &mut Machine) -> Cont {
    ...
    m.cpu.regs.ecx = 0x1fu32;
    // 0040138c xor eax,eax
    m.cpu.regs.eax = xor(m.cpu.regs.eax, m.cpu.regs.eax, &mut m.cpu.flags);
    // 0040138e lea edi,[esp+14h]
    m.cpu.regs.edi = m.cpu.regs.esp.wrapping_add(0x14u32);
    // 00401392 rep stosd
    rep(m, Rep::REP, stosd);
    ...
    m.cpu.regs.ecx = m.cpu.regs.esp.wrapping_add(0x18u32);
    // 0040139f mov dword ptr [esp+18h],7Ch
    m.memory
        .write::<u32>(m.cpu.regs.esp.wrapping_add(0x18u32), 0x7cu32);
    // 004013a7 mov dword ptr [esp+1Ch],21h
    m.memory
        .write::<u32>(m.cpu.regs.esp.wrapping_add(0x1cu32), 0x21u32);
    // 004013af mov dword ptr [esp+80h],218h
    m.memory
        .write::<u32>(m.cpu.regs.esp.wrapping_add(0x80u32), 0x218u32);
    // 004013ba mov dword ptr [esp+2Ch],1
    m.memory
        .write::<u32>(m.cpu.regs.esp.wrapping_add(0x2cu32), 0x1u32);
    ...
    let dst = indirect(m, m.memory.read(m.cpu.regs.edx.wrapping_add(0x18u32)));
    call(m, 0x4013ce, dst)
}
...
pub fn x004013dd(m: &mut Machine) -> Cont {
    ...
    m.cpu.regs.edx = xor(m.cpu.regs.edx, m.cpu.regs.edx, &mut m.cpu.flags);
    // 004013df mov eax,ds:[409588h]
    m.cpu.regs.eax = m.memory.read::<u32>(0x409588u32);
    // 004013e4 mov [esp],edx
    m.memory.write::<u32>(m.cpu.regs.esp, m.cpu.regs.edx);
    // 004013e8 mov dword ptr [esp],4
    m.memory.write::<u32>(m.cpu.regs.esp, 0x4u32);
    // 004013f0 mov [esp+4],edx
    m.memory
        .write::<u32>(m.cpu.regs.esp.wrapping_add(0x4u32), m.cpu.regs.edx);
    // 004013f4 push 40958Ch
    push(m, 0x40958cu32);
    // 004013f9 mov [esp+0Ch],edx
    m.memory
        .write::<u32>(m.cpu.regs.esp.wrapping_add(0xcu32), m.cpu.regs.edx);
    // 004013fd mov [esp+10h],edx
    m.memory
        .write::<u32>(m.cpu.regs.esp.wrapping_add(0x10u32), m.cpu.regs.edx);
    // 00401401 mov ecx,[eax]
    m.cpu.regs.ecx = m.memory.read::<u32>(m.cpu.regs.eax);
    // 00401403 lea edx,[esp+4]
    m.cpu.regs.edx = m.cpu.regs.esp.wrapping_add(0x4u32);
    // 00401407 push edx
    push(m, m.cpu.regs.edx);
    // 00401408 push eax
    push(m, m.cpu.regs.eax);
    // 00401409 call dword ptr [ecx+30h]
    let dst = indirect(m, m.memory.read(m.cpu.regs.ecx.wrapping_add(0x30u32)));
    call(m, 0x40140c, dst)
}
...
pub fn x0040140c(m: &mut Machine) -> Cont {
    // 0040140c neg eax
    m.cpu.regs.eax = neg(m.cpu.regs.eax, &mut m.cpu.flags);
    // 0040140e sbb eax,eax
    m.cpu.regs.eax = sbb(m.cpu.regs.eax, m.cpu.regs.eax, &mut m.cpu.flags);
...
pub fn x0040142a(m: &mut Machine) -> Cont {
    ...
    m.cpu.regs.eax = m.memory.read::<u32>(0x40958cu32);
...
pub fn x00401433(m: &mut Machine) -> Cont {
    ...
    let dst = indirect(m, m.memory.read(m.cpu.regs.ecx.wrapping_add(0x8u32)));
    call(m, 0x401439, dst)
}
...
pub fn x00401442(m: &mut Machine) -> Cont {
    ...
    let dst = indirect(m, m.memory.read(m.cpu.regs.edx.wrapping_add(0x8u32)));
    call(m, 0x401448, dst)
}
...
pub fn x00401460(m: &mut Machine) -> Cont {
    ...
    m.cpu.regs.eax = m.cpu.regs.ecx;
    // 00401462 mov dword ptr [eax],406110h
    m.memory.write::<u32>(m.cpu.regs.eax, 0x406110u32);
    // 00401468 mov dword ptr [eax+28h],0
    m.memory
        .write::<u32>(m.cpu.regs.eax.wrapping_add(0x28u32), 0x0u32);
    // 0040146f mov dword ptr [eax+1Ch],0FFFFFFFFh
    m.memory
        .write::<u32>(m.cpu.regs.eax.wrapping_add(0x1cu32), 0xffffffffu32);
    // 00401476 ret
    ret(m, 0)
}
...
pub fn x00401488(m: &mut Machine) -> Cont {
    ...
    and(
        m.memory.read::<u8>(m.cpu.regs.esp.wrapping_add(0x8u32)),
        0x1u8,
        &mut m.cpu.flags,
    );
...
pub fn x004014a0(m: &mut Machine) -> Cont {
    ...
    m.cpu.regs.eax = m.memory.read::<u32>(m.cpu.regs.esi.wrapping_add(0x28u32));
    // 004014a6 mov dword ptr [esi],406110h
    m.memory.write::<u32>(m.cpu.regs.esi, 0x406110u32);
...
pub fn x004014c4(m: &mut Machine) -> Cont {
    ...
    m.memory
        .write::<u32>(m.cpu.regs.esi.wrapping_add(0x28u32), 0x0u32);
    // 004014cb pop esi
    m.cpu.regs.esi = pop(m);
    // 004014cc ret
    ret(m, 0)
...
pub fn x004014d0(m: &mut Machine) -> Cont {
    ...
    m.cpu.regs.eax = m.memory.read::<u32>(m.cpu.regs.esp.wrapping_add(0x18u32));
    // 004014d4 sub esp,98h
    m.cpu.regs.esp = sub(m.cpu.regs.esp, 0x98u32, &mut m.cpu.flags);
    // 004014da mov edx,[esp+9Ch]
    m.cpu.regs.edx = m.memory.read::<u32>(m.cpu.regs.esp.wrapping_add(0x9cu32));
    // 004014e1 push ebx
    push(m, m.cpu.regs.ebx);
    // 004014e2 mov ebx,[esp+0B0h]
    m.cpu.regs.ebx = m.memory.read::<u32>(m.cpu.regs.esp.wrapping_add(0xb0u32));
    // 004014e9 push ebp
    ...
    m.cpu.regs.ecx = m.memory.read::<u32>(m.cpu.regs.esp.wrapping_add(0xb0u32));
    // 004014f5 push 0
    push(m, 0x0u32);
    // 004014f7 push eax
    push(m, m.cpu.regs.eax);
    ...
    m.cpu.regs.ecx = and(m.cpu.regs.ecx, 0xffffu32, &mut m.cpu.flags);
    // 004014ff push 0
    push(m, 0x0u32);
    // 00401501 push ecx
    push(m, m.cpu.regs.ecx);
...
pub fn x00401509(m: &mut Machine) -> Cont {
    ...
    m.cpu.regs.ebp = m.cpu.regs.eax;
    // 0040150b test ebp,ebp
    and(m.cpu.regs.ebp, m.cpu.regs.ebp, &mut m.cpu.flags);
...
pub fn x0040151e(m: &mut Machine) -> Cont {
    ...
    let dst = indirect(m, m.memory.read(m.cpu.regs.ecx.wrapping_add(0x6cu32)));
    call(m, 0x401524, dst)
}
...
pub fn x0040152c(m: &mut Machine) -> Cont {
    ...
    m.cpu.regs.edi = m.cpu.regs.eax;
    // 0040152e test edi,edi
    and(m.cpu.regs.edi, m.cpu.regs.edi, &mut m.cpu.flags);
...
pub fn x0040153e(m: &mut Machine) -> Cont {
    ...
    m.cpu.regs.edx = m.cpu.regs.esp.wrapping_add(0x14u32);
    // 00401542 push edx
    push(m, m.cpu.regs.edx);
    // 00401543 push 18h
    push(m, 0x18u32);
...
pub fn x0040154c(m: &mut Machine) -> Cont {
    ...
    and(m.cpu.regs.ebx, m.cpu.regs.ebx, &mut m.cpu.flags);
...
pub fn x00401550(m: &mut Machine) -> Cont {
    ...
    m.cpu.regs.ebx = m.memory.read::<u32>(m.cpu.regs.esp.wrapping_add(0x18u32));
    // 00401554 mov eax,[esp+0C0h]
    m.cpu.regs.eax = m.memory.read::<u32>(m.cpu.regs.esp.wrapping_add(0xc0u32));
...
pub fn x0040155f(m: &mut Machine) -> Cont {
    ...
    m.cpu.regs.eax = m.memory.read::<u32>(m.cpu.regs.esp.wrapping_add(0x1cu32));
    // 00401563 mov [esp+0C0h],eax
    m.memory
        .write::<u32>(m.cpu.regs.esp.wrapping_add(0xc0u32), m.cpu.regs.eax);
    // 0040156a mov eax,[esi+28h]
    m.cpu.regs.eax = m.memory.read::<u32>(m.cpu.regs.esi.wrapping_add(0x28u32));
    // 0040156d lea edx,[esp+2Ch]
    m.cpu.regs.edx = m.cpu.regs.esp.wrapping_add(0x2cu32);
    // 00401571 mov dword ptr [esp+2Ch],7Ch
    m.memory
        .write::<u32>(m.cpu.regs.esp.wrapping_add(0x2cu32), 0x7cu32);
    // 00401579 mov dword ptr [esp+30h],6
    m.memory
        .write::<u32>(m.cpu.regs.esp.wrapping_add(0x30u32), 0x6u32);
    ...
    let dst = indirect(m, m.memory.read(m.cpu.regs.ecx.wrapping_add(0x58u32)));
    call(m, 0x401588, dst)
}
...
pub fn x00401588(m: &mut Machine) -> Cont {
    ...
    m.cpu.regs.edx = m.cpu.regs.esp.wrapping_add(0x10u32);
    // 0040158f push edx
    push(m, m.cpu.regs.edx);
    // 00401590 push eax
    push(m, m.cpu.regs.eax);
    ...
    let dst = indirect(m, m.memory.read(m.cpu.regs.ecx.wrapping_add(0x44u32)));
    call(m, 0x401596, dst)
}
...
pub fn x00401596(m: &mut Machine) -> Cont {
    ...
    m.cpu.regs.ebp = m.memory.read::<u32>(m.cpu.regs.esp.wrapping_add(0xb8u32));
...
pub fn x004015a1(m: &mut Machine) -> Cont {
    ...
    m.cpu.regs.ecx = m.memory.read::<u32>(m.cpu.regs.esp.wrapping_add(0xb4u32));
    // 004015af mov edx,[esp+34h]
    m.cpu.regs.edx = m.memory.read::<u32>(m.cpu.regs.esp.wrapping_add(0x34u32));
    // 004015b3 push 0CC0020h
    push(m, 0xcc0020u32);
    // 004015b8 push eax
    push(m, m.cpu.regs.eax);
    // 004015b9 mov eax,[esp+40h]
    m.cpu.regs.eax = m.memory.read::<u32>(m.cpu.regs.esp.wrapping_add(0x40u32));
    // 004015bd push ebx
    push(m, m.cpu.regs.ebx);
    // 004015be push ebp
    push(m, m.cpu.regs.ebp);
    ...
    m.cpu.regs.ecx = m.memory.read::<u32>(m.cpu.regs.esp.wrapping_add(0x24u32));
    // 004015c4 push edi
    push(m, m.cpu.regs.edi);
    // 004015c5 push edx
    push(m, m.cpu.regs.edx);
...
pub fn x004015d2(m: &mut Machine) -> Cont {
    ...
    let dst = indirect(m, m.memory.read(m.cpu.regs.edx.wrapping_add(0x68u32)));
    call(m, 0x4015e0, dst)
}
...
pub fn x004015e7(m: &mut Machine) -> Cont {
    ...
    m.cpu.regs.edx = m.memory.read::<u32>(m.cpu.regs.esp.wrapping_add(0xacu32));
    // 004015ee mov eax,[esp+0B0h]
    m.cpu.regs.eax = m.memory.read::<u32>(m.cpu.regs.esp.wrapping_add(0xb0u32));
    // 004015f5 mov ecx,[esp+0B4h]
    m.cpu.regs.ecx = m.memory.read::<u32>(m.cpu.regs.esp.wrapping_add(0xb4u32));
    // 004015fc mov [esi+4],edx
    m.memory
        .write::<u32>(m.cpu.regs.esi.wrapping_add(0x4u32), m.cpu.regs.edx);
    // 004015ff mov edx,[esp+0C0h]
    m.cpu.regs.edx = m.memory.read::<u32>(m.cpu.regs.esp.wrapping_add(0xc0u32));
    // 00401606 mov [esi+8],eax
    m.memory
        .write::<u32>(m.cpu.regs.esi.wrapping_add(0x8u32), m.cpu.regs.eax);
    // 00401609 mov [esi+0Ch],ecx
    m.memory
        .write::<u32>(m.cpu.regs.esi.wrapping_add(0xcu32), m.cpu.regs.ecx);
    // 0040160c mov [esi+10h],ebp
    m.memory
        .write::<u32>(m.cpu.regs.esi.wrapping_add(0x10u32), m.cpu.regs.ebp);
    // 0040160f mov [esi+14h],ebx
    m.memory
        .write::<u32>(m.cpu.regs.esi.wrapping_add(0x14u32), m.cpu.regs.ebx);
    // 00401612 mov [esi+18h],edx
    m.memory
        .write::<u32>(m.cpu.regs.esi.wrapping_add(0x18u32), m.cpu.regs.edx);
    // 00401615 pop edi
    m.cpu.regs.edi = pop(m);
    // 00401616 pop esi
    m.cpu.regs.esi = pop(m);
    ...
    // 00401618 mov eax,1
    m.cpu.regs.eax = 0x1u32;
    // 0040161d pop ebx
    m.cpu.regs.ebx = pop(m);
    // 0040161e add esp,98h
    m.cpu.regs.esp = add(m.cpu.regs.esp, 0x98u32, &mut m.cpu.flags);
    // 00401624 ret 18h
    ret(m, 24)
}
...
pub fn x00401640(m: &mut Machine) -> Cont {
    ...
    m.cpu.regs.esp = sub(m.cpu.regs.esp, 0x84u32, &mut m.cpu.flags);
    // 00401646 push ebx
    push(m, m.cpu.regs.ebx);
    // 00401647 push ebp
    push(m, m.cpu.regs.ebp);
    ...
    m.cpu.regs.esi = m.memory.read::<u32>(m.cpu.regs.esp.wrapping_add(0x94u32));
    // 00401650 mov ebx,ecx
    m.cpu.regs.ebx = m.cpu.regs.ecx;
    // 00401652 push edi
    push(m, m.cpu.regs.edi);
    // 00401653 mov ebp,[esp+9Ch]
    m.cpu.regs.ebp = m.memory.read::<u32>(m.cpu.regs.esp.wrapping_add(0x9cu32));
    // 0040165a mov ecx,1Fh
    m.cpu.regs.ecx = 0x1fu32;
    // 0040165f xor eax,eax
    m.cpu.regs.eax = xor(m.cpu.regs.eax, m.cpu.regs.eax, &mut m.cpu.flags);
    // 00401661 lea edi,[esp+18h]
    m.cpu.regs.edi = m.cpu.regs.esp.wrapping_add(0x18u32);
    // 00401665 rep stosd
    rep(m, Rep::REP, stosd);
    // 00401667 mov eax,[esp+0A0h]
    m.cpu.regs.eax = m.memory.read::<u32>(m.cpu.regs.esp.wrapping_add(0xa0u32));
    // 0040166e mov ecx,[esi]
    m.cpu.regs.ecx = m.memory.read::<u32>(m.cpu.regs.esi);
    // 00401670 lea edi,[ebx+28h]
    m.cpu.regs.edi = m.cpu.regs.ebx.wrapping_add(0x28u32);
    // 00401673 push 0
    push(m, 0x0u32);
    // 00401675 lea edx,[esp+1Ch]
    m.cpu.regs.edx = m.cpu.regs.esp.wrapping_add(0x1cu32);
    // 00401679 push edi
    push(m, m.cpu.regs.edi);
    // 0040167a push edx
    push(m, m.cpu.regs.edx);
    ...
    m.memory
        .write::<u32>(m.cpu.regs.esp.wrapping_add(0x28u32), 0x7cu32);
    // 00401684 mov dword ptr [esp+2Ch],7
    m.memory
        .write::<u32>(m.cpu.regs.esp.wrapping_add(0x2cu32), 0x7u32);
    // 0040168c mov dword ptr [esp+90h],4040h
    m.memory
        .write::<u32>(m.cpu.regs.esp.wrapping_add(0x90u32), 0x4040u32);
    // 00401697 mov [esp+34h],ebp
    m.memory
        .write::<u32>(m.cpu.regs.esp.wrapping_add(0x34u32), m.cpu.regs.ebp);
    // 0040169b mov [esp+30h],eax
    m.memory
        .write::<u32>(m.cpu.regs.esp.wrapping_add(0x30u32), m.cpu.regs.eax);
    // 0040169f call dword ptr [ecx+18h]
    let dst = indirect(m, m.memory.read(m.cpu.regs.ecx.wrapping_add(0x18u32)));
    call(m, 0x4016a2, dst)
}
...
pub fn x004016a6(m: &mut Machine) -> Cont {
    ...
    sub(m.cpu.regs.eax, 0x8876017cu32, &mut m.cpu.flags);
...
pub fn x004016ad(m: &mut Machine) -> Cont {
    ...
    m.cpu.regs.eax = m.memory.read::<u32>(m.cpu.regs.esi);
    // 004016af push 0
    push(m, 0x0u32);
    // 004016b1 lea ecx,[esp+1Ch]
    m.cpu.regs.ecx = m.cpu.regs.esp.wrapping_add(0x1cu32);
    // 004016b5 push edi
    push(m, m.cpu.regs.edi);
    // 004016b6 push ecx
    push(m, m.cpu.regs.ecx);
    ...
    m.memory
        .write::<u32>(m.cpu.regs.esp.wrapping_add(0x90u32), 0x840u32);
    // 004016c3 call dword ptr [eax+18h]
    let dst = indirect(m, m.memory.read(m.cpu.regs.eax.wrapping_add(0x18u32)));
    call(m, 0x4016c6, dst)
}
...
pub fn x004016ca(m: &mut Machine) -> Cont {
    ...
    m.cpu.regs.esp = add(m.cpu.regs.esp, 0x84u32, &mut m.cpu.flags);
    // 004016d6 ret 10h
    ret(m, 16)
}
...
pub fn x004016d9(m: &mut Machine) -> Cont {
    ...
    m.cpu.regs.esi = m.memory.read::<u32>(m.cpu.regs.esp.wrapping_add(0xa4u32));
    // 004016e0 cmp esi,0FFFFFFFFh
    sub(m.cpu.regs.esi, 0xffffffffu32, &mut m.cpu.flags);
...
pub fn x004016e5(m: &mut Machine) -> Cont {
    ...
    m.cpu.regs.edi = m.memory.read::<u32>(m.cpu.regs.edi);
    // 004016e7 lea eax,[esp+10h]
    m.cpu.regs.eax = m.cpu.regs.esp.wrapping_add(0x10u32);
    // 004016eb mov [esp+10h],esi
    m.memory
        .write::<u32>(m.cpu.regs.esp.wrapping_add(0x10u32), m.cpu.regs.esi);
    // 004016ef mov dword ptr [esp+14h],0
    m.memory
        .write::<u32>(m.cpu.regs.esp.wrapping_add(0x14u32), 0x0u32);
    // 004016f7 mov edx,[edi]
    m.cpu.regs.edx = m.memory.read::<u32>(m.cpu.regs.edi);
    // 004016f9 push eax
    push(m, m.cpu.regs.eax);
    // 004016fa push 8
    push(m, 0x8u32);
    ...
    let dst = indirect(m, m.memory.read(m.cpu.regs.edx.wrapping_add(0x74u32)));
    call(m, 0x401700, dst)
}
...
pub fn x00401700(m: &mut Machine) -> Cont {
    ...
    m.cpu.regs.ecx = m.memory.read::<u32>(m.cpu.regs.esp.wrapping_add(0xa0u32));
    // 00401707 mov [ebx+1Ch],esi
    m.memory
        .write::<u32>(m.cpu.regs.ebx.wrapping_add(0x1cu32), m.cpu.regs.esi);
    // 0040170a pop edi
    m.cpu.regs.edi = pop(m);
    // 0040170b mov [ebx+24h],ebp
    m.memory
        .write::<u32>(m.cpu.regs.ebx.wrapping_add(0x24u32), m.cpu.regs.ebp);
    // 0040170e pop esi
    m.cpu.regs.esi = pop(m);
    // 0040170f mov [ebx+20h],ecx
    m.memory
        .write::<u32>(m.cpu.regs.ebx.wrapping_add(0x20u32), m.cpu.regs.ecx);
    // 00401712 pop ebp
    m.cpu.regs.ebp = pop(m);
    // 00401713 mov eax,1
    m.cpu.regs.eax = 0x1u32;
...
pub fn x00401730(m: &mut Machine) -> Cont {
    ...
    m.cpu.regs.esp = sub(m.cpu.regs.esp, 0x10u32, &mut m.cpu.flags);
    // 00401733 push ebx
    push(m, m.cpu.regs.ebx);
    // 00401734 push ebp
    push(m, m.cpu.regs.ebp);
    ...
    m.cpu.regs.esi = m.memory.read::<u32>(m.cpu.regs.esp.wrapping_add(0x34u32));
    // 0040173a push edi
    push(m, m.cpu.regs.edi);
    // 0040173b mov edi,ecx
    m.cpu.regs.edi = m.cpu.regs.ecx;
    // 0040173d test esi,esi
    and(m.cpu.regs.esi, m.cpu.regs.esi, &mut m.cpu.flags);
...
pub fn x00401741(m: &mut Machine) -> Cont {
    ...
    m.cpu.regs.esi = m.memory.read::<u32>(m.cpu.regs.edi.wrapping_add(0x24u32));
    // 00401744 mov edx,[esp+3Ch]
    m.cpu.regs.edx = m.memory.read::<u32>(m.cpu.regs.esp.wrapping_add(0x3cu32));
    // 00401748 test edx,edx
    and(m.cpu.regs.edx, m.cpu.regs.edx, &mut m.cpu.flags);
...
pub fn x0040174c(m: &mut Machine) -> Cont {
    ...
    m.cpu.regs.edx = m.memory.read::<u32>(m.cpu.regs.edi.wrapping_add(0x20u32));
    // 0040174f mov eax,[esp+30h]
    m.cpu.regs.eax = m.memory.read::<u32>(m.cpu.regs.esp.wrapping_add(0x30u32));
    // 00401753 mov ecx,[esp+34h]
    m.cpu.regs.ecx = m.memory.read::<u32>(m.cpu.regs.esp.wrapping_add(0x34u32));
    // 00401757 mov ebx,[esp+2Ch]
    m.cpu.regs.ebx = m.memory.read::<u32>(m.cpu.regs.esp.wrapping_add(0x2cu32));
    // 0040175b mov ebp,[esp+28h]
    m.cpu.regs.ebp = m.memory.read::<u32>(m.cpu.regs.esp.wrapping_add(0x28u32));
    // 0040175f mov [esp+10h],eax
    m.memory
        .write::<u32>(m.cpu.regs.esp.wrapping_add(0x10u32), m.cpu.regs.eax);
    // 00401763 mov [esp+14h],ecx
    m.memory
        .write::<u32>(m.cpu.regs.esp.wrapping_add(0x14u32), m.cpu.regs.ecx);
    // 00401767 add eax,esi
    m.cpu.regs.eax = add(m.cpu.regs.eax, m.cpu.regs.esi, &mut m.cpu.flags);
    // 00401769 mov esi,[esp+24h]
    m.cpu.regs.esi = m.memory.read::<u32>(m.cpu.regs.esp.wrapping_add(0x24u32));
    // 0040176d add ecx,edx
    m.cpu.regs.ecx = add(m.cpu.regs.ecx, m.cpu.regs.edx, &mut m.cpu.flags);
    // 0040176f mov [esp+18h],eax
    m.memory
        .write::<u32>(m.cpu.regs.esp.wrapping_add(0x18u32), m.cpu.regs.eax);
    // 00401773 mov [esp+1Ch],ecx
    m.memory
        .write::<u32>(m.cpu.regs.esp.wrapping_add(0x1cu32), m.cpu.regs.ecx);
    // 00401777 mov eax,[edi+1Ch]
    m.cpu.regs.eax = m.memory.read::<u32>(m.cpu.regs.edi.wrapping_add(0x1cu32));
...
pub fn x00401784(m: &mut Machine) -> Cont {
    ...
    m.cpu.regs.edx = m.memory.read::<u32>(m.cpu.regs.edi.wrapping_add(0x28u32));
    // 00401789 lea ecx,[esp+14h]
    m.cpu.regs.ecx = m.cpu.regs.esp.wrapping_add(0x14u32);
    // 0040178d push ecx
    push(m, m.cpu.regs.ecx);
    // 0040178e push edx
    push(m, m.cpu.regs.edx);
    ...
    let dst = indirect(m, m.memory.read(m.cpu.regs.eax.wrapping_add(0x1cu32)));
    call(m, 0x401795, dst)
}
...
pub fn x004017b0(m: &mut Machine) -> Cont {
    ...
    m.cpu.regs.esp = add(m.cpu.regs.esp, 0x10u32, &mut m.cpu.flags);
    // 004017b9 ret 1Ch
    ret(m, 28)
}
...
pub fn x004017f0(m: &mut Machine) -> Cont {
    ...
    m.cpu.regs.eax = m.memory.read::<u32>(m.cpu.regs.ecx.wrapping_add(0x28u32));
    // 004017f3 push eax
    push(m, m.cpu.regs.eax);
...
pub fn x00401806(m: &mut Machine) -> Cont {
    ...
    push(m, m.memory.read::<u32>(0x409ab0u32));
...
pub fn x00401812(m: &mut Machine) -> Cont {
    ...
    m.cpu.regs.edx = m.memory.read::<u32>(0x409ab0u32);
    // 00401818 pop ecx
    m.cpu.regs.ecx = pop(m);
    // 00401819 mov ecx,ds:[409AACh]
    m.cpu.regs.ecx = m.memory.read::<u32>(0x409aacu32);
    // 0040181f mov esi,ecx
    m.cpu.regs.esi = m.cpu.regs.ecx;
    // 00401821 sub esi,edx
    m.cpu.regs.esi = sub(m.cpu.regs.esi, m.cpu.regs.edx, &mut m.cpu.flags);
    // 00401823 add esi,4
    m.cpu.regs.esi = add(m.cpu.regs.esi, 0x4u32, &mut m.cpu.flags);
    // 00401826 cmp eax,esi
    sub(m.cpu.regs.eax, m.cpu.regs.esi, &mut m.cpu.flags);
    // 00401828 pop esi
    m.cpu.regs.esi = pop(m);
...
pub fn x00401831(m: &mut Machine) -> Cont {
    ...
    m.cpu.regs.eax = add(m.cpu.regs.eax, 0x10u32, &mut m.cpu.flags);
    // 00401834 push eax
    push(m, m.cpu.regs.eax);
...
pub fn x00401840(m: &mut Machine) -> Cont {
    ...
    m.cpu.regs.esp = add(m.cpu.regs.esp, 0xcu32, &mut m.cpu.flags);
...
pub fn x00401848(m: &mut Machine) -> Cont {
    ...
    m.cpu.regs.ecx = sub(
        m.cpu.regs.ecx,
        m.memory.read::<u32>(0x409ab0u32),
        &mut m.cpu.flags,
    );
    // 00401854 mov ds:[409AB0h],eax
    m.memory.write::<u32>(0x409ab0u32, m.cpu.regs.eax);
    // 00401859 sar ecx,2
    m.cpu.regs.ecx = sar(m.cpu.regs.ecx, 0x2u8, &mut m.cpu.flags);
    // 0040185c lea ecx,[eax+ecx*4]
    m.cpu.regs.ecx = m.cpu.regs.eax.wrapping_add((m.cpu.regs.ecx * 4));
    // 0040185f mov ds:[409AACh],ecx
    m.memory.write::<u32>(0x409aacu32, m.cpu.regs.ecx);
    // 00401865 mov eax,[esp+4]
    m.cpu.regs.eax = m.memory.read::<u32>(m.cpu.regs.esp.wrapping_add(0x4u32));
    // 00401869 mov [ecx],eax
    m.memory.write::<u32>(m.cpu.regs.ecx, m.cpu.regs.eax);
    // 0040186b add dword ptr ds:[409AACh],4
    m.memory.write::<u32>(
        0x409aacu32,
        add(m.memory.read::<u32>(0x409aacu32), 0x4u32, &mut m.cpu.flags),
    );
    // 00401872 ret
    ret(m, 0)
}
...
pub fn x00401873(m: &mut Machine) -> Cont {
    ...
    push(m, m.memory.read::<u32>(m.cpu.regs.esp.wrapping_add(0x4u32)));
...
pub fn x0040187c(m: &mut Machine) -> Cont {
    ...
    m.cpu.regs.eax = neg(m.cpu.regs.eax, &mut m.cpu.flags);
    // 00401883 dec eax
    m.cpu.regs.eax = dec(m.cpu.regs.eax, &mut m.cpu.flags);
    // 00401884 ret
    ret(m, 0)
}
...
pub fn x004018a0(m: &mut Machine) -> Cont {
    ...
    m.cpu.regs.eax = m.memory.read::<u32>(0x409ab0u32);
    // 004018a5 pop ecx
    m.cpu.regs.ecx = pop(m);
    ...
    m.memory.write::<u32>(
        m.cpu.regs.eax,
        and(
            m.memory.read::<u32>(m.cpu.regs.eax),
            0x0u32,
            &mut m.cpu.flags,
        ),
    );
    ...
    m.memory.write::<u32>(0x409aacu32, m.cpu.regs.eax);
    // 004018b3 ret
    ret(m, 0)
}
...
pub fn x004018bf(m: &mut Machine) -> Cont {
    ...
    m.cpu.regs.eax = m.memory.read::<u32>(m.cpu.regs.fs_base);
    // 004018d4 push eax
    push(m, m.cpu.regs.eax);
    // 004018d5 mov fs:[0],esp
    m.memory.write::<u32>(m.cpu.regs.fs_base, m.cpu.regs.esp);
    // 004018dc sub esp,58h
    m.cpu.regs.esp = sub(m.cpu.regs.esp, 0x58u32, &mut m.cpu.flags);
    // 004018df push ebx
    push(m, m.cpu.regs.ebx);
    // 004018e0 push esi
    push(m, m.cpu.regs.esi);
    ...
    m.memory
        .write::<u32>(m.cpu.regs.ebp.wrapping_add(0xffffffe8u32), m.cpu.regs.esp);
...
pub fn x004018eb(m: &mut Machine) -> Cont {
    ...
    m.cpu.regs.edx = xor(m.cpu.regs.edx, m.cpu.regs.edx, &mut m.cpu.flags);
    // 004018ed mov dl,ah
    m.cpu.regs.set_dl(m.cpu.regs.get_ah());
    // 004018ef mov ds:[4095C0h],edx
    m.memory.write::<u32>(0x4095c0u32, m.cpu.regs.edx);
    // 004018f5 mov ecx,eax
    m.cpu.regs.ecx = m.cpu.regs.eax;
    // 004018f7 and ecx,0FFh
    m.cpu.regs.ecx = and(m.cpu.regs.ecx, 0xffu32, &mut m.cpu.flags);
    // 004018fd mov ds:[4095BCh],ecx
    m.memory.write::<u32>(0x4095bcu32, m.cpu.regs.ecx);
    // 00401903 shl ecx,8
    m.cpu.regs.ecx = shl(m.cpu.regs.ecx, 0x8u8, &mut m.cpu.flags);
    // 00401906 add ecx,edx
    m.cpu.regs.ecx = add(m.cpu.regs.ecx, m.cpu.regs.edx, &mut m.cpu.flags);
    // 00401908 mov ds:[4095B8h],ecx
    m.memory.write::<u32>(0x4095b8u32, m.cpu.regs.ecx);
    // 0040190e shr eax,10h
    m.cpu.regs.eax = shr(m.cpu.regs.eax, 0x10u8, &mut m.cpu.flags);
    // 00401911 mov ds:[4095B4h],eax
    m.memory.write::<u32>(0x4095b4u32, m.cpu.regs.eax);
    // 00401916 xor esi,esi
    m.cpu.regs.esi = xor(m.cpu.regs.esi, m.cpu.regs.esi, &mut m.cpu.flags);
    // 00401918 push esi
    push(m, m.cpu.regs.esi);
...
pub fn x0040192a(m: &mut Machine) -> Cont {
    ...
    m.memory
        .write::<u32>(m.cpu.regs.ebp.wrapping_add(0xfffffffcu32), m.cpu.regs.esi);
...
pub fn x00401939(m: &mut Machine) -> Cont {
    ...
    m.memory.write::<u32>(0x409ab8u32, m.cpu.regs.eax);
...
pub fn x00401943(m: &mut Machine) -> Cont {
    ...
    m.memory.write::<u32>(0x40959cu32, m.cpu.regs.eax);
...
pub fn x00401957(m: &mut Machine) -> Cont {
    ...
    m.memory
        .write::<u32>(m.cpu.regs.ebp.wrapping_add(0xffffffd0u32), m.cpu.regs.esi);
    // 0040195a lea eax,[ebp-5Ch]
    m.cpu.regs.eax = m.cpu.regs.ebp.wrapping_add(0xffffffa4u32);
    // 0040195d push eax
    push(m, m.cpu.regs.eax);
...
pub fn x00401969(m: &mut Machine) -> Cont {
    ...
    m.memory
        .write::<u32>(m.cpu.regs.ebp.wrapping_add(0xffffff9cu32), m.cpu.regs.eax);
    // 0040196c test byte ptr [ebp-30h],1
    and(
        m.memory
            .read::<u8>(m.cpu.regs.ebp.wrapping_add(0xffffffd0u32)),
        0x1u8,
        &mut m.cpu.flags,
    );
...
pub fn x00401972(m: &mut Machine) -> Cont {
    ...
    m.cpu.regs.eax = m
        .memory
        .read::<u16>(m.cpu.regs.ebp.wrapping_add(0xffffffd4u32)) as _;
...
pub fn x00401978(m: &mut Machine) -> Cont {
    ...
    push(
        m,
        m.memory
            .read::<u32>(m.cpu.regs.ebp.wrapping_add(0xffffff9cu32)),
    );
    // 0040197f push esi
    push(m, m.cpu.regs.esi);
    // 00401980 push esi
...
pub fn x0040198d(m: &mut Machine) -> Cont {
    ...
    m.memory
        .write::<u32>(m.cpu.regs.ebp.wrapping_add(0xffffffa0u32), m.cpu.regs.eax);
    // 00401990 push eax
    push(m, m.cpu.regs.eax);
...
pub fn x00401996(m: &mut Machine) -> Cont {
    ...
    m.cpu.regs.eax = m
        .memory
        .read::<u32>(m.cpu.regs.ebp.wrapping_add(0xffffffecu32));
    // 00401999 mov ecx,[eax]
    m.cpu.regs.ecx = m.memory.read::<u32>(m.cpu.regs.eax);
    // 0040199b mov ecx,[ecx]
    m.cpu.regs.ecx = m.memory.read::<u32>(m.cpu.regs.ecx);
    // 0040199d mov [ebp-68h],ecx
    m.memory
        .write::<u32>(m.cpu.regs.ebp.wrapping_add(0xffffff98u32), m.cpu.regs.ecx);
    // 004019a0 push eax
    push(m, m.cpu.regs.eax);
    // 004019a1 push ecx
    push(m, m.cpu.regs.ecx);
...
pub fn x004019aa(m: &mut Machine) -> Cont {
    ...
    m.cpu.regs.esp = m
        .memory
        .read::<u32>(m.cpu.regs.ebp.wrapping_add(0xffffffe8u32));
    // 004019ad push dword ptr [ebp-68h]
    push(
        m,
        m.memory
            .read::<u32>(m.cpu.regs.ebp.wrapping_add(0xffffff98u32)),
    );
...
pub fn x004019b5(m: &mut Machine) -> Cont {
    ...
    sub(m.memory.read::<u32>(0x4095a4u32), 0x1u32, &mut m.cpu.flags);
...
pub fn x004019cc(m: &mut Machine) -> Cont {
    ...
    let dst = indirect(m, m.memory.read(0x4070c4u32));
    call(m, 0x4019d7, dst)
}
...
pub fn x004019fe(m: &mut Machine) -> Cont {
    ...
    sub(
        m.memory.read::<u32>(m.cpu.regs.ebp.wrapping_add(0x8u32)),
        0x0u32,
        &mut m.cpu.flags,
    );
    // 00401a06 push ebx
...
pub fn x00401a0b(m: &mut Machine) -> Cont {
    ...
    push(m, m.memory.read::<u32>(m.cpu.regs.ebp.wrapping_add(0xcu32)));
...
pub fn x00401a19(m: &mut Machine) -> Cont {
    ...
    m.cpu.regs.esi = m.memory.read::<u32>(m.cpu.regs.ebp.wrapping_add(0xcu32));
...
pub fn x00401a20(m: &mut Machine) -> Cont {
    ...
    push(m, m.memory.read::<u32>(m.cpu.regs.ebp.wrapping_add(0x8u32)));
...
pub fn x00401a2e(m: &mut Machine) -> Cont {
    ...
    m.cpu.regs.eax = m.memory.read::<u32>(0x409988u32);
    // 00401a33 cmp eax,3
    sub(m.cpu.regs.eax, 0x3u32, &mut m.cpu.flags);
...
pub fn x00401a3c(m: &mut Machine) -> Cont {
    ...
    m.cpu.regs.edi = xor(m.cpu.regs.edi, m.cpu.regs.edi, &mut m.cpu.flags);
    // 00401a3e cmp esi,0FFFFFFE0h
    sub(m.cpu.regs.esi, 0xffffffe0u32, &mut m.cpu.flags);
...
pub fn x00401a62(m: &mut Machine) -> Cont {
    ...
    m.cpu.regs.edi = m.memory.read::<u32>(m.cpu.regs.ebp.wrapping_add(0x8u32));
    // 00401a65 push esi
    push(m, m.cpu.regs.esi);
    // 00401a66 push edi
    push(m, m.cpu.regs.edi);
...
pub fn x00401a81(m: &mut Machine) -> Cont {
    ...
    m.cpu.regs.ebx = m.memory.read::<u32>(m.cpu.regs.ebp.wrapping_add(0x8u32));
    // 00401a84 mov eax,[ebx-4]
    m.cpu.regs.eax = m
        .memory
        .read::<u32>(m.cpu.regs.ebx.wrapping_add(0xfffffffcu32));
    // 00401a87 dec eax
    m.cpu.regs.eax = dec(m.cpu.regs.eax, &mut m.cpu.flags);
...
pub fn x00401aa7(m: &mut Machine) -> Cont {
    ...
    m.cpu.regs.esp = add(m.cpu.regs.esp, 0x18u32, &mut m.cpu.flags);
...
pub fn x00401ab2(m: &mut Machine) -> Cont {
    ...
    m.cpu.regs.esi = add(m.cpu.regs.esi, 0xfu32, &mut m.cpu.flags);
    // 00401ab8 and esi,0FFFFFFF0h
    m.cpu.regs.esi = and(m.cpu.regs.esi, 0xfffffff0u32, &mut m.cpu.flags);
    // 00401abb push esi
    push(m, m.cpu.regs.esi);
    // 00401abc push 0
    push(m, 0x0u32);
...
pub fn x00401ad0(m: &mut Machine) -> Cont {
    ...
    m.cpu.regs.ecx = m.memory.read::<u32>(m.cpu.regs.ebp.wrapping_add(0x8u32));
    // 00401ad3 mov eax,[ecx-4]
    m.cpu.regs.eax = m
        .memory
        .read::<u32>(m.cpu.regs.ecx.wrapping_add(0xfffffffcu32));
    // 00401ad6 dec eax
    m.cpu.regs.eax = dec(m.cpu.regs.eax, &mut m.cpu.flags);
...
pub fn x00401aee(m: &mut Machine) -> Cont {
    ...
    m.cpu.regs.esp = add(m.cpu.regs.esp, 0x14u32, &mut m.cpu.flags);
...
pub fn x00401b1a(m: &mut Machine) -> Cont {
    ...
    sub(m.memory.read::<u32>(0x40970cu32), 0x0u32, &mut m.cpu.flags);
...
pub fn x00401b3e(m: &mut Machine) -> Cont {
    // 00401b3e cmp eax,2
    sub(m.cpu.regs.eax, 0x2u32, &mut m.cpu.flags);
...
pub fn x00401b66(m: &mut Machine) -> Cont {
    ...
    m.cpu.regs.eax = m.cpu.regs.ebp.wrapping_add(0xcu32);
    // 00401b69 push eax
    push(m, m.cpu.regs.eax);
    // 00401b6a lea eax,[ebp-4]
    m.cpu.regs.eax = m.cpu.regs.ebp.wrapping_add(0xfffffffcu32);
    // 00401b6d push eax
    push(m, m.cpu.regs.eax);
...
pub fn x00401b8b(m: &mut Machine) -> Cont {
    ...
    m.cpu.regs.edi = m.cpu.regs.esi;
    // 00401b8d shr edi,4
    m.cpu.regs.edi = shr(m.cpu.regs.edi, 0x4u8, &mut m.cpu.flags);
    // 00401b90 push edi
    push(m, m.cpu.regs.edi);
    // 00401b91 push ebx
    push(m, m.cpu.regs.ebx);
    ...
    push(
        m,
        m.memory
            .read::<u32>(m.cpu.regs.ebp.wrapping_add(0xfffffffcu32)),
    );
...
pub fn x00401bb6(m: &mut Machine) -> Cont {
    ...
    m.cpu.regs.eax = m.memory.read::<u8>(m.cpu.regs.ebx) as _;
    // 00401bb9 shl eax,4
    m.cpu.regs.eax = shl(m.cpu.regs.eax, 0x4u8, &mut m.cpu.flags);
...
pub fn x00401c9e(m: &mut Machine) -> Cont {
    ...
    m.cpu.regs.eax = m.memory.read::<u32>(0x409ab4u32);
...
pub fn x00401ca7(m: &mut Machine) -> Cont {
    // 00401ca7 call eax
    let dst = indirect(m, m.cpu.regs.eax);
    call(m, 0x401ca9, dst)
}
...
pub fn x00401ccb(m: &mut Machine) -> Cont {
    ...
    push(m, m.memory.read::<u32>(m.cpu.regs.esp.wrapping_add(0xcu32)));
...
pub fn x00401cf9(m: &mut Machine) -> Cont {
    ...
    push(m, m.memory.read::<u32>(m.cpu.regs.esp.wrapping_add(0x8u32)));
...
pub fn x00401d0a(m: &mut Machine) -> Cont {
    ...
    sub(
        m.memory.read::<u32>(m.cpu.regs.esp.wrapping_add(0xcu32)),
        0x0u32,
        &mut m.cpu.flags,
    );
    // 00401d0f push ebx
    ...
    m.cpu.regs.ebx = m.memory.read::<u32>(m.cpu.regs.esp.wrapping_add(0x14u32));
    // 00401d14 mov ds:[4095ECh],edi
    m.memory.write::<u32>(0x4095ecu32, m.cpu.regs.edi);
    // 00401d1a mov ds:[4095E8h],bl
    m.memory.write::<u8>(0x4095e8u32, m.cpu.regs.get_bl());
...
pub fn x00401d2b(m: &mut Machine) -> Cont {
    ...
    m.cpu.regs.esi = m.cpu.regs.ecx.wrapping_add(0xfffffffcu32);
    // 00401d35 cmp esi,eax
    sub(m.cpu.regs.esi, m.cpu.regs.eax, &mut m.cpu.flags);
...
pub fn x00401d41(m: &mut Machine) -> Cont {
    // 00401d41 sub esi,4
    m.cpu.regs.esi = sub(m.cpu.regs.esi, 0x4u32, &mut m.cpu.flags);
...
pub fn x00401d74(m: &mut Machine) -> Cont {
    ...
    m.memory.write::<u32>(0x4095f0u32, m.cpu.regs.edi);
...
pub fn x00401d86(m: &mut Machine) -> Cont {
    ...
    m.cpu.regs.esi = m.memory.read::<u32>(m.cpu.regs.esp.wrapping_add(0x8u32));
...
pub fn x00401db0(m: &mut Machine) -> Cont {
    ...
    m.cpu.regs.esi = m.memory.read::<u32>(m.cpu.regs.ebp.wrapping_add(0x8u32));
    // 00401db3 push esi
    push(m, m.cpu.regs.esi);
...
pub fn x00401dbe(m: &mut Machine) -> Cont {
    ...
    m.cpu.regs.eax = m
        .memory
        .read::<u32>(m.cpu.regs.esi.wrapping_add(0xfffffffcu32));
    // 00401dc1 sub eax,9
    m.cpu.regs.eax = sub(m.cpu.regs.eax, 0x9u32, &mut m.cpu.flags);
...
pub fn x00401dce(m: &mut Machine) -> Cont {
    ...
    m.cpu.regs.eax = m.cpu.regs.ebp.wrapping_add(0xfffffff8u32);
    // 00401dd5 push eax
    push(m, m.cpu.regs.eax);
...
pub fn x00401de5(m: &mut Machine) -> Cont {
    ...
    m.cpu.regs.eax = m.memory.read::<u8>(m.cpu.regs.eax) as _;
    // 00401de8 shl eax,4
    m.cpu.regs.eax = shl(m.cpu.regs.eax, 0x4u8, &mut m.cpu.flags);
...
pub fn x00401e13(m: &mut Machine) -> Cont {
    ...
    sub(
        m.memory.read::<u32>(m.cpu.regs.esp.wrapping_add(0x4u32)),
        0xffffffe0u32,
        &mut m.cpu.flags,
    );
...
pub fn x00401e28(m: &mut Machine) -> Cont {
    ...
    sub(
        m.memory.read::<u32>(m.cpu.regs.esp.wrapping_add(0x8u32)),
        m.cpu.regs.eax,
        &mut m.cpu.flags,
    );
...
pub fn x00401e68(m: &mut Machine) -> Cont {
    ...
    m.cpu.regs.eax = m.memory.read::<u32>(m.cpu.regs.esp.wrapping_add(0x8u32));
...
pub fn x00401e70(m: &mut Machine) -> Cont {
    ...
    m.cpu.regs.esi = m.cpu.regs.eax.wrapping_add(0xfu32);
...
pub fn x00401e83(m: &mut Machine) -> Cont {
    ...
    m.cpu.regs.eax = m.cpu.regs.esi;
    // 00401e85 shr eax,4
    m.cpu.regs.eax = shr(m.cpu.regs.eax, 0x4u8, &mut m.cpu.flags);
    // 00401e88 push eax
    push(m, m.cpu.regs.eax);
...
pub fn x00401ee4(m: &mut Machine) -> Cont {
    ...
    m.cpu.regs.eax = m.cpu.regs.ebp.wrapping_add(0x8u32);
    // 00401ee7 push eax
    push(m, m.cpu.regs.eax);
...
pub fn x00401f31(m: &mut Machine) -> Cont {
    ...
    m.cpu.regs.ebx = m.memory.read::<u32>(m.cpu.regs.eax.wrapping_add(0x8u32));
...
pub fn x00401f3c(m: &mut Machine) -> Cont {
    // 00401f3c cmp ebx,5
    sub(m.cpu.regs.ebx, 0x5u32, &mut m.cpu.flags);
...
pub fn x00401f41(m: &mut Machine) -> Cont {
    ...
    m.memory.write::<u32>(
        m.cpu.regs.eax.wrapping_add(0x8u32),
        and(
            m.memory.read::<u32>(m.cpu.regs.eax.wrapping_add(0x8u32)),
            0x0u32,
            &mut m.cpu.flags,
        ),
    );
...
pub fn x00401f4d(m: &mut Machine) -> Cont {
    // 00401f4d cmp ebx,1
    sub(m.cpu.regs.ebx, 0x1u32, &mut m.cpu.flags);
...
pub fn x00401f56(m: &mut Machine) -> Cont {
    ...
    m.cpu.regs.ecx = m.memory.read::<u32>(0x4095f4u32);
    // 00401f5c mov [ebp+8],ecx
    m.memory
        .write::<u32>(m.cpu.regs.ebp.wrapping_add(0x8u32), m.cpu.regs.ecx);
    // 00401f5f mov ecx,[ebp+0Ch]
    m.cpu.regs.ecx = m.memory.read::<u32>(m.cpu.regs.ebp.wrapping_add(0xcu32));
    // 00401f62 mov ds:[4095F4h],ecx
    m.memory.write::<u32>(0x4095f4u32, m.cpu.regs.ecx);
    // 00401f68 mov ecx,[eax+4]
    m.cpu.regs.ecx = m.memory.read::<u32>(m.cpu.regs.eax.wrapping_add(0x4u32));
    // 00401f6b cmp ecx,8
    sub(m.cpu.regs.ecx, 0x8u32, &mut m.cpu.flags);
...
pub fn x00401f74(m: &mut Machine) -> Cont {
    ...
    m.cpu.regs.ecx = m.memory.read::<u32>(0x407148u32);
    // 00401f7a mov edx,ds:[40714Ch]
    m.cpu.regs.edx = m.memory.read::<u32>(0x40714cu32);
    // 00401f80 add edx,ecx
    m.cpu.regs.edx = add(m.cpu.regs.edx, m.cpu.regs.ecx, &mut m.cpu.flags);
    // 00401f82 push esi
    push(m, m.cpu.regs.esi);
    // 00401f83 cmp ecx,edx
    sub(m.cpu.regs.ecx, m.cpu.regs.edx, &mut m.cpu.flags);
...
pub fn x00401f87(m: &mut Machine) -> Cont {
    ...
    m.cpu.regs.esi = m.cpu.regs.ecx.wrapping_add((m.cpu.regs.ecx * 2));
    // 00401f8a sub edx,ecx
    m.cpu.regs.edx = sub(m.cpu.regs.edx, m.cpu.regs.ecx, &mut m.cpu.flags);
    // 00401f8c lea esi,[esi*4+4070D8h]
    m.cpu.regs.esi = (m.cpu.regs.esi * 4).wrapping_add(0x4070d8u32);
    // 00401f93 and dword ptr [esi],0
    m.memory.write::<u32>(
        m.cpu.regs.esi,
        and(
            m.memory.read::<u32>(m.cpu.regs.esi),
            0x0u32,
            &mut m.cpu.flags,
        ),
    );
    // 00401f96 add esi,0Ch
    m.cpu.regs.esi = add(m.cpu.regs.esi, 0xcu32, &mut m.cpu.flags);
    // 00401f99 dec edx
    m.cpu.regs.edx = dec(m.cpu.regs.edx, &mut m.cpu.flags);
...
pub fn x00401f9c(m: &mut Machine) -> Cont {
    ...
    m.cpu.regs.eax = m.memory.read::<u32>(m.cpu.regs.eax);
    // 00401f9e mov esi,ds:[407154h]
    m.cpu.regs.esi = m.memory.read::<u32>(0x407154u32);
    // 00401fa4 cmp eax,0C000008Eh
    sub(m.cpu.regs.eax, 0xc000008eu32, &mut m.cpu.flags);
...
pub fn x00401fb7(m: &mut Machine) -> Cont {
    ...
    sub(m.cpu.regs.eax, 0xc0000090u32, &mut m.cpu.flags);
...
pub fn x00401fca(m: &mut Machine) -> Cont {
    ...
    sub(m.cpu.regs.eax, 0xc0000091u32, &mut m.cpu.flags);
...
pub fn x00401fdd(m: &mut Machine) -> Cont {
    ...
    sub(m.cpu.regs.eax, 0xc0000093u32, &mut m.cpu.flags);
...
pub fn x00401ff0(m: &mut Machine) -> Cont {
    ...
    sub(m.cpu.regs.eax, 0xc000008du32, &mut m.cpu.flags);
...
pub fn x00402003(m: &mut Machine) -> Cont {
    ...
    sub(m.cpu.regs.eax, 0xc000008fu32, &mut m.cpu.flags);
...
pub fn x00402016(m: &mut Machine) -> Cont {
    ...
    sub(m.cpu.regs.eax, 0xc0000092u32, &mut m.cpu.flags);
...
pub fn x00402031(m: &mut Machine) -> Cont {
    ...
    m.memory.write::<u32>(0x407154u32, m.cpu.regs.esi);
    // 00402038 pop ecx
    m.cpu.regs.ecx = pop(m);
    // 00402039 pop esi
    m.cpu.regs.esi = pop(m);
...
pub fn x00402043(m: &mut Machine) -> Cont {
    ...
    m.cpu.regs.eax = m.memory.read::<u32>(m.cpu.regs.ebp.wrapping_add(0x8u32));
    // 00402047 mov ds:[4095F4h],eax
    m.memory.write::<u32>(0x4095f4u32, m.cpu.regs.eax);
...
pub fn x0040205d(m: &mut Machine) -> Cont {
    ...
    m.cpu.regs.edx = m.memory.read::<u32>(m.cpu.regs.esp.wrapping_add(0x4u32));
    // 00402061 mov ecx,ds:[407150h]
    m.cpu.regs.ecx = m.memory.read::<u32>(0x407150u32);
    // 00402067 cmp ds:[4070D0h],edx
    sub(
        m.memory.read::<u32>(0x4070d0u32),
        m.cpu.regs.edx,
        &mut m.cpu.flags,
    );
    // 0040206d push esi
...
pub fn x00402075(m: &mut Machine) -> Cont {
    ...
    m.cpu.regs.esi = (m.cpu.regs.esi * 4).wrapping_add(0x4070d0u32);
    // 0040207f add eax,0Ch
    m.cpu.regs.eax = add(m.cpu.regs.eax, 0xcu32, &mut m.cpu.flags);
...
pub fn x0040208a(m: &mut Machine) -> Cont {
    ...
    m.cpu.regs.ecx = m.cpu.regs.ecx.wrapping_add((m.cpu.regs.ecx * 2));
    // 0040208d pop esi
    m.cpu.regs.esi = pop(m);
    // 0040208e lea ecx,[ecx*4+4070D0h]
    m.cpu.regs.ecx = (m.cpu.regs.ecx * 4).wrapping_add(0x4070d0u32);
    // 00402095 cmp eax,ecx
    sub(m.cpu.regs.eax, m.cpu.regs.ecx, &mut m.cpu.flags);
...
pub fn x004020a0(m: &mut Machine) -> Cont {
    ...
    sub(m.memory.read::<u32>(0x409aa8u32), 0x0u32, &mut m.cpu.flags);
...
pub fn x004020ae(m: &mut Machine) -> Cont {
    ...
    m.cpu.regs.esi = m.memory.read::<u32>(0x409ab8u32);
    // 004020b5 mov al,[esi]
    m.cpu.regs.set_al(m.memory.read::<u8>(m.cpu.regs.esi));
    // 004020b7 cmp al,22h
    sub(m.cpu.regs.get_al(), 0x22u8, &mut m.cpu.flags);
...
pub fn x004020bb(m: &mut Machine) -> Cont {
    ...
    m.cpu
        .regs
        .set_al(m.memory.read::<u8>(m.cpu.regs.esi.wrapping_add(0x1u32)));
    // 004020be inc esi
    m.cpu.regs.esi = inc(m.cpu.regs.esi, &mut m.cpu.flags);
    // 004020bf cmp al,22h
    sub(m.cpu.regs.get_al(), 0x22u8, &mut m.cpu.flags);
...
pub fn x004020c3(m: &mut Machine) -> Cont {
    // 004020c3 test al,al
    and(m.cpu.regs.get_al(), m.cpu.regs.get_al(), &mut m.cpu.flags);
...
pub fn x004020c7(m: &mut Machine) -> Cont {
    ...
    m.cpu.regs.eax = m.cpu.regs.get_al() as _;
    // 004020ca push eax
    push(m, m.cpu.regs.eax);
...
pub fn x004020d8(m: &mut Machine) -> Cont {
    ...
    sub(
        m.memory.read::<u8>(m.cpu.regs.esi),
        0x22u8,
        &mut m.cpu.flags,
    );
...
pub fn x004020e0(m: &mut Machine) -> Cont {
    // 004020e0 cmp al,20h
    sub(m.cpu.regs.get_al(), 0x20u8, &mut m.cpu.flags);
...
pub fn x004020f8(m: &mut Machine) -> Cont {
    ...
    m.cpu.regs.ebx = xor(m.cpu.regs.ebx, m.cpu.regs.ebx, &mut m.cpu.flags);
    // 004020fb cmp ds:[409AA8h],ebx
    sub(
        m.memory.read::<u32>(0x409aa8u32),
        m.cpu.regs.ebx,
        &mut m.cpu.flags,
    );
    // 00402101 push esi
...
pub fn x0040210a(m: &mut Machine) -> Cont {
    ...
    m.cpu.regs.esi = m.memory.read::<u32>(0x40959cu32);
    // 00402110 xor edi,edi
    m.cpu.regs.edi = xor(m.cpu.regs.edi, m.cpu.regs.edi, &mut m.cpu.flags);
    // 00402112 mov al,[esi]
    m.cpu.regs.set_al(m.memory.read::<u8>(m.cpu.regs.esi));
    // 00402114 cmp al,bl
    sub(m.cpu.regs.get_al(), m.cpu.regs.get_bl(), &mut m.cpu.flags);
...
pub fn x00402118(m: &mut Machine) -> Cont {
    // 00402118 cmp al,3Dh
    sub(m.cpu.regs.get_al(), 0x3du8, &mut m.cpu.flags);
...
pub fn x0040211c(m: &mut Machine) -> Cont {
    // 0040211c inc edi
    m.cpu.regs.edi = inc(m.cpu.regs.edi, &mut m.cpu.flags);
    // 0040211d push esi
    push(m, m.cpu.regs.esi);
...
pub fn x0040212a(m: &mut Machine) -> Cont {
    ...
    m.cpu.regs.eax = (m.cpu.regs.edi * 4).wrapping_add(0x4u32);
    // 00402131 push eax
    push(m, m.cpu.regs.eax);
...
pub fn x00402137(m: &mut Machine) -> Cont {
    ...
    sub(m.cpu.regs.esi, m.cpu.regs.ebx, &mut m.cpu.flags);
    // 0040213c mov ds:[4095D0h],esi
    m.memory.write::<u32>(0x4095d0u32, m.cpu.regs.esi);
...
pub fn x0040214b(m: &mut Machine) -> Cont {
    ...
    m.cpu.regs.edi = m.memory.read::<u32>(0x40959cu32);
    // 00402152 cmp [edi],bl
    sub(
        m.memory.read::<u8>(m.cpu.regs.edi),
        m.cpu.regs.get_bl(),
        &mut m.cpu.flags,
    );
...
pub fn x0040215d(m: &mut Machine) -> Cont {
    ...
    m.cpu.regs.ecx = pop(m);
    // 00402160 inc ebp
    m.cpu.regs.ebp = inc(m.cpu.regs.ebp, &mut m.cpu.flags);
...
pub fn x0040216c(m: &mut Machine) -> Cont {
    ...
    sub(m.cpu.regs.eax, m.cpu.regs.ebx, &mut m.cpu.flags);
    // 0040216e pop ecx
    m.cpu.regs.ecx = pop(m);
    // 0040216f mov [esi],eax
    m.memory.write::<u32>(m.cpu.regs.esi, m.cpu.regs.eax);
...
pub fn x0040217a(m: &mut Machine) -> Cont {
    ...
    push(m, m.memory.read::<u32>(m.cpu.regs.esi));
...
pub fn x00402183(m: &mut Machine) -> Cont {
    ...
    m.cpu.regs.edi = add(m.cpu.regs.edi, m.cpu.regs.ebp, &mut m.cpu.flags);
    // 0040218a cmp [edi],bl
    sub(
        m.memory.read::<u8>(m.cpu.regs.edi),
        m.cpu.regs.get_bl(),
...
pub fn x0040219a(m: &mut Machine) -> Cont {
    ...
    m.memory.write::<u32>(0x40959cu32, m.cpu.regs.ebx);
    // 004021a1 mov [esi],ebx
    m.memory.write::<u32>(m.cpu.regs.esi, m.cpu.regs.ebx);
    // 004021a3 pop edi
    m.cpu.regs.edi = pop(m);
    // 004021a4 pop esi
    m.cpu.regs.esi = pop(m);
    // 004021a5 mov dword ptr ds:[409AA4h],1
    m.memory.write::<u32>(0x409aa4u32, 0x1u32);
    // 004021af pop ebx
    m.cpu.regs.ebx = pop(m);
    // 004021b0 ret
    ret(m, 0)
...
pub fn x004021da(m: &mut Machine) -> Cont {
    ...
    m.cpu.regs.eax = m.memory.read::<u32>(0x409ab8u32);
    // 004021df mov ds:[4095E0h],esi
    m.memory.write::<u32>(0x4095e0u32, m.cpu.regs.esi);
    // 004021e5 mov edi,esi
    m.cpu.regs.edi = m.cpu.regs.esi;
    // 004021e7 cmp [eax],bl
    sub(
        m.memory.read::<u8>(m.cpu.regs.eax),
        m.cpu.regs.get_bl(),
        &mut m.cpu.flags,
    );
...
pub fn x004021fd(m: &mut Machine) -> Cont {
    ...
    m.cpu.regs.eax = m
        .memory
        .read::<u32>(m.cpu.regs.ebp.wrapping_add(0xfffffff8u32));
    // 00402200 mov ecx,[ebp-4]
    m.cpu.regs.ecx = m
        .memory
        .read::<u32>(m.cpu.regs.ebp.wrapping_add(0xfffffffcu32));
    // 00402203 lea eax,[eax+ecx*4]
    m.cpu.regs.eax = m.cpu.regs.eax.wrapping_add((m.cpu.regs.ecx * 4));
    // 00402206 push eax
    push(m, m.cpu.regs.eax);
...
pub fn x0040221c(m: &mut Machine) -> Cont {
    ...
    m.cpu.regs.eax = m.cpu.regs.esi.wrapping_add((m.cpu.regs.eax * 4));
    // 0040222b push eax
    push(m, m.cpu.regs.eax);
    // 0040222c push esi
    push(m, m.cpu.regs.esi);
...
pub fn x00402233(m: &mut Machine) -> Cont {
    ...
    m.memory.write::<u32>(0x4095c8u32, m.cpu.regs.esi);
    // 00402240 pop edi
    m.cpu.regs.edi = pop(m);
    // 00402241 pop esi
    m.cpu.regs.esi = pop(m);
    // 00402242 mov ds:[4095C4h],eax
    m.memory.write::<u32>(0x4095c4u32, m.cpu.regs.eax);
    // 00402247 pop ebx
    m.cpu.regs.ebx = pop(m);
    // 00402248 leave
    leave(m);
...
pub fn x0040224a(m: &mut Machine) -> Cont {
    ...
    m.cpu.regs.ecx = m.memory.read::<u32>(m.cpu.regs.ebp.wrapping_add(0x18u32));
    // 00402250 mov eax,[ebp+14h]
    m.cpu.regs.eax = m.memory.read::<u32>(m.cpu.regs.ebp.wrapping_add(0x14u32));
    // 00402253 push ebx
    push(m, m.cpu.regs.ebx);
    // 00402254 push esi
    push(m, m.cpu.regs.esi);
    ...
    m.memory.write::<u32>(
        m.cpu.regs.ecx,
        and(
            m.memory.read::<u32>(m.cpu.regs.ecx),
            0x0u32,
            &mut m.cpu.flags,
        ),
    );
    // 00402258 mov esi,[ebp+10h]
    m.cpu.regs.esi = m.memory.read::<u32>(m.cpu.regs.ebp.wrapping_add(0x10u32));
    // 0040225b push edi
    push(m, m.cpu.regs.edi);
    // 0040225c mov edi,[ebp+0Ch]
    m.cpu.regs.edi = m.memory.read::<u32>(m.cpu.regs.ebp.wrapping_add(0xcu32));
    // 0040225f mov dword ptr [eax],1
    m.memory.write::<u32>(m.cpu.regs.eax, 0x1u32);
...
pub fn x0040226c(m: &mut Machine) -> Cont {
    ...
    m.memory.write::<u32>(m.cpu.regs.edi, m.cpu.regs.esi);
    // 0040226e add edi,4
    m.cpu.regs.edi = add(m.cpu.regs.edi, 0x4u32, &mut m.cpu.flags);
    // 00402271 mov [ebp+0Ch],edi
    m.memory
        .write::<u32>(m.cpu.regs.ebp.wrapping_add(0xcu32), m.cpu.regs.edi);
...
pub fn x00402279(m: &mut Machine) -> Cont {
    ...
    m.cpu
        .regs
        .set_dl(m.memory.read::<u8>(m.cpu.regs.eax.wrapping_add(0x1u32)));
    // 0040227c inc eax
    m.cpu.regs.eax = inc(m.cpu.regs.eax, &mut m.cpu.flags);
    // 0040227d cmp dl,22h
    sub(m.cpu.regs.get_dl(), 0x22u8, &mut m.cpu.flags);
...
pub fn x00402282(m: &mut Machine) -> Cont {
    // 00402282 test dl,dl
    and(m.cpu.regs.get_dl(), m.cpu.regs.get_dl(), &mut m.cpu.flags);
...
pub fn x00402286(m: &mut Machine) -> Cont {
    ...
    m.cpu.regs.edx = m.cpu.regs.get_dl() as _;
    // 00402289 test byte ptr [edx+409861h],4
    and(
        m.memory
            .read::<u8>(m.cpu.regs.edx.wrapping_add(0x409861u32)),
        0x4u8,
        &mut m.cpu.flags,
    );
...
pub fn x00402292(m: &mut Machine) -> Cont {
    ...
    m.memory.write::<u32>(
        m.cpu.regs.ecx,
        inc(m.memory.read::<u32>(m.cpu.regs.ecx), &mut m.cpu.flags),
    );
...
pub fn x00402298(m: &mut Machine) -> Cont {
    // 00402298 mov dl,[eax]
    m.cpu.regs.set_dl(m.memory.read::<u8>(m.cpu.regs.eax));
    // 0040229a mov [esi],dl
    m.memory.write::<u8>(m.cpu.regs.esi, m.cpu.regs.get_dl());
    // 0040229c inc esi
    m.cpu.regs.esi = inc(m.cpu.regs.esi, &mut m.cpu.flags);
    // 0040229d inc eax
    m.cpu.regs.eax = inc(m.cpu.regs.eax, &mut m.cpu.flags);
...
pub fn x004022b1(m: &mut Machine) -> Cont {
    ...
    m.memory.write::<u8>(
        m.cpu.regs.esi,
        and(m.memory.read::<u8>(m.cpu.regs.esi), 0x0u8, &mut m.cpu.flags),
    );
    // 004022b4 inc esi
    m.cpu.regs.esi = inc(m.cpu.regs.esi, &mut m.cpu.flags);
...
pub fn x004022c3(m: &mut Machine) -> Cont {
    ...
    m.cpu.regs.ebx = m.cpu.regs.get_dl() as _;
    // 004022ce test byte ptr [ebx+409861h],4
    and(
        m.memory
            .read::<u8>(m.cpu.regs.ebx.wrapping_add(0x409861u32)),
        0x4u8,
        &mut m.cpu.flags,
    );
...
pub fn x004022dd(m: &mut Machine) -> Cont {
    // 004022dd mov bl,[eax]
    m.cpu.regs.set_bl(m.memory.read::<u8>(m.cpu.regs.eax));
    // 004022df mov [esi],bl
    m.memory.write::<u8>(m.cpu.regs.esi, m.cpu.regs.get_bl());
    // 004022e1 inc esi
    m.cpu.regs.esi = inc(m.cpu.regs.esi, &mut m.cpu.flags);
    // 004022e2 inc eax
    m.cpu.regs.eax = inc(m.cpu.regs.eax, &mut m.cpu.flags);
    // 004022e3 cmp dl,20h
    sub(m.cpu.regs.get_dl(), 0x20u8, &mut m.cpu.flags);
...
pub fn x004022ec(m: &mut Machine) -> Cont {
    // 004022ec cmp dl,9
    sub(m.cpu.regs.get_dl(), 0x9u8, &mut m.cpu.flags);
...
pub fn x004022fc(m: &mut Machine) -> Cont {
    ...
    m.memory.write::<u8>(
        m.cpu.regs.esi.wrapping_add(0xffffffffu32),
        and(
            m.memory
                .read::<u8>(m.cpu.regs.esi.wrapping_add(0xffffffffu32)),
            0x0u8,
            &mut m.cpu.flags,
        ),
    );
    ...
    m.memory.write::<u32>(
        m.cpu.regs.ebp.wrapping_add(0x18u32),
        and(
            m.memory.read::<u32>(m.cpu.regs.ebp.wrapping_add(0x18u32)),
            0x0u32,
            &mut m.cpu.flags,
        ),
    );
    // 00402304 cmp byte ptr [eax],0
    sub(m.memory.read::<u8>(m.cpu.regs.eax), 0x0u8, &mut m.cpu.flags);
...
pub fn x00402329(m: &mut Machine) -> Cont {
    ...
    m.cpu.regs.edx = m.memory.read::<u32>(m.cpu.regs.ebp.wrapping_add(0x14u32));
    // 00402334 inc dword ptr [edx]
    m.memory.write::<u32>(
        m.cpu.regs.edx,
        inc(m.memory.read::<u32>(m.cpu.regs.edx), &mut m.cpu.flags),
    );
    // 00402336 mov dword ptr [ebp+8],1
    m.memory
        .write::<u32>(m.cpu.regs.ebp.wrapping_add(0x8u32), 0x1u32);
...
pub fn x00402344(m: &mut Machine) -> Cont {
    ...
    m.cpu.regs.eax = inc(m.cpu.regs.eax, &mut m.cpu.flags);
    // 00402345 inc ebx
    m.cpu.regs.ebx = inc(m.cpu.regs.ebx, &mut m.cpu.flags);
...
pub fn x0040234d(m: &mut Machine) -> Cont {
    // 0040234d test bl,1
    and(m.cpu.regs.get_bl(), 0x1u8, &mut m.cpu.flags);
...
pub fn x00402359(m: &mut Machine) -> Cont {
    ...
    sub(
        m.memory.read::<u8>(m.cpu.regs.eax.wrapping_add(0x1u32)),
        0x22u8,
        &mut m.cpu.flags,
    );
    // 0040235d lea edx,[eax+1]
    m.cpu.regs.edx = m.cpu.regs.eax.wrapping_add(0x1u32);
...
pub fn x00402366(m: &mut Machine) -> Cont {
    ...
    m.memory
        .write::<u32>(m.cpu.regs.ebp.wrapping_add(0x8u32), m.cpu.regs.edi);
    ...
    // 00402371 sete dl
    m.cpu.regs.set_dl(sete(m));
    // 00402374 mov [ebp+18h],edx
    m.memory
        .write::<u32>(m.cpu.regs.ebp.wrapping_add(0x18u32), m.cpu.regs.edx);
    // 00402377 shr ebx,1
    m.cpu.regs.ebx = shr(m.cpu.regs.ebx, 0x1u8, &mut m.cpu.flags);
    // 00402379 mov edx,ebx
    m.cpu.regs.edx = m.cpu.regs.ebx;
    // 0040237b dec ebx
    m.cpu.regs.ebx = dec(m.cpu.regs.ebx, &mut m.cpu.flags);
...
pub fn x00402385(m: &mut Machine) -> Cont {
    ...
    m.memory.write::<u8>(m.cpu.regs.esi, 0x5cu8);
    // 00402388 inc esi
    m.cpu.regs.esi = inc(m.cpu.regs.esi, &mut m.cpu.flags);
...
pub fn x004023f1(m: &mut Machine) -> Cont {
    ...
    m.memory.write::<u32>(
        m.cpu.regs.edi,
        and(
            m.memory.read::<u32>(m.cpu.regs.edi),
            0x0u32,
            &mut m.cpu.flags,
        ),
    );
    ...
    m.memory.write::<u32>(
        m.cpu.regs.eax,
        inc(m.memory.read::<u32>(m.cpu.regs.eax), &mut m.cpu.flags),
    );
    // 004023fc pop ebp
    m.cpu.regs.ebp = pop(m);
    // 004023fd ret
...
pub fn x004023fe(m: &mut Machine) -> Cont {
    ...
    m.cpu.regs.eax = m.memory.read::<u32>(0x4096fcu32);
    // 00402405 push ebx
    push(m, m.cpu.regs.ebx);
    // 00402406 push ebp
    push(m, m.cpu.regs.ebp);
    // 00402407 mov ebp,ds:[4060ACh]
    m.cpu.regs.ebp = m.memory.read::<u32>(0x4060acu32);
    // 0040240d push esi
    push(m, m.cpu.regs.esi);
    // 0040240e push edi
    push(m, m.cpu.regs.edi);
...
pub fn x00402419(m: &mut Machine) -> Cont {
    // 00402419 call ebp
    let dst = indirect(m, m.cpu.regs.ebp);
    call(m, 0x40241b, dst)
}
...
pub fn x00402433(m: &mut Machine) -> Cont {
    ...
    sub(m.cpu.regs.edi, m.cpu.regs.ebx, &mut m.cpu.flags);
...
pub fn x0040244c(m: &mut Machine) -> Cont {
    // 0040244c cmp eax,1
    sub(m.cpu.regs.eax, 0x1u32, &mut m.cpu.flags);
...
pub fn x00402465(m: &mut Machine) -> Cont {
    // 00402465 cmp [esi],bx
    sub(
        m.memory.read::<u16>(m.cpu.regs.esi),
        m.cpu.regs.get_bx(),
        &mut m.cpu.flags,
    );
...
pub fn x0040246c(m: &mut Machine) -> Cont {
    ...
    // 0040246e cmp [eax],bx
    sub(
        m.memory.read::<u16>(m.cpu.regs.eax),
        m.cpu.regs.get_bx(),
        &mut m.cpu.flags,
    );
...
pub fn x0040247a(m: &mut Machine) -> Cont {
    ...
    m.cpu.regs.eax = sub(m.cpu.regs.eax, m.cpu.regs.esi, &mut m.cpu.flags);
    // 0040247c mov edi,ds:[4060A4h]
    m.cpu.regs.edi = m.memory.read::<u32>(0x4060a4u32);
    // 00402482 sar eax,1
    m.cpu.regs.eax = sar(m.cpu.regs.eax, 0x1u8, &mut m.cpu.flags);
    // 00402484 push ebx
    push(m, m.cpu.regs.ebx);
    // 00402485 push ebx
    push(m, m.cpu.regs.ebx);
    ...
    m.memory
        .write::<u32>(m.cpu.regs.esp.wrapping_add(0x34u32), m.cpu.regs.eax);
    // 00402491 call edi
    let dst = indirect(m, m.cpu.regs.edi);
    call(m, 0x402493, dst)
}
...
pub fn x00402493(m: &mut Machine) -> Cont {
    ...
    sub(m.cpu.regs.ebp, m.cpu.regs.ebx, &mut m.cpu.flags);
...
pub fn x004024a8(m: &mut Machine) -> Cont {
    ...
    push(
        m,
        m.memory.read::<u32>(m.cpu.regs.esp.wrapping_add(0x24u32)),
    );
    // 004024b0 push esi
    push(m, m.cpu.regs.esi);
    // 004024b1 push ebx
...
pub fn x004024c2(m: &mut Machine) -> Cont {
    ...
    m.memory
        .write::<u32>(m.cpu.regs.esp.wrapping_add(0x10u32), m.cpu.regs.ebx);
    // 004024c7 mov ebx,[esp+10h]
    m.cpu.regs.ebx = m.memory.read::<u32>(m.cpu.regs.esp.wrapping_add(0x10u32));
    // 004024cb push esi
    push(m, m.cpu.regs.esi);
...
pub fn x004024fb(m: &mut Machine) -> Cont {
    ...
    m.cpu.regs.eax = sub(m.cpu.regs.eax, m.cpu.regs.edi, &mut m.cpu.flags);
    // 004024fd inc eax
    m.cpu.regs.eax = inc(m.cpu.regs.eax, &mut m.cpu.flags);
...
pub fn x00402530(m: &mut Machine) -> Cont {
    ...
    m.cpu.regs.esp = sub(m.cpu.regs.esp, 0x44u32, &mut m.cpu.flags);
    // 00402533 push ebx
    push(m, m.cpu.regs.ebx);
    // 00402534 push ebp
    push(m, m.cpu.regs.ebp);
...
pub fn x0040254f(m: &mut Machine) -> Cont {
    ...
    m.memory.write::<u32>(0x4099a0u32, m.cpu.regs.esi);
    // 00402556 mov dword ptr ds:[409AA0h],20h
    m.memory.write::<u32>(0x409aa0u32, 0x20u32);
    // 00402560 lea eax,[esi+100h]
    m.cpu.regs.eax = m.cpu.regs.esi.wrapping_add(0x100u32);
...
pub fn x0040256a(m: &mut Machine) -> Cont {
    ...
    m.memory.write::<u8>(
        m.cpu.regs.esi.wrapping_add(0x4u32),
        and(
            m.memory.read::<u8>(m.cpu.regs.esi.wrapping_add(0x4u32)),
            0x0u8,
            &mut m.cpu.flags,
        ),
    );
    ...
    m.memory
        .write::<u8>(m.cpu.regs.esi.wrapping_add(0x5u32), 0xau8);
    // 00402575 mov eax,ds:[4099A0h]
    m.cpu.regs.eax = m.memory.read::<u32>(0x4099a0u32);
    // 0040257a add esi,8
    m.cpu.regs.esi = add(m.cpu.regs.esi, 0x8u32, &mut m.cpu.flags);
    // 0040257d add eax,100h
    m.cpu.regs.eax = add(m.cpu.regs.eax, 0x100u32, &mut m.cpu.flags);
...
pub fn x0040258f(m: &mut Machine) -> Cont {
    ...
    sub(
        m.memory.read::<u16>(m.cpu.regs.esp.wrapping_add(0x42u32)),
        0x0u16,
        &mut m.cpu.flags,
    );
...
pub fn x0040259b(m: &mut Machine) -> Cont {
    ...
    m.cpu.regs.eax = m.memory.read::<u32>(m.cpu.regs.esp.wrapping_add(0x44u32));
...
pub fn x004025a7(m: &mut Machine) -> Cont {
    ...
    m.cpu.regs.esi = m.memory.read::<u32>(m.cpu.regs.eax);
    // 004025a9 lea ebp,[eax+4]
    m.cpu.regs.ebp = m.cpu.regs.eax.wrapping_add(0x4u32);
    // 004025ac mov eax,800h
    m.cpu.regs.eax = 0x800u32;
    // 004025b1 cmp esi,eax
    sub(m.cpu.regs.esi, m.cpu.regs.eax, &mut m.cpu.flags);
    // 004025b3 lea ebx,[esi+ebp]
    m.cpu.regs.ebx = m.cpu.regs.esi.wrapping_add(m.cpu.regs.ebp);
...
pub fn x004025d6(m: &mut Machine) -> Cont {
    ...
    m.memory.write::<u32>(
        0x409aa0u32,
        add(m.memory.read::<u32>(0x409aa0u32), 0x20u32, &mut m.cpu.flags),
    );
    // 004025dd mov [edi],eax
    m.memory.write::<u32>(m.cpu.regs.edi, m.cpu.regs.eax);
    // 004025df lea ecx,[eax+100h]
    m.cpu.regs.ecx = m.cpu.regs.eax.wrapping_add(0x100u32);
...
pub fn x004025e9(m: &mut Machine) -> Cont {
    ...
    m.memory.write::<u8>(
        m.cpu.regs.eax.wrapping_add(0x4u32),
        and(
            m.memory.read::<u8>(m.cpu.regs.eax.wrapping_add(0x4u32)),
            0x0u8,
            &mut m.cpu.flags,
        ),
    );
    ...
    m.memory
        .write::<u8>(m.cpu.regs.eax.wrapping_add(0x5u32), 0xau8);
    // 004025f4 mov ecx,[edi]
    m.cpu.regs.ecx = m.memory.read::<u32>(m.cpu.regs.edi);
    // 004025f6 add eax,8
    m.cpu.regs.eax = add(m.cpu.regs.eax, 0x8u32, &mut m.cpu.flags);
    // 004025f9 add ecx,100h
    m.cpu.regs.ecx = add(m.cpu.regs.ecx, 0x100u32, &mut m.cpu.flags);
...
pub fn x0040260e(m: &mut Machine) -> Cont {
    ...
    m.cpu.regs.esi = m.memory.read::<u32>(0x409aa0u32);
...
pub fn x0040261a(m: &mut Machine) -> Cont {
    ...
    m.cpu.regs.eax = m.memory.read::<u32>(m.cpu.regs.ebx);
    // 0040261c cmp eax,0FFFFFFFFh
    sub(m.cpu.regs.eax, 0xffffffffu32, &mut m.cpu.flags);
...
pub fn x00402621(m: &mut Machine) -> Cont {
    // 00402621 mov cl,[ebp]
    m.cpu.regs.set_cl(m.memory.read::<u8>(m.cpu.regs.ebp));
    // 00402624 test cl,1
    and(m.cpu.regs.get_cl(), 0x1u8, &mut m.cpu.flags);
...
pub fn x00402629(m: &mut Machine) -> Cont {
    // 00402629 test cl,8
    and(m.cpu.regs.get_cl(), 0x8u8, &mut m.cpu.flags);
...
pub fn x00402639(m: &mut Machine) -> Cont {
    ...
    m.cpu.regs.ecx = m.cpu.regs.edi;
    // 0040263d sar eax,5
    m.cpu.regs.eax = sar(m.cpu.regs.eax, 0x5u8, &mut m.cpu.flags);
    // 00402640 and ecx,1Fh
    m.cpu.regs.ecx = and(m.cpu.regs.ecx, 0x1fu32, &mut m.cpu.flags);
    // 00402643 mov eax,[eax*4+4099A0h]
    m.cpu.regs.eax = m
        .memory
        .read::<u32>((m.cpu.regs.eax * 4).wrapping_add(0x4099a0u32));
    // 0040264a lea eax,[eax+ecx*8]
    m.cpu.regs.eax = m.cpu.regs.eax.wrapping_add((m.cpu.regs.ecx * 8));
    // 0040264d mov ecx,[ebx]
    m.cpu.regs.ecx = m.memory.read::<u32>(m.cpu.regs.ebx);
    // 0040264f mov [eax],ecx
    m.memory.write::<u32>(m.cpu.regs.eax, m.cpu.regs.ecx);
    // 00402651 mov cl,[ebp]
    m.cpu.regs.set_cl(m.memory.read::<u8>(m.cpu.regs.ebp));
    // 00402654 mov [eax+4],cl
    m.memory
        .write::<u8>(m.cpu.regs.eax.wrapping_add(0x4u32), m.cpu.regs.get_cl());
    // 00402657 inc edi
    m.cpu.regs.edi = inc(m.cpu.regs.edi, &mut m.cpu.flags);
    // 00402658 inc ebp
    m.cpu.regs.ebp = inc(m.cpu.regs.ebp, &mut m.cpu.flags);
    // 00402659 add ebx,4
    m.cpu.regs.ebx = add(m.cpu.regs.ebx, 0x4u32, &mut m.cpu.flags);
    // 0040265c cmp edi,esi
    sub(m.cpu.regs.edi, m.cpu.regs.esi, &mut m.cpu.flags);
...
pub fn x00402660(m: &mut Machine) -> Cont {
    ...
    sub(
        m.memory
            .read::<u32>(m.cpu.regs.eax.wrapping_add((m.cpu.regs.ebx * 8))),
        0xffffffffu32,
        &mut m.cpu.flags,
    );
    // 0040266b lea esi,[eax+ebx*8]
    m.cpu.regs.esi = m.cpu.regs.eax.wrapping_add((m.cpu.regs.ebx * 8));
...
pub fn x00402670(m: &mut Machine) -> Cont {
    ...
    m.memory
        .write::<u8>(m.cpu.regs.esi.wrapping_add(0x4u32), 0x81u8);
...
pub fn x0040267d(m: &mut Machine) -> Cont {
    ...
    m.cpu.regs.eax = add(m.cpu.regs.eax, 0xfffffff5u32, &mut m.cpu.flags);
    // 00402687 push eax
    push(m, m.cpu.regs.eax);
...
pub fn x0040268e(m: &mut Machine) -> Cont {
    ...
    sub(m.cpu.regs.edi, 0xffffffffu32, &mut m.cpu.flags);
...
pub fn x004026a0(m: &mut Machine) -> Cont {
    ...
    m.cpu.regs.eax = and(m.cpu.regs.eax, 0xffu32, &mut m.cpu.flags);
    // 004026a5 mov [esi],edi
    m.memory.write::<u32>(m.cpu.regs.esi, m.cpu.regs.edi);
    // 004026a7 cmp eax,2
    sub(m.cpu.regs.eax, 0x2u32, &mut m.cpu.flags);
...
pub fn x004026bd(m: &mut Machine) -> Cont {
    ...
    m.cpu.regs.ebx = inc(m.cpu.regs.ebx, &mut m.cpu.flags);
    // 004026c2 cmp ebx,3
    sub(m.cpu.regs.ebx, 0x3u32, &mut m.cpu.flags);
...
pub fn x004026d3(m: &mut Machine) -> Cont {
    ...
    m.cpu.regs.esp = add(m.cpu.regs.esp, 0x44u32, &mut m.cpu.flags);
    // 004026da ret
    ret(m, 0)
}
...
pub fn x004026f2(m: &mut Machine) -> Cont {
    ...
    m.cpu.regs.ecx = m.memory.read::<u32>(m.cpu.regs.eax.wrapping_add(0x3cu32));
    // 004026f5 test ecx,ecx
    and(m.cpu.regs.ecx, m.cpu.regs.ecx, &mut m.cpu.flags);
...
pub fn x004026f9(m: &mut Machine) -> Cont {
    ...
    m.cpu.regs.eax = add(m.cpu.regs.eax, m.cpu.regs.ecx, &mut m.cpu.flags);
    // 004026fb mov cl,[eax+1Ah]
    m.cpu
        .regs
        .set_cl(m.memory.read::<u8>(m.cpu.regs.eax.wrapping_add(0x1au32)));
    // 004026fe mov [esi],cl
    m.memory.write::<u8>(m.cpu.regs.esi, m.cpu.regs.get_cl());
    // 00402700 mov al,[eax+1Bh]
    m.cpu
        .regs
        .set_al(m.memory.read::<u8>(m.cpu.regs.eax.wrapping_add(0x1bu32)));
    // 00402703 mov [esi+1],al
    m.memory
        .write::<u8>(m.cpu.regs.esi.wrapping_add(0x1u32), m.cpu.regs.get_al());
    // 00402706 pop esi
    m.cpu.regs.esi = pop(m);
    // 00402707 ret
    ret(m, 0)
...
pub fn x00402715(m: &mut Machine) -> Cont {
    ...
    m.cpu.regs.eax = m.cpu.regs.ebp.wrapping_add(0xffffff68u32);
    // 0040271b push ebx
    push(m, m.cpu.regs.ebx);
    // 0040271c push eax
    push(m, m.cpu.regs.eax);
    ...
    m.memory
        .write::<u32>(m.cpu.regs.ebp.wrapping_add(0xffffff68u32), 0x94u32);
...
pub fn x00402731(m: &mut Machine) -> Cont {
    ...
    sub(
        m.memory
            .read::<u32>(m.cpu.regs.ebp.wrapping_add(0xffffff78u32)),
        0x2u32,
        &mut m.cpu.flags,
    );
...
pub fn x0040273a(m: &mut Machine) -> Cont {
    ...
    sub(
        m.memory
            .read::<u32>(m.cpu.regs.ebp.wrapping_add(0xffffff6cu32)),
        0x5u32,
        &mut m.cpu.flags,
    );
...
pub fn x0040274b(m: &mut Machine) -> Cont {
    ...
    m.cpu.regs.eax = m.cpu.regs.ebp.wrapping_add(0xffffedd4u32);
    // 00402751 push 1090h
    push(m, 0x1090u32);
    // 00402756 push eax
    push(m, m.cpu.regs.eax);
...
pub fn x0040276a(m: &mut Machine) -> Cont {
    ...
    m.cpu.regs.ecx = m.cpu.regs.ebp.wrapping_add(0xffffedd4u32);
    // 00402772 cmp [ebp-122Ch],bl
    sub(
        m.memory
            .read::<u8>(m.cpu.regs.ebp.wrapping_add(0xffffedd4u32)),
        m.cpu.regs.get_bl(),
        &mut m.cpu.flags,
    );
...
pub fn x0040277a(m: &mut Machine) -> Cont {
    // 0040277a mov al,[ecx]
    m.cpu.regs.set_al(m.memory.read::<u8>(m.cpu.regs.ecx));
    // 0040277c cmp al,61h
    sub(m.cpu.regs.get_al(), 0x61u8, &mut m.cpu.flags);
...
pub fn x00402780(m: &mut Machine) -> Cont {
    // 00402780 cmp al,7Ah
    sub(m.cpu.regs.get_al(), 0x7au8, &mut m.cpu.flags);
...
pub fn x00402784(m: &mut Machine) -> Cont {
    ...
    m.cpu
        .regs
        .set_al(sub(m.cpu.regs.get_al(), 0x20u8, &mut m.cpu.flags));
    // 00402786 mov [ecx],al
    m.memory.write::<u8>(m.cpu.regs.ecx, m.cpu.regs.get_al());
    // 00402788 inc ecx
    m.cpu.regs.ecx = inc(m.cpu.regs.ecx, &mut m.cpu.flags);
    // 00402789 cmp [ecx],bl
    sub(
        m.memory.read::<u8>(m.cpu.regs.ecx),
        m.cpu.regs.get_bl(),
        &mut m.cpu.flags,
    );
...
pub fn x004027af(m: &mut Machine) -> Cont {
    ...
    m.cpu.regs.eax = m.cpu.regs.ebp.wrapping_add(0xfffffe64u32);
    // 004027b5 push 104h
    push(m, 0x104u32);
    // 004027ba push eax
    push(m, m.cpu.regs.eax);
...
pub fn x004027c2(m: &mut Machine) -> Cont {
    ...
    sub(
        m.memory
            .read::<u8>(m.cpu.regs.ebp.wrapping_add(0xfffffe64u32)),
        m.cpu.regs.get_bl(),
        &mut m.cpu.flags,
    );
    // 004027c8 lea ecx,[ebp-19Ch]
    m.cpu.regs.ecx = m.cpu.regs.ebp.wrapping_add(0xfffffe64u32);
...
pub fn x00402816(m: &mut Machine) -> Cont {
    // 00402816 mov [ecx],bl
    m.memory.write::<u8>(m.cpu.regs.ecx, m.cpu.regs.get_bl());
...
pub fn x00402843(m: &mut Machine) -> Cont {
    ...
    sub(
        m.memory
            .read::<u8>(m.cpu.regs.ebp.wrapping_add(0xfffffffcu32)),
        0x6u8,
        &mut m.cpu.flags,
    );
    // 00402847 pop ecx
    ...
    m.cpu.regs.eax = sbb(m.cpu.regs.eax, m.cpu.regs.eax, &mut m.cpu.flags);
    // 0040284a add eax,3
    m.cpu.regs.eax = add(m.cpu.regs.eax, 0x3u32, &mut m.cpu.flags);
    // 0040284d pop ebx
    m.cpu.regs.ebx = pop(m);
    // 0040284e leave
    leave(m);
...
pub fn x00402867(m: &mut Machine) -> Cont {
    ...
    m.memory.write::<u32>(0x409984u32, m.cpu.regs.eax);
...
pub fn x00402875(m: &mut Machine) -> Cont {
    ...
    m.memory.write::<u32>(0x409988u32, m.cpu.regs.eax);
...
pub fn x00402a80(m: &mut Machine) -> Cont {
    ...
    m.cpu.regs.eax = m.memory.read::<u32>(0x4095a4u32);
    // 00402a85 cmp eax,1
    sub(m.cpu.regs.eax, 0x1u32, &mut m.cpu.flags);
...
pub fn x00402a8e(m: &mut Machine) -> Cont {
    ...
    sub(m.memory.read::<u32>(0x4070c8u32), 0x1u32, &mut m.cpu.flags);
...
pub fn x00402aa1(m: &mut Machine) -> Cont {
    ...
    m.cpu.regs.eax = m.memory.read::<u32>(0x409700u32);
    // 00402aa6 pop ecx
    m.cpu.regs.ecx = pop(m);
...
pub fn x00402ab9(m: &mut Machine) -> Cont {
    ...
    m.cpu.regs.esp = sub(m.cpu.regs.esp, 0x1a4u32, &mut m.cpu.flags);
    // 00402ac2 mov edx,[ebp+8]
    m.cpu.regs.edx = m.memory.read::<u32>(m.cpu.regs.ebp.wrapping_add(0x8u32));
    // 00402ac5 xor ecx,ecx
    m.cpu.regs.ecx = xor(m.cpu.regs.ecx, m.cpu.regs.ecx, &mut m.cpu.flags);
    // 00402ac7 mov eax,407178h
    m.cpu.regs.eax = 0x407178u32;
...
pub fn x00402ad0(m: &mut Machine) -> Cont {
    ...
    sub(m.cpu.regs.eax, 0x407208u32, &mut m.cpu.flags);
...
pub fn x00402adb(m: &mut Machine) -> Cont {
    ...
    m.cpu.regs.esi = m.cpu.regs.ecx;
    // 00402ade shl esi,3
    m.cpu.regs.esi = shl(m.cpu.regs.esi, 0x3u8, &mut m.cpu.flags);
    // 00402ae1 cmp edx,[esi+407178h]
    sub(
        m.cpu.regs.edx,
        m.memory
            .read::<u32>(m.cpu.regs.esi.wrapping_add(0x407178u32)),
        &mut m.cpu.flags,
    );
...
pub fn x00402b0c(m: &mut Machine) -> Cont {
    ...
    sub(m.cpu.regs.edx, 0xfcu32, &mut m.cpu.flags);
...
pub fn x00402b18(m: &mut Machine) -> Cont {
    ...
    m.cpu.regs.eax = m.cpu.regs.ebp.wrapping_add(0xfffffe5cu32);
    // 00402b1e push 104h
    push(m, 0x104u32);
    // 00402b23 push eax
    push(m, m.cpu.regs.eax);
...
pub fn x00402b41(m: &mut Machine) -> Cont {
    ...
    m.cpu.regs.edi = m.cpu.regs.ebp.wrapping_add(0xfffffe5cu32);
...
pub fn x00402b56(m: &mut Machine) -> Cont {
    ...
    sub(m.cpu.regs.eax, 0x3cu32, &mut m.cpu.flags);
...
pub fn x00402b69(m: &mut Machine) -> Cont {
    ...
    m.cpu.regs.eax = sub(m.cpu.regs.eax, 0x3bu32, &mut m.cpu.flags);
    // 00402b74 push 3
    push(m, 0x3u32);
    // 00402b76 add edi,eax
    m.cpu.regs.edi = add(m.cpu.regs.edi, m.cpu.regs.eax, &mut m.cpu.flags);
...
pub fn x00402b83(m: &mut Machine) -> Cont {
    ...
    m.cpu.regs.eax = m.cpu.regs.ebp.wrapping_add(0xffffff60u32);
...
pub fn x00402bb5(m: &mut Machine) -> Cont {
    ...
    push(
        m,
        m.memory
            .read::<u32>(m.cpu.regs.esi.wrapping_add(0x40717cu32)),
    );
...
pub fn x00402bdd(m: &mut Machine) -> Cont {
    ...
    m.cpu.regs.esp = add(m.cpu.regs.esp, 0x2cu32, &mut m.cpu.flags);
    // 00402be0 pop edi
    m.cpu.regs.edi = pop(m);
...
pub fn x00402be3(m: &mut Machine) -> Cont {
    ...
    m.cpu.regs.esi = m.cpu.regs.esi.wrapping_add(0x40717cu32);
    // 00402bec push 0
    push(m, 0x0u32);
    // 00402bee push eax
    push(m, m.cpu.regs.eax);
...
pub fn x00402c1f(m: &mut Machine) -> Cont {
    ...
    m.memory.write::<u32>(0x40997cu32, m.cpu.regs.eax);
...
pub fn x00402c29(m: &mut Machine) -> Cont {
    ...
    m.cpu.regs.ecx = m.memory.read::<u32>(m.cpu.regs.esp.wrapping_add(0x4u32));
    // 00402c2d and dword ptr ds:[409974h],0
    m.memory.write::<u32>(
        0x409974u32,
        and(m.memory.read::<u32>(0x409974u32), 0x0u32, &mut m.cpu.flags),
    );
    // 00402c34 and dword ptr ds:[409978h],0
    m.memory.write::<u32>(
        0x409978u32,
        and(m.memory.read::<u32>(0x409978u32), 0x0u32, &mut m.cpu.flags),
    );
    // 00402c3b push 1
    push(m, 0x1u32);
    // 00402c3d mov ds:[409970h],eax
    m.memory.write::<u32>(0x409970u32, m.cpu.regs.eax);
    // 00402c42 mov ds:[409980h],ecx
    m.memory.write::<u32>(0x409980u32, m.cpu.regs.ecx);
    // 00402c48 mov dword ptr ds:[409968h],10h
    m.memory.write::<u32>(0x409968u32, 0x10u32);
    // 00402c52 pop eax
    m.cpu.regs.eax = pop(m);
    // 00402c53 ret
    ret(m, 0)
...
pub fn x00402c54(m: &mut Machine) -> Cont {
    ...
    m.cpu.regs.eax = m.memory.read::<u32>(0x409978u32);
    // 00402c59 lea ecx,[eax+eax*4]
    m.cpu.regs.ecx = m.cpu.regs.eax.wrapping_add((m.cpu.regs.eax * 4));
    // 00402c5c mov eax,ds:[40997Ch]
    m.cpu.regs.eax = m.memory.read::<u32>(0x40997cu32);
...
pub fn x00402c68(m: &mut Machine) -> Cont {
    ...
    m.cpu.regs.edx = sub(
        m.cpu.regs.edx,
        m.memory.read::<u32>(m.cpu.regs.eax.wrapping_add(0xcu32)),
        &mut m.cpu.flags,
    );
    // 00402c6f cmp edx,100000h
    sub(m.cpu.regs.edx, 0x100000u32, &mut m.cpu.flags);
...
pub fn x00402c77(m: &mut Machine) -> Cont {
    ...
    m.cpu.regs.eax = add(m.cpu.regs.eax, 0x14u32, &mut m.cpu.flags);
...
pub fn x00402c7f(m: &mut Machine) -> Cont {
    ...
    m.cpu.regs.eax = m.memory.read::<u32>(m.cpu.regs.ecx.wrapping_add(0x10u32));
    // 00402c90 push edi
    push(m, m.cpu.regs.edi);
    // 00402c91 mov edi,esi
    m.cpu.regs.edi = m.cpu.regs.esi;
    // 00402c93 add esi,0FFFFFFFCh
    m.cpu.regs.esi = add(m.cpu.regs.esi, 0xfffffffcu32, &mut m.cpu.flags);
    // 00402c96 sub edi,[ecx+0Ch]
    m.cpu.regs.edi = sub(
        m.cpu.regs.edi,
        m.memory.read::<u32>(m.cpu.regs.ecx.wrapping_add(0xcu32)),
        &mut m.cpu.flags,
    );
    // 00402c99 shr edi,0Fh
    m.cpu.regs.edi = shr(m.cpu.regs.edi, 0xfu8, &mut m.cpu.flags);
    // 00402c9c mov ecx,edi
    m.cpu.regs.ecx = m.cpu.regs.edi;
    // 00402c9e imul ecx,204h
    m.cpu.regs.ecx = imul(m.cpu.regs.ecx as i32, 0x204u32 as i32, &mut m.cpu.flags) as u32;
    ...
    m.memory
        .write::<u32>(m.cpu.regs.ebp.wrapping_add(0xfffffff0u32), m.cpu.regs.ecx);
    // 00402cae mov ecx,[esi]
    m.cpu.regs.ecx = m.memory.read::<u32>(m.cpu.regs.esi);
    // 00402cb0 dec ecx
    m.cpu.regs.ecx = dec(m.cpu.regs.ecx, &mut m.cpu.flags);
    // 00402cb1 test cl,1
    and(m.cpu.regs.get_cl(), 0x1u8, &mut m.cpu.flags);
    // 00402cb4 mov [ebp-4],ecx
    m.memory
        .write::<u32>(m.cpu.regs.ebp.wrapping_add(0xfffffffcu32), m.cpu.regs.ecx);
...
pub fn x00402cbd(m: &mut Machine) -> Cont {
    ...
    m.cpu.regs.edx = m
        .memory
        .read::<u32>(m.cpu.regs.ecx.wrapping_add(m.cpu.regs.esi));
    // 00402cc0 lea ebx,[ecx+esi]
    m.cpu.regs.ebx = m.cpu.regs.ecx.wrapping_add(m.cpu.regs.esi);
    // 00402cc3 mov [ebp-0Ch],edx
    m.memory
        .write::<u32>(m.cpu.regs.ebp.wrapping_add(0xfffffff4u32), m.cpu.regs.edx);
    ...
    m.memory
        .write::<u32>(m.cpu.regs.ebp.wrapping_add(0xfffffff8u32), m.cpu.regs.edx);
    // 00402ccc mov edx,[ebp-0Ch]
    m.cpu.regs.edx = m
        .memory
        .read::<u32>(m.cpu.regs.ebp.wrapping_add(0xfffffff4u32));
    // 00402ccf test dl,1
    and(m.cpu.regs.get_dl(), 0x1u8, &mut m.cpu.flags);
    // 00402cd2 mov [ebp+0Ch],ebx
    m.memory
        .write::<u32>(m.cpu.regs.ebp.wrapping_add(0xcu32), m.cpu.regs.ebx);
...
pub fn x00402cd7(m: &mut Machine) -> Cont {
    // 00402cd7 sar edx,4
    m.cpu.regs.edx = sar(m.cpu.regs.edx, 0x4u8, &mut m.cpu.flags);
    // 00402cda dec edx
    m.cpu.regs.edx = dec(m.cpu.regs.edx, &mut m.cpu.flags);
    // 00402cdb cmp edx,3Fh
    sub(m.cpu.regs.edx, 0x3fu32, &mut m.cpu.flags);
...
pub fn x00402ce0(m: &mut Machine) -> Cont {
    ...
    m.cpu.regs.ecx = m.memory.read::<u32>(m.cpu.regs.ebx.wrapping_add(0x4u32));
    // 00402ce6 cmp ecx,[ebx+8]
    sub(
        m.cpu.regs.ecx,
        m.memory.read::<u32>(m.cpu.regs.ebx.wrapping_add(0x8u32)),
        &mut m.cpu.flags,
    );
...
pub fn x00402ceb(m: &mut Machine) -> Cont {
    ...
    sub(m.cpu.regs.edx, 0x20u32, &mut m.cpu.flags);
...
pub fn x00402cf0(m: &mut Machine) -> Cont {
    ...
    m.cpu.regs.ebx = 0x80000000u32;
    // 00402cf5 mov ecx,edx
    m.cpu.regs.ecx = m.cpu.regs.edx;
    // 00402cf7 shr ebx,cl
    m.cpu.regs.ebx = shr(m.cpu.regs.ebx, m.cpu.regs.get_cl(), &mut m.cpu.flags);
    ...
    m.memory.write::<u8>(
        m.cpu.regs.ecx,
        dec(m.memory.read::<u8>(m.cpu.regs.ecx), &mut m.cpu.flags),
    );
...
pub fn x00402d0e(m: &mut Machine) -> Cont {
    ...
    m.cpu.regs.ecx = m.cpu.regs.edx.wrapping_add(0xffffffe0u32);
...
pub fn x00402d29(m: &mut Machine) -> Cont {
    ...
    m.memory.write::<u32>(
        m.cpu.regs.ecx.wrapping_add(0x4u32),
        and(
            m.memory.read::<u32>(m.cpu.regs.ecx.wrapping_add(0x4u32)),
            m.cpu.regs.ebx,
            &mut m.cpu.flags,
        ),
    );
    ...
    m.cpu.regs.ebx = m.memory.read::<u32>(m.cpu.regs.ebp.wrapping_add(0xcu32));
...
pub fn x00402d37(m: &mut Machine) -> Cont {
    ...
    m.cpu.regs.edx = m.memory.read::<u32>(m.cpu.regs.ebx.wrapping_add(0x8u32));
    // 00402d3d mov ebx,[ebx+4]
    m.cpu.regs.ebx = m.memory.read::<u32>(m.cpu.regs.ebx.wrapping_add(0x4u32));
    ...
    m.memory
        .write::<u32>(m.cpu.regs.edx.wrapping_add(0x4u32), m.cpu.regs.ebx);
    // 00402d46 mov edx,[ebp+0Ch]
    m.cpu.regs.edx = m.memory.read::<u32>(m.cpu.regs.ebp.wrapping_add(0xcu32));
    // 00402d49 mov [ebp-4],ecx
    m.memory
        .write::<u32>(m.cpu.regs.ebp.wrapping_add(0xfffffffcu32), m.cpu.regs.ecx);
    // 00402d4c mov ebx,[edx+4]
    m.cpu.regs.ebx = m.memory.read::<u32>(m.cpu.regs.edx.wrapping_add(0x4u32));
    // 00402d4f mov edx,[edx+8]
    m.cpu.regs.edx = m.memory.read::<u32>(m.cpu.regs.edx.wrapping_add(0x8u32));
    // 00402d52 mov [ebx+8],edx
    m.memory
        .write::<u32>(m.cpu.regs.ebx.wrapping_add(0x8u32), m.cpu.regs.edx);
    // 00402d55 mov edx,ecx
    m.cpu.regs.edx = m.cpu.regs.ecx;
    // 00402d57 sar edx,4
    m.cpu.regs.edx = sar(m.cpu.regs.edx, 0x4u8, &mut m.cpu.flags);
    // 00402d5a dec edx
    m.cpu.regs.edx = dec(m.cpu.regs.edx, &mut m.cpu.flags);
...
pub fn x00402d60(m: &mut Machine) -> Cont {
    ...
    m.cpu.regs.ebx = m
        ...
        .read::<u32>(m.cpu.regs.ebp.wrapping_add(0xfffffff8u32));
    // 00402d66 and ebx,1
    m.cpu.regs.ebx = and(m.cpu.regs.ebx, 0x1u32, &mut m.cpu.flags);
    // 00402d69 mov [ebp-0Ch],ebx
    m.memory
        .write::<u32>(m.cpu.regs.ebp.wrapping_add(0xfffffff4u32), m.cpu.regs.ebx);
...
pub fn x00402d72(m: &mut Machine) -> Cont {
    ...
    m.cpu.regs.ebx = m
        ...
        .read::<u32>(m.cpu.regs.ebp.wrapping_add(0xfffffff8u32));
    // 00402d78 sar ebx,4
    m.cpu.regs.ebx = sar(m.cpu.regs.ebx, 0x4u8, &mut m.cpu.flags);
    // 00402d7b push 3Fh
    push(m, 0x3fu32);
    // 00402d7d mov [ebp+0Ch],esi
    m.memory
        .write::<u32>(m.cpu.regs.ebp.wrapping_add(0xcu32), m.cpu.regs.esi);
    // 00402d80 dec ebx
    m.cpu.regs.ebx = dec(m.cpu.regs.ebx, &mut m.cpu.flags);
    // 00402d81 pop esi
    m.cpu.regs.esi = pop(m);
    // 00402d82 cmp ebx,esi
    sub(m.cpu.regs.ebx, m.cpu.regs.esi, &mut m.cpu.flags);
...
pub fn x00402d86(m: &mut Machine) -> Cont {
    ...
    sub(m.cpu.regs.edx, m.cpu.regs.esi, &mut m.cpu.flags);
...
pub fn x00402d98(m: &mut Machine) -> Cont {
    ...
    m.cpu.regs.edx = m.cpu.regs.esi;
    // 00402d9a cmp ebx,edx
    sub(m.cpu.regs.ebx, m.cpu.regs.edx, &mut m.cpu.flags);
...
pub fn x00402d9e(m: &mut Machine) -> Cont {
    ...
    m.cpu.regs.esi = m.memory.read::<u32>(m.cpu.regs.ecx.wrapping_add(0x4u32));
    // 00402da4 cmp esi,[ecx+8]
    sub(
        m.cpu.regs.esi,
        m.memory.read::<u32>(m.cpu.regs.ecx.wrapping_add(0x8u32)),
        &mut m.cpu.flags,
    );
...
pub fn x00402da9(m: &mut Machine) -> Cont {
    ...
    sub(m.cpu.regs.ebx, 0x20u32, &mut m.cpu.flags);
...
pub fn x00402dae(m: &mut Machine) -> Cont {
    ...
    m.cpu.regs.esi = 0x80000000u32;
    // 00402db3 mov ecx,ebx
    m.cpu.regs.ecx = m.cpu.regs.ebx;
    // 00402db5 shr esi,cl
    m.cpu.regs.esi = shr(m.cpu.regs.esi, m.cpu.regs.get_cl(), &mut m.cpu.flags);
    // 00402db7 not esi
    not();
...
pub fn x00402dca(m: &mut Machine) -> Cont {
    ...
    m.cpu.regs.ecx = m.cpu.regs.ebx.wrapping_add(0xffffffe0u32);
...
pub fn x00402de3(m: &mut Machine) -> Cont {
    ...
    m.cpu.regs.esi = m.memory.read::<u32>(m.cpu.regs.ecx.wrapping_add(0x8u32));
    // 00402def mov ecx,[ecx+4]
    m.cpu.regs.ecx = m.memory.read::<u32>(m.cpu.regs.ecx.wrapping_add(0x4u32));
    // 00402df2 mov [esi+4],ecx
    m.memory
        .write::<u32>(m.cpu.regs.esi.wrapping_add(0x4u32), m.cpu.regs.ecx);
    // 00402df5 mov ecx,[ebp+0Ch]
    m.cpu.regs.ecx = m.memory.read::<u32>(m.cpu.regs.ebp.wrapping_add(0xcu32));
    // 00402df8 mov esi,[ecx+4]
    m.cpu.regs.esi = m.memory.read::<u32>(m.cpu.regs.ecx.wrapping_add(0x4u32));
    // 00402dfb mov ecx,[ecx+8]
    m.cpu.regs.ecx = m.memory.read::<u32>(m.cpu.regs.ecx.wrapping_add(0x8u32));
    // 00402dfe mov [esi+8],ecx
    m.memory
        .write::<u32>(m.cpu.regs.esi.wrapping_add(0x8u32), m.cpu.regs.ecx);
...
pub fn x00402e17(m: &mut Machine) -> Cont {
    ...
    m.cpu.regs.ecx = m
        .memory
        .read::<u32>(m.cpu.regs.ebp.wrapping_add(0xfffffff0u32));
    // 00402e1a mov ebx,[ecx+edx*8+4]
    m.cpu.regs.ebx = m.memory.read::<u32>(
        m.cpu
            .regs
            .ecx
            .wrapping_add((m.cpu.regs.edx * 8))
            .wrapping_add(0x4u32),
    );
    // 00402e1e lea ecx,[ecx+edx*8]
    m.cpu.regs.ecx = m.cpu.regs.ecx.wrapping_add((m.cpu.regs.edx * 8));
    // 00402e21 mov [esi+4],ebx
    m.memory
        .write::<u32>(m.cpu.regs.esi.wrapping_add(0x4u32), m.cpu.regs.ebx);
    // 00402e24 mov [esi+8],ecx
    m.memory
        .write::<u32>(m.cpu.regs.esi.wrapping_add(0x8u32), m.cpu.regs.ecx);
    // 00402e27 mov [ecx+4],esi
    m.memory
        .write::<u32>(m.cpu.regs.ecx.wrapping_add(0x4u32), m.cpu.regs.esi);
    // 00402e2a mov ecx,[esi+4]
    m.cpu.regs.ecx = m.memory.read::<u32>(m.cpu.regs.esi.wrapping_add(0x4u32));
    // 00402e2d mov [ecx+8],esi
    m.memory
        .write::<u32>(m.cpu.regs.ecx.wrapping_add(0x8u32), m.cpu.regs.esi);
    // 00402e30 mov ecx,[esi+4]
    m.cpu.regs.ecx = m.memory.read::<u32>(m.cpu.regs.esi.wrapping_add(0x4u32));
    // 00402e33 cmp ecx,[esi+8]
    sub(
        m.cpu.regs.ecx,
        m.memory.read::<u32>(m.cpu.regs.esi.wrapping_add(0x8u32)),
        &mut m.cpu.flags,
    );
...
pub fn x00402e38(m: &mut Machine) -> Cont {
    ...
    m.memory
        .write::<u8>(m.cpu.regs.ebp.wrapping_add(0xfu32), m.cpu.regs.get_cl());
    // 00402e42 inc cl
    m.cpu
        .regs
        .set_cl(inc(m.cpu.regs.get_cl(), &mut m.cpu.flags));
...
pub fn x00402e4a(m: &mut Machine) -> Cont {
    ...
    sub(
        m.memory.read::<u8>(m.cpu.regs.ebp.wrapping_add(0xfu32)),
        0x0u8,
        &mut m.cpu.flags,
    );
...
pub fn x00402e75(m: &mut Machine) -> Cont {
    ...
    m.cpu.regs.edx = 0x80000000u32;
    // 00402e8d shr edx,cl
    m.cpu.regs.edx = shr(m.cpu.regs.edx, m.cpu.regs.get_cl(), &mut m.cpu.flags);
    ...
    m.memory.write::<u32>(
        m.cpu.regs.eax,
        dec(m.memory.read::<u32>(m.cpu.regs.eax), &mut m.cpu.flags),
    );
...
pub fn x00402eac(m: &mut Machine) -> Cont {
    ...
    m.cpu.regs.eax = m.memory.read::<u32>(0x409974u32);
...
pub fn x00402eb9(m: &mut Machine) -> Cont {
    ...
    m.cpu.regs.ecx = m.memory.read::<u32>(0x40996cu32);
    // 00402ebf mov esi,ds:[406098h]
    m.cpu.regs.esi = m.memory.read::<u32>(0x406098u32);
    // 00402ec5 shl ecx,0Fh
    m.cpu.regs.ecx = shl(m.cpu.regs.ecx, 0xfu8, &mut m.cpu.flags);
...
pub fn x00402ed9(m: &mut Machine) -> Cont {
    ...
    m.cpu.regs.eax = m.memory.read::<u32>(m.cpu.regs.eax.wrapping_add(0x10u32));
    // 00402efc and dword ptr [eax+ecx*4+0C4h],0
    m.memory.write::<u32>(
        m.cpu
            .regs
            .eax
            .wrapping_add((m.cpu.regs.ecx * 4))
            .wrapping_add(0xc4u32),
        and(
            m.memory.read::<u32>(
                m.cpu
    ...
    m.memory.write::<u8>(
        m.cpu.regs.eax.wrapping_add(0x43u32),
        dec(
            m.memory.read::<u8>(m.cpu.regs.eax.wrapping_add(0x43u32)),
            &mut m.cpu.flags,
        ),
    );
    ...
    m.cpu.regs.ecx = m.memory.read::<u32>(m.cpu.regs.eax.wrapping_add(0x10u32));
    // 00402f17 cmp byte ptr [ecx+43h],0
    sub(
        m.memory.read::<u8>(m.cpu.regs.ecx.wrapping_add(0x43u32)),
        0x0u8,
        &mut m.cpu.flags,
    );
...
pub fn x00402f1d(m: &mut Machine) -> Cont {
    ...
    m.memory.write::<u32>(
        m.cpu.regs.eax.wrapping_add(0x4u32),
        and(
            m.memory.read::<u32>(m.cpu.regs.eax.wrapping_add(0x4u32)),
            0xfffffffeu32,
            &mut m.cpu.flags,
        ),
    );
...
pub fn x00402f2c(m: &mut Machine) -> Cont {
    ...
    push(m, m.memory.read::<u32>(m.cpu.regs.eax.wrapping_add(0xcu32)));
    // 00402f32 call esi
    let dst = indirect(m, m.cpu.regs.esi);
    call(m, 0x402f34, dst)
}
...
pub fn x00402f34(m: &mut Machine) -> Cont {
    ...
    push(
        m,
        m.memory.read::<u32>(m.cpu.regs.eax.wrapping_add(0x10u32)),
    );
    // 00402f3c push 0
    push(m, 0x0u32);
...
pub fn x00402f4a(m: &mut Machine) -> Cont {
    ...
    m.cpu.regs.edx = m.memory.read::<u32>(0x40997cu32);
    // 00402f55 lea eax,[eax+eax*4]
    m.cpu.regs.eax = m.cpu.regs.eax.wrapping_add((m.cpu.regs.eax * 4));
    // 00402f58 shl eax,2
    m.cpu.regs.eax = shl(m.cpu.regs.eax, 0x2u8, &mut m.cpu.flags);
    // 00402f5b mov ecx,eax
    m.cpu.regs.ecx = m.cpu.regs.eax;
    // 00402f5d mov eax,ds:[409974h]
    m.cpu.regs.eax = m.memory.read::<u32>(0x409974u32);
    // 00402f62 sub ecx,eax
    m.cpu.regs.ecx = sub(m.cpu.regs.ecx, m.cpu.regs.eax, &mut m.cpu.flags);
    // 00402f64 lea ecx,[ecx+edx-14h]
    m.cpu.regs.ecx = m
        .cpu
        .regs
        .ecx
        .wrapping_add(m.cpu.regs.edx)
        .wrapping_add(0xffffffecu32);
    // 00402f68 push ecx
    push(m, m.cpu.regs.ecx);
    // 00402f69 lea ecx,[eax+14h]
    m.cpu.regs.ecx = m.cpu.regs.eax.wrapping_add(0x14u32);
    // 00402f6c push ecx
    push(m, m.cpu.regs.ecx);
    // 00402f6d push eax
    push(m, m.cpu.regs.eax);
...
pub fn x00402f73(m: &mut Machine) -> Cont {
    ...
    m.memory.write::<u32>(
        0x409978u32,
        dec(m.memory.read::<u32>(0x409978u32), &mut m.cpu.flags),
    );
    // 00402f7f cmp eax,ds:[409974h]
    sub(
        m.cpu.regs.eax,
        m.memory.read::<u32>(0x409974u32),
        &mut m.cpu.flags,
    );
...
pub fn x00402f87(m: &mut Machine) -> Cont {
    ...
    m.memory.write::<u32>(
        m.cpu.regs.ebp.wrapping_add(0x8u32),
        sub(
            m.memory.read::<u32>(m.cpu.regs.ebp.wrapping_add(0x8u32)),
            0x14u32,
            &mut m.cpu.flags,
    ...
    m.memory.write::<u32>(0x40996cu32, m.cpu.regs.edi);
    // 00402f9e mov ds:[409974h],eax
    m.memory.write::<u32>(0x409974u32, m.cpu.regs.eax);
    // 00402fa3 pop edi
    m.cpu.regs.edi = pop(m);
    // 00402fa4 pop esi
    m.cpu.regs.esi = pop(m);
...
pub fn x00402fa8(m: &mut Machine) -> Cont {
    ...
    m.cpu.regs.esp = sub(m.cpu.regs.esp, 0x14u32, &mut m.cpu.flags);
    ...
    m.cpu.regs.edi = m.cpu.regs.edx.wrapping_add((m.cpu.regs.eax * 4));
    // 00402fc2 mov eax,[ebp+8]
    m.cpu.regs.eax = m.memory.read::<u32>(m.cpu.regs.ebp.wrapping_add(0x8u32));
    // 00402fc5 mov [ebp-4],edi
    m.memory
        .write::<u32>(m.cpu.regs.ebp.wrapping_add(0xfffffffcu32), m.cpu.regs.edi);
    // 00402fc8 lea ecx,[eax+17h]
    m.cpu.regs.ecx = m.cpu.regs.eax.wrapping_add(0x17u32);
    // 00402fcb and ecx,0FFFFFFF0h
    m.cpu.regs.ecx = and(m.cpu.regs.ecx, 0xfffffff0u32, &mut m.cpu.flags);
    // 00402fce mov [ebp-10h],ecx
    m.memory
        .write::<u32>(m.cpu.regs.ebp.wrapping_add(0xfffffff0u32), m.cpu.regs.ecx);
    // 00402fd1 sar ecx,4
    m.cpu.regs.ecx = sar(m.cpu.regs.ecx, 0x4u8, &mut m.cpu.flags);
    // 00402fd4 dec ecx
    m.cpu.regs.ecx = dec(m.cpu.regs.ecx, &mut m.cpu.flags);
    // 00402fd5 cmp ecx,20h
    sub(m.cpu.regs.ecx, 0x20u32, &mut m.cpu.flags);
...
pub fn x00402fda(m: &mut Machine) -> Cont {
    ...
    m.cpu.regs.esi = or(m.cpu.regs.esi, 0xffffffffu32, &mut m.cpu.flags);
    // 00402fdd shr esi,cl
    m.cpu.regs.esi = shr(m.cpu.regs.esi, m.cpu.regs.get_cl(), &mut m.cpu.flags);
    // 00402fdf or dword ptr [ebp-8],0FFFFFFFFh
    m.memory.write::<u32>(
        m.cpu.regs.ebp.wrapping_add(0xfffffff8u32),
        or(
            m.memory
                .read::<u32>(m.cpu.regs.ebp.wrapping_add(0xfffffff8u32)),
            0xffffffffu32,
    ...
    m.memory
        .write::<u32>(m.cpu.regs.ebp.wrapping_add(0xfffffff4u32), m.cpu.regs.esi);
...
pub fn x00402fe8(m: &mut Machine) -> Cont {
    ...
    m.cpu.regs.ecx = add(m.cpu.regs.ecx, 0xffffffe0u32, &mut m.cpu.flags);
    // 00402feb or eax,0FFFFFFFFh
    m.cpu.regs.eax = or(m.cpu.regs.eax, 0xffffffffu32, &mut m.cpu.flags);
    // 00402fee xor esi,esi
    m.cpu.regs.esi = xor(m.cpu.regs.esi, m.cpu.regs.esi, &mut m.cpu.flags);
    // 00402ff0 shr eax,cl
    m.cpu.regs.eax = shr(m.cpu.regs.eax, m.cpu.regs.get_cl(), &mut m.cpu.flags);
    // 00402ff2 mov [ebp-0Ch],esi
    m.memory
        .write::<u32>(m.cpu.regs.ebp.wrapping_add(0xfffffff4u32), m.cpu.regs.esi);
    // 00402ff5 mov [ebp-8],eax
    m.memory
        .write::<u32>(m.cpu.regs.ebp.wrapping_add(0xfffffff8u32), m.cpu.regs.eax);
    // 00402ff8 mov eax,ds:[409970h]
    m.cpu.regs.eax = m.memory.read::<u32>(0x409970u32);
    // 00402ffd mov ebx,eax
    m.cpu.regs.ebx = m.cpu.regs.eax;
    // 00402fff cmp ebx,edi
    sub(m.cpu.regs.ebx, m.cpu.regs.edi, &mut m.cpu.flags);
    // 00403001 mov [ebp+8],ebx
    m.memory
        .write::<u32>(m.cpu.regs.ebp.wrapping_add(0x8u32), m.cpu.regs.ebx);
...
pub fn x00403006(m: &mut Machine) -> Cont {
    ...
    m.cpu.regs.edi = m.memory.read::<u32>(m.cpu.regs.ebx);
    ...
    m.cpu.regs.edi = and(m.cpu.regs.edi, m.cpu.regs.esi, &mut m.cpu.flags);
    // 00403010 or ecx,edi
    m.cpu.regs.ecx = or(m.cpu.regs.ecx, m.cpu.regs.edi, &mut m.cpu.flags);
...
pub fn x00403014(m: &mut Machine) -> Cont {
    ...
    m.cpu.regs.ebx = add(m.cpu.regs.ebx, 0x14u32, &mut m.cpu.flags);
...
pub fn x00403024(m: &mut Machine) -> Cont {
    ...
    m.cpu.regs.ebx = m.cpu.regs.edx;
    // 00403026 cmp ebx,eax
    sub(m.cpu.regs.ebx, m.cpu.regs.eax, &mut m.cpu.flags);
...
pub fn x00403088(m: &mut Machine) -> Cont {
    ...
    m.cpu.regs.ecx = m.memory.read::<u32>(m.cpu.regs.ebx.wrapping_add(0x10u32));
    // 0040308c mov [ecx],eax
    m.memory.write::<u32>(m.cpu.regs.ecx, m.cpu.regs.eax);
    // 0040308e mov eax,[ebx+10h]
    m.cpu.regs.eax = m.memory.read::<u32>(m.cpu.regs.ebx.wrapping_add(0x10u32));
...
pub fn x0040309d(m: &mut Machine) -> Cont {
    ...
    m.memory.write::<u32>(0x409970u32, m.cpu.regs.ebx);
    // 004030a3 mov eax,[ebx+10h]
    m.cpu.regs.eax = m.memory.read::<u32>(m.cpu.regs.ebx.wrapping_add(0x10u32));
    // 004030a6 mov edx,[eax]
    m.cpu.regs.edx = m.memory.read::<u32>(m.cpu.regs.eax);
    // 004030a8 cmp edx,0FFFFFFFFh
    sub(m.cpu.regs.edx, 0xffffffffu32, &mut m.cpu.flags);
    // 004030ab mov [ebp-4],edx
    m.memory
        .write::<u32>(m.cpu.regs.ebp.wrapping_add(0xfffffffcu32), m.cpu.regs.edx);
...
pub fn x004030b0(m: &mut Machine) -> Cont {
    ...
    m.cpu.regs.ecx = m.memory.read::<u32>(
        m.cpu
            .regs
            .eax
            .wrapping_add((m.cpu.regs.edx * 4))
            .wrapping_add(0xc4u32),
    );
    // 004030b7 mov edi,[eax+edx*4+44h]
    m.cpu.regs.edi = m.memory.read::<u32>(
        m.cpu
            .regs
            .eax
            .wrapping_add((m.cpu.regs.edx * 4))
...
pub fn x004030c4(m: &mut Machine) -> Cont {
    ...
    m.cpu.regs.edx = m.memory.read::<u32>(m.cpu.regs.eax.wrapping_add(0xc4u32));
    // 004030ca mov esi,[eax+44h]
    m.cpu.regs.esi = m.memory.read::<u32>(m.cpu.regs.eax.wrapping_add(0x44u32));
    ...
    m.memory.write::<u32>(
        m.cpu.regs.ebp.wrapping_add(0xfffffffcu32),
        and(
            m.memory
                .read::<u32>(m.cpu.regs.ebp.wrapping_add(0xfffffffcu32)),
            0x0u32,
    ...
    m.cpu.regs.ecx = m.cpu.regs.eax.wrapping_add(0x44u32);
    // 004030da or edx,esi
    m.cpu.regs.edx = or(m.cpu.regs.edx, m.cpu.regs.esi, &mut m.cpu.flags);
...
pub fn x004030e1(m: &mut Machine) -> Cont {
    ...
    m.cpu.regs.edx = m.memory.read::<u32>(m.cpu.regs.ecx.wrapping_add(0x84u32));
    ...
    // 004030ed add ecx,4
    m.cpu.regs.ecx = add(m.cpu.regs.ecx, 0x4u32, &mut m.cpu.flags);
    ...
    // 004030f4 or edx,edi
    m.cpu.regs.edx = or(m.cpu.regs.edx, m.cpu.regs.edi, &mut m.cpu.flags);
...
pub fn x004030f8(m: &mut Machine) -> Cont {
    ...
    m.memory
        .write::<u32>(m.cpu.regs.ebp.wrapping_add(0xfffffff4u32), m.cpu.regs.ecx);
    ...
    m.cpu.regs.ecx = and(m.cpu.regs.ecx, m.cpu.regs.esi, &mut m.cpu.flags);
...
pub fn x00403128(m: &mut Machine) -> Cont {
    // 00403128 shl ecx,1
    m.cpu.regs.ecx = shl(m.cpu.regs.ecx, 0x1u8, &mut m.cpu.flags);
    // 0040312a inc edi
    m.cpu.regs.edi = inc(m.cpu.regs.edi, &mut m.cpu.flags);
...
pub fn x0040312d(m: &mut Machine) -> Cont {
    ...
    m.cpu.regs.edx = m.memory.read::<u32>(
        m.cpu
            .regs
            .ecx
            .wrapping_add((m.cpu.regs.edi * 8))
            .wrapping_add(0x4u32),
    );
    // 00403134 mov ecx,[edx]
    m.cpu.regs.ecx = m.memory.read::<u32>(m.cpu.regs.edx);
    ...
    m.memory
        .write::<u32>(m.cpu.regs.ebp.wrapping_add(0xfffffff8u32), m.cpu.regs.ecx);
    // 0040313e sar esi,4
    m.cpu.regs.esi = sar(m.cpu.regs.esi, 0x4u8, &mut m.cpu.flags);
    // 00403141 dec esi
    m.cpu.regs.esi = dec(m.cpu.regs.esi, &mut m.cpu.flags);
    // 00403142 cmp esi,3Fh
    sub(m.cpu.regs.esi, 0x3fu32, &mut m.cpu.flags);
...
pub fn x00403147(m: &mut Machine) -> Cont {
    ...
    sub(m.cpu.regs.esi, m.cpu.regs.edi, &mut m.cpu.flags);
...
pub fn x00403152(m: &mut Machine) -> Cont {
    ...
    m.cpu.regs.ecx = m.memory.read::<u32>(m.cpu.regs.edx.wrapping_add(0x4u32));
    // 00403155 cmp ecx,[edx+8]
    sub(
        m.cpu.regs.ecx,
        m.memory.read::<u32>(m.cpu.regs.edx.wrapping_add(0x8u32)),
        &mut m.cpu.flags,
    );
...
pub fn x0040315a(m: &mut Machine) -> Cont {
    ...
    sub(m.cpu.regs.edi, 0x20u32, &mut m.cpu.flags);
...
pub fn x0040315f(m: &mut Machine) -> Cont {
    ...
    m.cpu.regs.edi = m
        ...
        .regs
        .eax
        .wrapping_add(m.cpu.regs.edi)
        .wrapping_add(0x4u32);
    // 0040316f not ebx
    not();
    // 00403171 mov [ebp-14h],ebx
    m.memory
        .write::<u32>(m.cpu.regs.ebp.wrapping_add(0xffffffecu32), m.cpu.regs.ebx);
    ...
    m.memory.write::<u8>(
        m.cpu.regs.edi,
        dec(m.memory.read::<u8>(m.cpu.regs.edi), &mut m.cpu.flags),
    );
...
pub fn x00403180(m: &mut Machine) -> Cont {
    ...
    m.memory.write::<u32>(
        m.cpu.regs.ebx,
        and(
            m.memory.read::<u32>(m.cpu.regs.ebx),
            m.cpu.regs.ecx,
            &mut m.cpu.flags,
        ),
    );
...
pub fn x0040318a(m: &mut Machine) -> Cont {
    ...
    m.cpu.regs.ecx = m.cpu.regs.edi.wrapping_add(0xffffffe0u32);
...
pub fn x004031ad(m: &mut Machine) -> Cont {
    ...
    m.memory.write::<u32>(
        m.cpu.regs.ebx.wrapping_add(0x4u32),
        and(
            m.memory.read::<u32>(m.cpu.regs.ebx.wrapping_add(0x4u32)),
            m.cpu.regs.ecx,
            &mut m.cpu.flags,
        ),
    );
...
pub fn x004031b8(m: &mut Machine) -> Cont {
    ...
    m.cpu.regs.ecx = m.memory.read::<u32>(m.cpu.regs.edx.wrapping_add(0x8u32));
    // 004031be mov edi,[edx+4]
    m.cpu.regs.edi = m.memory.read::<u32>(m.cpu.regs.edx.wrapping_add(0x4u32));
    ...
    m.memory
        .write::<u32>(m.cpu.regs.ecx.wrapping_add(0x4u32), m.cpu.regs.edi);
    // 004031c8 mov ecx,[edx+4]
    m.cpu.regs.ecx = m.memory.read::<u32>(m.cpu.regs.edx.wrapping_add(0x4u32));
    // 004031cb mov edi,[edx+8]
    m.cpu.regs.edi = m.memory.read::<u32>(m.cpu.regs.edx.wrapping_add(0x8u32));
    // 004031ce mov [ecx+8],edi
    m.memory
        .write::<u32>(m.cpu.regs.ecx.wrapping_add(0x8u32), m.cpu.regs.edi);
...
pub fn x004031d7(m: &mut Machine) -> Cont {
    ...
    m.cpu.regs.edi = m.memory.read::<u32>(
        m.cpu
            .regs
            .ecx
            .wrapping_add((m.cpu.regs.esi * 8))
            .wrapping_add(0x4u32),
    );
    // 004031de lea ecx,[ecx+esi*8]
    m.cpu.regs.ecx = m.cpu.regs.ecx.wrapping_add((m.cpu.regs.esi * 8));
    // 004031e1 mov [edx+4],edi
    m.memory
        .write::<u32>(m.cpu.regs.edx.wrapping_add(0x4u32), m.cpu.regs.edi);
    // 004031e4 mov [edx+8],ecx
    m.memory
        .write::<u32>(m.cpu.regs.edx.wrapping_add(0x8u32), m.cpu.regs.ecx);
    // 004031e7 mov [ecx+4],edx
    m.memory
        .write::<u32>(m.cpu.regs.ecx.wrapping_add(0x4u32), m.cpu.regs.edx);
    // 004031ea mov ecx,[edx+4]
    m.cpu.regs.ecx = m.memory.read::<u32>(m.cpu.regs.edx.wrapping_add(0x4u32));
    // 004031ed mov [ecx+8],edx
    m.memory
        .write::<u32>(m.cpu.regs.ecx.wrapping_add(0x8u32), m.cpu.regs.edx);
...
pub fn x004031f8(m: &mut Machine) -> Cont {
    ...
    sub(m.cpu.regs.esi, 0x20u32, &mut m.cpu.flags);
    // 004031ff mov [ebp+0Bh],cl
    m.memory
        .write::<u8>(m.cpu.regs.ebp.wrapping_add(0xbu32), m.cpu.regs.get_cl());
...
pub fn x00403204(m: &mut Machine) -> Cont {
    ...
    sub(
        m.memory.read::<u8>(m.cpu.regs.ebp.wrapping_add(0xbu32)),
        0x0u8,
        &mut m.cpu.flags,
    );
...
pub fn x00403210(m: &mut Machine) -> Cont {
    ...
    m.cpu.regs.edi = 0x80000000u32;
    // 00403215 mov ecx,esi
    m.cpu.regs.ecx = m.cpu.regs.esi;
    // 00403217 shr edi,cl
    m.cpu.regs.edi = shr(m.cpu.regs.edi, m.cpu.regs.get_cl(), &mut m.cpu.flags);
    // 00403219 or [ebx],edi
    m.memory.write::<u32>(
        m.cpu.regs.ebx,
        or(
...
pub fn x00403239(m: &mut Machine) -> Cont {
    ...
    m.cpu.regs.ecx = m.cpu.regs.esi.wrapping_add(0xffffffe0u32);
...
pub fn x00403263(m: &mut Machine) -> Cont {
    ...
    m.memory.write::<u32>(m.cpu.regs.edx, m.cpu.regs.ecx);
...
pub fn x0040326b(m: &mut Machine) -> Cont {
    ...
    m.cpu.regs.ecx = m.cpu.regs.esi.wrapping_add(0x1u32);
    ...
    m.cpu.regs.edi = m.cpu.regs.ecx.wrapping_add(0x1u32);
...
pub fn x0040329d(m: &mut Machine) -> Cont {
    ...
    m.cpu.regs.eax = m.cpu.regs.edx.wrapping_add(0x4u32);
    // 004032ac pop edi
    m.cpu.regs.edi = pop(m);
    // 004032ad pop esi
    m.cpu.regs.esi = pop(m);
...
pub fn x004032b1(m: &mut Machine) -> Cont {
    ...
    m.cpu.regs.ecx = m.memory.read::<u32>(0x409968u32);
    // 004032bc push esi
    push(m, m.cpu.regs.esi);
    // 004032bd push edi
    push(m, m.cpu.regs.edi);
...
pub fn x004032c4(m: &mut Machine) -> Cont {
    ...
    push(m, m.memory.read::<u32>(0x40997cu32));
    // 004032d2 push edi
    push(m, m.cpu.regs.edi);
...
pub fn x004032df(m: &mut Machine) -> Cont {
    ...
    sub(m.cpu.regs.eax, m.cpu.regs.edi, &mut m.cpu.flags);
...
pub fn x004032e3(m: &mut Machine) -> Cont {
    ...
    m.memory.write::<u32>(
        0x409968u32,
        add(m.memory.read::<u32>(0x409968u32), 0x10u32, &mut m.cpu.flags),
    );
    ...
    m.cpu.regs.ecx = m.memory.read::<u32>(0x40997cu32);
    // 004032fa push 41C4h
    push(m, 0x41c4u32);
    // 004032ff push 8
    push(m, 0x8u32);
    ...
    m.cpu.regs.esi = m.cpu.regs.ecx.wrapping_add((m.cpu.regs.eax * 4));
...
pub fn x00403313(m: &mut Machine) -> Cont {
    ...
    m.memory
        .write::<u32>(m.cpu.regs.esi.wrapping_add(0x10u32), m.cpu.regs.eax);
...
pub fn x0040332d(m: &mut Machine) -> Cont {
    ...
    m.memory
        .write::<u32>(m.cpu.regs.esi.wrapping_add(0xcu32), m.cpu.regs.eax);
...
pub fn x00403334(m: &mut Machine) -> Cont {
    ...
    push(
        m,
        m.memory.read::<u32>(m.cpu.regs.esi.wrapping_add(0x10u32)),
    );
    // 00403337 push edi
    push(m, m.cpu.regs.edi);
...
pub fn x00403348(m: &mut Machine) -> Cont {
    ...
    m.memory.write::<u32>(
        m.cpu.regs.esi.wrapping_add(0x8u32),
        or(
            m.memory.read::<u32>(m.cpu.regs.esi.wrapping_add(0x8u32)),
            0xffffffffu32,
            &mut m.cpu.flags,
    ...
    m.memory
        .write::<u32>(m.cpu.regs.esi.wrapping_add(0x4u32), m.cpu.regs.edi);
    // 00403351 inc dword ptr ds:[409978h]
    m.memory.write::<u32>(
        0x409978u32,
        inc(m.memory.read::<u32>(0x409978u32), &mut m.cpu.flags),
    );
    // 00403357 mov eax,[esi+10h]
    m.cpu.regs.eax = m.memory.read::<u32>(m.cpu.regs.esi.wrapping_add(0x10u32));
...
pub fn x00403362(m: &mut Machine) -> Cont {
    ...
    m.cpu.regs.esi = m.memory.read::<u32>(m.cpu.regs.ecx.wrapping_add(0x10u32));
    // 0040336f mov eax,[ecx+8]
    m.cpu.regs.eax = m.memory.read::<u32>(m.cpu.regs.ecx.wrapping_add(0x8u32));
...
pub fn x00403378(m: &mut Machine) -> Cont {
    // 00403378 shl eax,1
    m.cpu.regs.eax = shl(m.cpu.regs.eax, 0x1u8, &mut m.cpu.flags);
    // 0040337a inc ebx
    m.cpu.regs.ebx = inc(m.cpu.regs.ebx, &mut m.cpu.flags);
...
pub fn x0040337d(m: &mut Machine) -> Cont {
    ...
    m.cpu.regs.eax = imul(m.cpu.regs.eax as i32, 0x204u32 as i32, &mut m.cpu.flags) as u32;
    // 00403387 pop edx
    m.cpu.regs.edx = pop(m);
    ...
    m.memory
        .write::<u32>(m.cpu.regs.ebp.wrapping_add(0xfffffffcu32), m.cpu.regs.eax);
    // 00403392 mov [eax+8],eax
    m.memory
        .write::<u32>(m.cpu.regs.eax.wrapping_add(0x8u32), m.cpu.regs.eax);
    // 00403395 mov [eax+4],eax
    m.memory
        .write::<u32>(m.cpu.regs.eax.wrapping_add(0x4u32), m.cpu.regs.eax);
    // 00403398 add eax,8
    m.cpu.regs.eax = add(m.cpu.regs.eax, 0x8u32, &mut m.cpu.flags);
    // 0040339b dec edx
    m.cpu.regs.edx = dec(m.cpu.regs.edx, &mut m.cpu.flags);
...
pub fn x0040339e(m: &mut Machine) -> Cont {
    ...
    m.cpu.regs.edi = m.cpu.regs.ebx;
    // 004033a0 push 4
    push(m, 0x4u32);
    // 004033a2 shl edi,0Fh
    m.cpu.regs.edi = shl(m.cpu.regs.edi, 0xfu8, &mut m.cpu.flags);
...
pub fn x004033c5(m: &mut Machine) -> Cont {
    ...
    m.cpu.regs.edx = m.cpu.regs.edi.wrapping_add(0x7000u32);
    // 004033cb cmp edi,edx
    sub(m.cpu.regs.edi, m.cpu.regs.edx, &mut m.cpu.flags);
...
pub fn x004033cf(m: &mut Machine) -> Cont {
    ...
    m.cpu.regs.eax = m.cpu.regs.edi.wrapping_add(0x10u32);
    // 004033d2 or dword ptr [eax-8],0FFFFFFFFh
    m.memory.write::<u32>(
        m.cpu.regs.eax.wrapping_add(0xfffffff8u32),
        or(
            m.memory
                .read::<u32>(m.cpu.regs.eax.wrapping_add(0xfffffff8u32)),
            0xffffffffu32,
            &mut m.cpu.flags,
        ),
    );
    ...
    m.memory.write::<u32>(
        m.cpu.regs.eax.wrapping_add(0xfecu32),
        or(
            m.memory.read::<u32>(m.cpu.regs.eax.wrapping_add(0xfecu32)),
            0xffffffffu32,
            &mut m.cpu.flags,
        ),
    );
    // 004033dd lea ecx,[eax+0FFCh]
    m.cpu.regs.ecx = m.cpu.regs.eax.wrapping_add(0xffcu32);
    // 004033e3 mov dword ptr [eax-4],0FF0h
    m.memory
        .write::<u32>(m.cpu.regs.eax.wrapping_add(0xfffffffcu32), 0xff0u32);
    // 004033ea mov [eax],ecx
    m.memory.write::<u32>(m.cpu.regs.eax, m.cpu.regs.ecx);
    // 004033ec lea ecx,[eax-1004h]
    m.cpu.regs.ecx = m.cpu.regs.eax.wrapping_add(0xffffeffcu32);
    // 004033f2 mov [eax+4],ecx
    m.memory
        .write::<u32>(m.cpu.regs.eax.wrapping_add(0x4u32), m.cpu.regs.ecx);
    // 004033f5 mov dword ptr [eax+0FE8h],0FF0h
    m.memory
        .write::<u32>(m.cpu.regs.eax.wrapping_add(0xfe8u32), 0xff0u32);
    // 004033ff add eax,1000h
    m.cpu.regs.eax = add(m.cpu.regs.eax, 0x1000u32, &mut m.cpu.flags);
    // 00403404 lea ecx,[eax-10h]
    m.cpu.regs.ecx = m.cpu.regs.eax.wrapping_add(0xfffffff0u32);
...
pub fn x0040340b(m: &mut Machine) -> Cont {
    ...
    m.cpu.regs.ecx = m.cpu.regs.edi.wrapping_add(0xcu32);
    // 00403411 add eax,1F8h
    m.cpu.regs.eax = add(m.cpu.regs.eax, 0x1f8u32, &mut m.cpu.flags);
    // 00403416 push 1
    push(m, 0x1u32);
    // 00403418 pop edi
    m.cpu.regs.edi = pop(m);
    ...
    m.memory
        .write::<u32>(m.cpu.regs.ecx.wrapping_add(0x8u32), m.cpu.regs.eax);
    // 0040341f lea ecx,[edx+0Ch]
    m.cpu.regs.ecx = m.cpu.regs.edx.wrapping_add(0xcu32);
    // 00403422 mov [eax+8],ecx
    m.memory
        .write::<u32>(m.cpu.regs.eax.wrapping_add(0x8u32), m.cpu.regs.ecx);
    // 00403425 mov [ecx+4],eax
    m.memory
        .write::<u32>(m.cpu.regs.ecx.wrapping_add(0x4u32), m.cpu.regs.eax);
    // 00403428 and dword ptr [esi+ebx*4+44h],0
    m.memory.write::<u32>(
        m.cpu
            .regs
            .esi
            .wrapping_add((m.cpu.regs.ebx * 4))
            .wrapping_add(0x44u32),
        and(
            m.memory.read::<u32>(
                m.cpu
    ...
    m.cpu
        .regs
        .set_al(m.memory.read::<u8>(m.cpu.regs.esi.wrapping_add(0x43u32)));
    // 00403437 mov cl,al
    m.cpu.regs.set_cl(m.cpu.regs.get_al());
    // 00403439 inc cl
    m.cpu
        .regs
        .set_cl(inc(m.cpu.regs.get_cl(), &mut m.cpu.flags));
    ...
    m.memory
        .write::<u8>(m.cpu.regs.esi.wrapping_add(0x43u32), m.cpu.regs.get_cl());
...
pub fn x0040345d(m: &mut Machine) -> Cont {
    ...
    m.cpu.regs.esp = sub(m.cpu.regs.esp, 0xcu32, &mut m.cpu.flags);
    // 00403463 mov ecx,[ebp+8]
    m.cpu.regs.ecx = m.memory.read::<u32>(m.cpu.regs.ebp.wrapping_add(0x8u32));
    // 00403466 mov eax,[ebp+10h]
    m.cpu.regs.eax = m.memory.read::<u32>(m.cpu.regs.ebp.wrapping_add(0x10u32));
    // 00403469 push ebx
    push(m, m.cpu.regs.ebx);
    // 0040346a push esi
    push(m, m.cpu.regs.esi);
    ...
    m.cpu.regs.edx = m.cpu.regs.edi;
    // 00403471 lea esi,[eax+17h]
    m.cpu.regs.esi = m.cpu.regs.eax.wrapping_add(0x17u32);
    ...
    m.cpu.regs.edx = shr(m.cpu.regs.edx, 0xfu8, &mut m.cpu.flags);
    ...
    m.cpu.regs.ecx = m
        .memory
        .read::<u32>(m.cpu.regs.edi.wrapping_add(0xfffffffcu32));
    // 00403495 dec ecx
    m.cpu.regs.ecx = dec(m.cpu.regs.ecx, &mut m.cpu.flags);
    // 00403496 cmp esi,ecx
    sub(m.cpu.regs.esi, m.cpu.regs.ecx, &mut m.cpu.flags);
    // 00403498 mov [ebp+10h],ecx
    m.memory
        .write::<u32>(m.cpu.regs.ebp.wrapping_add(0x10u32), m.cpu.regs.ecx);
    ...
    m.memory
        .write::<u32>(m.cpu.regs.ebp.wrapping_add(0xfffffffcu32), m.cpu.regs.ebx);
...
pub fn x004034b5(m: &mut Machine) -> Cont {
    ...
    m.cpu.regs.ebx = add(m.cpu.regs.ebx, m.cpu.regs.ecx, &mut m.cpu.flags);
...
pub fn x004034bf(m: &mut Machine) -> Cont {
    ...
    sub(m.cpu.regs.ecx, 0x3fu32, &mut m.cpu.flags);
...
pub fn x004034ce(m: &mut Machine) -> Cont {
    ...
    m.cpu.regs.ebx = m.memory.read::<u32>(m.cpu.regs.edi.wrapping_add(0x4u32));
    // 004034d7 cmp ebx,[edi+8]
    sub(
        m.cpu.regs.ebx,
        m.memory.read::<u32>(m.cpu.regs.edi.wrapping_add(0x8u32)),
        &mut m.cpu.flags,
    );
...
pub fn x0040351e(m: &mut Machine) -> Cont {
    ...
    m.cpu.regs.ecx = m.memory.read::<u32>(m.cpu.regs.edi.wrapping_add(0x8u32));
    // 00403527 mov ebx,[edi+4]
    m.cpu.regs.ebx = m.memory.read::<u32>(m.cpu.regs.edi.wrapping_add(0x4u32));
    // 0040352a mov [ecx+4],ebx
    m.memory
        .write::<u32>(m.cpu.regs.ecx.wrapping_add(0x4u32), m.cpu.regs.ebx);
    // 0040352d mov ecx,[edi+4]
    m.cpu.regs.ecx = m.memory.read::<u32>(m.cpu.regs.edi.wrapping_add(0x4u32));
    // 00403530 mov edi,[edi+8]
    m.cpu.regs.edi = m.memory.read::<u32>(m.cpu.regs.edi.wrapping_add(0x8u32));
    // 00403533 mov [ecx+8],edi
    m.memory
        .write::<u32>(m.cpu.regs.ecx.wrapping_add(0x8u32), m.cpu.regs.edi);
    // 00403536 mov ecx,[ebp+10h]
    m.cpu.regs.ecx = m.memory.read::<u32>(m.cpu.regs.ebp.wrapping_add(0x10u32));
    // 00403539 sub ecx,esi
    m.cpu.regs.ecx = sub(m.cpu.regs.ecx, m.cpu.regs.esi, &mut m.cpu.flags);
...
pub fn x00403548(m: &mut Machine) -> Cont {
    ...
    m.cpu.regs.ecx = m.memory.read::<u32>(m.cpu.regs.ebp.wrapping_add(0xcu32));
    // 0040354e sar edi,4
    m.cpu.regs.edi = sar(m.cpu.regs.edi, 0x4u8, &mut m.cpu.flags);
    // 00403551 dec edi
    m.cpu.regs.edi = dec(m.cpu.regs.edi, &mut m.cpu.flags);
    ...
    sub(m.cpu.regs.edi, 0x3fu32, &mut m.cpu.flags);
...
pub fn x0040355b(m: &mut Machine) -> Cont {
    ...
    m.cpu.regs.ebx = m.cpu.regs.ebx.wrapping_add((m.cpu.regs.edi * 8));
    // 00403564 mov [ebp+10h],ebx
    m.memory
        .write::<u32>(m.cpu.regs.ebp.wrapping_add(0x10u32), m.cpu.regs.ebx);
    ...
    m.cpu.regs.ebx = m.memory.read::<u32>(m.cpu.regs.ebp.wrapping_add(0x10u32));
    // 00403570 mov [ecx+8],ebx
    m.memory
        .write::<u32>(m.cpu.regs.ecx.wrapping_add(0x8u32), m.cpu.regs.ebx);
    // 00403573 mov [ebx+4],ecx
    m.memory
        .write::<u32>(m.cpu.regs.ebx.wrapping_add(0x4u32), m.cpu.regs.ecx);
    // 00403576 mov ebx,[ecx+4]
    m.cpu.regs.ebx = m.memory.read::<u32>(m.cpu.regs.ecx.wrapping_add(0x4u32));
    // 00403579 mov [ebx+8],ecx
    m.memory
        .write::<u32>(m.cpu.regs.ebx.wrapping_add(0x8u32), m.cpu.regs.ecx);
...
pub fn x00403584(m: &mut Machine) -> Cont {
    ...
    m.memory
        .write::<u8>(m.cpu.regs.ebp.wrapping_add(0x13u32), m.cpu.regs.get_cl());
    // 0040358e inc cl
    m.cpu
        .regs
        .set_cl(inc(m.cpu.regs.get_cl(), &mut m.cpu.flags));
...
pub fn x00403596(m: &mut Machine) -> Cont {
    ...
    sub(
        m.memory.read::<u8>(m.cpu.regs.ebp.wrapping_add(0x13u32)),
        0x0u8,
        &mut m.cpu.flags,
    );
...
pub fn x004035f2(m: &mut Machine) -> Cont {
    ...
    m.cpu.regs.eax = m.cpu.regs.esi.wrapping_add(0x1u32);
    // 004035f8 mov [edx-4],eax
    m.memory
        .write::<u32>(m.cpu.regs.edx.wrapping_add(0xfffffffcu32), m.cpu.regs.eax);
...
pub fn x00403611(m: &mut Machine) -> Cont {
    ...
    m.memory.write::<u32>(
        m.cpu.regs.ebp.wrapping_add(0x10u32),
        sub(
            m.memory.read::<u32>(m.cpu.regs.ebp.wrapping_add(0x10u32)),
            m.cpu.regs.esi,
            &mut m.cpu.flags,
        ),
    );
    ...
    m.memory
        .write::<u32>(m.cpu.regs.ebx.wrapping_add(0xfffffffcu32), m.cpu.regs.ecx);
...
pub fn x0040365c(m: &mut Machine) -> Cont {
    ...
    m.memory.write::<u8>(
        m.cpu.regs.esi,
        dec(m.memory.read::<u8>(m.cpu.regs.esi), &mut m.cpu.flags),
    );
...
pub fn x00403695(m: &mut Machine) -> Cont {
    ...
    m.cpu.regs.esi = m.memory.read::<u32>(m.cpu.regs.edi.wrapping_add(0x4u32));
    ...
    m.cpu.regs.esi = m.memory.read::<u32>(m.cpu.regs.edi.wrapping_add(0x8u32));
    ...
    m.memory
        .write::<u32>(m.cpu.regs.ebp.wrapping_add(0x10u32), m.cpu.regs.esi);
    // 004036b9 sar esi,4
    m.cpu.regs.esi = sar(m.cpu.regs.esi, 0x4u8, &mut m.cpu.flags);
    // 004036bc dec esi
    m.cpu.regs.esi = dec(m.cpu.regs.esi, &mut m.cpu.flags);
...
pub fn x004036c2(m: &mut Machine) -> Cont {
    ...
    m.memory
        .write::<u32>(m.cpu.regs.ebx.wrapping_add(0x4u32), m.cpu.regs.edi);
...
pub fn x0040371f(m: &mut Machine) -> Cont {
    ...
    m.memory.write::<u32>(m.cpu.regs.ebx, m.cpu.regs.eax);
    // 00403747 mov [eax+ebx-4],eax
    m.memory.write::<u32>(
        m.cpu
            .regs
            .eax
            .wrapping_add(m.cpu.regs.ebx)
            .wrapping_add(0xfffffffcu32),
        m.cpu.regs.eax,
    );
    // 0040374b push 1
...
pub fn x00403784(m: &mut Machine) -> Cont {
    ...
    m.cpu.regs.ebp = m.memory.read::<u32>(0x40605cu32);
    // 0040378a push 4
    push(m, 0x4u32);
    // 0040378c push 2000h
    push(m, 0x2000u32);
...
pub fn x004037c5(m: &mut Machine) -> Cont {
    ...
    sub(m.memory.read::<u32>(0x407208u32), 0x0u32, &mut m.cpu.flags);
...
pub fn x004037ce(m: &mut Machine) -> Cont {
    ...
    m.memory.write::<u32>(0x407208u32, m.cpu.regs.eax);
    // 004037d3 cmp dword ptr ds:[40720Ch],0
    sub(m.memory.read::<u32>(0x40720cu32), 0x0u32, &mut m.cpu.flags);
...
pub fn x004037dc(m: &mut Machine) -> Cont {
    ...
    m.memory.write::<u32>(0x40720cu32, m.cpu.regs.eax);
...
pub fn x004037e3(m: &mut Machine) -> Cont {
    ...
    m.cpu.regs.eax = m.memory.read::<u32>(0x40720cu32);
    // 004037ea mov [esi+4],eax
    m.memory
        .write::<u32>(m.cpu.regs.esi.wrapping_add(0x4u32), m.cpu.regs.eax);
    // 004037ed mov ds:[40720Ch],esi
    m.memory.write::<u32>(0x40720cu32, m.cpu.regs.esi);
    // 004037f3 mov eax,[esi+4]
    m.cpu.regs.eax = m.memory.read::<u32>(m.cpu.regs.esi.wrapping_add(0x4u32));
    // 004037f6 mov [eax],esi
    m.memory.write::<u32>(m.cpu.regs.eax, m.cpu.regs.esi);
    // 004037f8 lea eax,[edi+400000h]
    m.cpu.regs.eax = m.cpu.regs.edi.wrapping_add(0x400000u32);
    // 004037fe lea ecx,[esi+98h]
    m.cpu.regs.ecx = m.cpu.regs.esi.wrapping_add(0x98u32);
    // 00403804 mov [esi+14h],eax
    m.memory
        .write::<u32>(m.cpu.regs.esi.wrapping_add(0x14u32), m.cpu.regs.eax);
    // 00403807 lea eax,[esi+18h]
    m.cpu.regs.eax = m.cpu.regs.esi.wrapping_add(0x18u32);
    // 0040380a mov [esi+0Ch],ecx
    m.memory
        .write::<u32>(m.cpu.regs.esi.wrapping_add(0xcu32), m.cpu.regs.ecx);
    // 0040380d mov [esi+10h],edi
    m.memory
        .write::<u32>(m.cpu.regs.esi.wrapping_add(0x10u32), m.cpu.regs.edi);
    // 00403810 mov [esi+8],eax
    m.memory
        .write::<u32>(m.cpu.regs.esi.wrapping_add(0x8u32), m.cpu.regs.eax);
    // 00403813 xor ebp,ebp
    m.cpu.regs.ebp = xor(m.cpu.regs.ebp, m.cpu.regs.ebp, &mut m.cpu.flags);
    // 00403815 mov ecx,0F1h
    m.cpu.regs.ecx = 0xf1u32;
    // 0040381a xor edx,edx
    m.cpu.regs.edx = xor(m.cpu.regs.edx, m.cpu.regs.edx, &mut m.cpu.flags);
    // 0040381c cmp ebp,10h
    sub(m.cpu.regs.ebp, 0x10u32, &mut m.cpu.flags);
    // 0040381f setge dl
    setge(m);
    // 00403822 dec edx
    m.cpu.regs.edx = dec(m.cpu.regs.edx, &mut m.cpu.flags);
    // 00403823 and edx,ecx
    m.cpu.regs.edx = and(m.cpu.regs.edx, m.cpu.regs.ecx, &mut m.cpu.flags);
    // 00403825 dec edx
    m.cpu.regs.edx = dec(m.cpu.regs.edx, &mut m.cpu.flags);
    // 00403826 inc ebp
    m.cpu.regs.ebp = inc(m.cpu.regs.ebp, &mut m.cpu.flags);
    // 00403827 mov [eax],edx
    m.memory.write::<u32>(m.cpu.regs.eax, m.cpu.regs.edx);
    ...
    sub(m.cpu.regs.ebp, 0x400u32, &mut m.cpu.flags);
...
pub fn x00403840(m: &mut Machine) -> Cont {
    ...
    m.cpu.regs.eax = add(m.cpu.regs.eax, m.cpu.regs.ebx, &mut m.cpu.flags);
    // 00403848 cmp edi,eax
    sub(m.cpu.regs.edi, m.cpu.regs.eax, &mut m.cpu.flags);
...
pub fn x0040384c(m: &mut Machine) -> Cont {
    ...
    m.memory.write::<u8>(
        m.cpu.regs.edi.wrapping_add(0xf8u32),
        or(
            m.memory.read::<u8>(m.cpu.regs.edi.wrapping_add(0xf8u32)),
            0xffu8,
            &mut m.cpu.flags,
        ),
    );
    // 00403853 lea eax,[edi+8]
    m.cpu.regs.eax = m.cpu.regs.edi.wrapping_add(0x8u32);
    // 00403856 mov [edi],eax
    m.memory.write::<u32>(m.cpu.regs.edi, m.cpu.regs.eax);
    // 00403858 mov dword ptr [edi+4],0F0h
    m.memory
        .write::<u32>(m.cpu.regs.edi.wrapping_add(0x4u32), 0xf0u32);
    // 0040385f add edi,1000h
    m.cpu.regs.edi = add(m.cpu.regs.edi, 0x1000u32, &mut m.cpu.flags);
...
pub fn x00403879(m: &mut Machine) -> Cont {
    ...
    sub(m.cpu.regs.esi, 0x407208u32, &mut m.cpu.flags);
...
pub fn x004038b4(m: &mut Machine) -> Cont {
    ...
    m.memory.write::<u32>(0x409228u32, m.cpu.regs.eax);
...
pub fn x004038ed(m: &mut Machine) -> Cont {
    ...
    m.cpu.regs.esi = m.memory.read::<u32>(0x40720cu32);
    // 004038f9 push edi
    push(m, m.cpu.regs.edi);
...
pub fn x00403904(m: &mut Machine) -> Cont {
    ...
    m.cpu.regs.edi = m.cpu.regs.esi.wrapping_add(0x2010u32);
    // 0040390e mov ebx,3FF000h
    m.cpu.regs.ebx = 0x3ff000u32;
...
pub fn x00403935(m: &mut Machine) -> Cont {
    ...
    m.memory.write::<u32>(
        0x409704u32,
        dec(m.memory.read::<u32>(0x409704u32), &mut m.cpu.flags),
    );
    // 0040393e mov eax,[esi+0Ch]
    m.cpu.regs.eax = m.memory.read::<u32>(m.cpu.regs.esi.wrapping_add(0xcu32));
...
pub fn x00403949(m: &mut Machine) -> Cont {
    ...
    m.memory
        .write::<u32>(m.cpu.regs.esi.wrapping_add(0xcu32), m.cpu.regs.edi);
...
pub fn x00403954(m: &mut Machine) -> Cont {
    ...
    m.cpu.regs.ebx = sub(m.cpu.regs.ebx, 0x1000u32, &mut m.cpu.flags);
    // 0040395a sub edi,8
    m.cpu.regs.edi = sub(m.cpu.regs.edi, 0x8u32, &mut m.cpu.flags);
...
pub fn x00403961(m: &mut Machine) -> Cont {
    ...
    m.cpu.regs.esi = m.memory.read::<u32>(m.cpu.regs.esi.wrapping_add(0x4u32));
...
pub fn x0040396c(m: &mut Machine) -> Cont {
    ...
    sub(
        m.memory.read::<u32>(m.cpu.regs.ecx.wrapping_add(0x18u32)),
        0xffffffffu32,
        &mut m.cpu.flags,
    );
...
pub fn x00403972(m: &mut Machine) -> Cont {
    ...
    m.cpu.regs.eax = m.cpu.regs.ecx.wrapping_add(0x20u32);
    // 00403977 pop edx
    m.cpu.regs.edx = pop(m);
...
pub fn x0040397d(m: &mut Machine) -> Cont {
    // 0040397d inc edx
    m.cpu.regs.edx = inc(m.cpu.regs.edx, &mut m.cpu.flags);
    // 0040397e add eax,8
    m.cpu.regs.eax = add(m.cpu.regs.eax, 0x8u32, &mut m.cpu.flags);
    // 00403981 cmp edx,400h
    sub(m.cpu.regs.edx, 0x400u32, &mut m.cpu.flags);
...
pub fn x004039af(m: &mut Machine) -> Cont {
    ...
    sub(
        m.cpu.regs.eax,
        m.memory.read::<u32>(m.cpu.regs.ecx.wrapping_add(0x10u32)),
        &mut m.cpu.flags,
    );
...
pub fn x004039c0(m: &mut Machine) -> Cont {
    ...
    sub(
        m.cpu.regs.eax,
        m.memory.read::<u32>(m.cpu.regs.ecx.wrapping_add(0x14u32)),
        &mut m.cpu.flags,
    );
...
pub fn x004039cd(m: &mut Machine) -> Cont {
    ...
    and(m.cpu.regs.get_al(), 0xfu8, &mut m.cpu.flags);
...
pub fn x004039d1(m: &mut Machine) -> Cont {
    ...
    m.cpu.regs.edx = 0x100u32;
    // 004039d8 and esi,0FFFh
    m.cpu.regs.esi = and(m.cpu.regs.esi, 0xfffu32, &mut m.cpu.flags);
    // 004039de cmp esi,edx
    sub(m.cpu.regs.esi, m.cpu.regs.edx, &mut m.cpu.flags);
...
pub fn x004039e2(m: &mut Machine) -> Cont {
    ...
    m.cpu.regs.esi = m.memory.read::<u32>(m.cpu.regs.esp.wrapping_add(0xcu32));
    // 004039e6 mov [esi],ecx
    m.memory.write::<u32>(m.cpu.regs.esi, m.cpu.regs.ecx);
    // 004039e8 mov esi,[esp+10h]
    m.cpu.regs.esi = m.memory.read::<u32>(m.cpu.regs.esp.wrapping_add(0x10u32));
    // 004039ec mov ecx,eax
    m.cpu.regs.ecx = m.cpu.regs.eax;
    // 004039ee and cx,0F000h
    m.cpu
        .regs
        .set_cx(and(m.cpu.regs.get_cx(), 0xf000u16, &mut m.cpu.flags));
    // 004039f3 sub eax,ecx
    m.cpu.regs.eax = sub(m.cpu.regs.eax, m.cpu.regs.ecx, &mut m.cpu.flags);
    // 004039f5 mov [esi],ecx
    m.memory.write::<u32>(m.cpu.regs.esi, m.cpu.regs.ecx);
    // 004039f7 sub eax,edx
    m.cpu.regs.eax = sub(m.cpu.regs.eax, m.cpu.regs.edx, &mut m.cpu.flags);
    // 004039f9 pop esi
    m.cpu.regs.esi = pop(m);
    // 004039fa sar eax,4
    m.cpu.regs.eax = sar(m.cpu.regs.eax, 0x4u8, &mut m.cpu.flags);
    // 004039fd lea eax,[eax+ecx+8]
    m.cpu.regs.eax = m
        .cpu
        .regs
        .eax
        .wrapping_add(m.cpu.regs.ecx)
        .wrapping_add(0x8u32);
    // 00403a01 ret
    ret(m, 0)
}
...
pub fn x00403a06(m: &mut Machine) -> Cont {
    ...
    m.cpu.regs.ecx = m.memory.read::<u32>(m.cpu.regs.esp.wrapping_add(0x8u32));
    ...
    m.cpu.regs.ecx = sar(m.cpu.regs.ecx, 0xcu8, &mut m.cpu.flags);
    // 00403a14 lea eax,[eax+ecx*8+18h]
    m.cpu.regs.eax = m
        .cpu
        .regs
        .eax
        .wrapping_add((m.cpu.regs.ecx * 8))
        .wrapping_add(0x18u32);
    // 00403a18 mov ecx,[esp+0Ch]
    m.cpu.regs.ecx = m.memory.read::<u32>(m.cpu.regs.esp.wrapping_add(0xcu32));
    // 00403a1c movzx edx,byte ptr [ecx]
    m.cpu.regs.edx = m.memory.read::<u8>(m.cpu.regs.ecx) as _;
    ...
    m.memory.write::<u8>(
        m.cpu.regs.ecx,
        and(m.memory.read::<u8>(m.cpu.regs.ecx), 0x0u8, &mut m.cpu.flags),
    );
    ...
    m.memory
        .write::<u32>(m.cpu.regs.eax.wrapping_add(0x4u32), 0xf1u32);
...
pub fn x00403a33(m: &mut Machine) -> Cont {
    ...
    m.memory.write::<u32>(
        0x409704u32,
        inc(m.memory.read::<u32>(0x409704u32), &mut m.cpu.flags),
    );
    // 00403a39 cmp dword ptr ds:[409704h],20h
    sub(m.memory.read::<u32>(0x409704u32), 0x20u32, &mut m.cpu.flags);
...
pub fn x00403a4b(m: &mut Machine) -> Cont {
    ...
    m.cpu.regs.esi = m.memory.read::<u32>(0x409228u32);
    // 00403a58 push edi
    push(m, m.cpu.regs.edi);
    // 00403a59 mov edx,[esi+10h]
    m.cpu.regs.edx = m.memory.read::<u32>(m.cpu.regs.esi.wrapping_add(0x10u32));
...
pub fn x00403a65(m: &mut Machine) -> Cont {
    ...
    m.cpu.regs.edi = m.memory.read::<u32>(m.cpu.regs.esi.wrapping_add(0x8u32));
    // 00403a68 lea ecx,[esi+2018h]
    m.cpu.regs.ecx = m.cpu.regs.esi.wrapping_add(0x2018u32);
    // 00403a6e mov eax,edi
    m.cpu.regs.eax = m.cpu.regs.edi;
    // 00403a70 sub eax,esi
    m.cpu.regs.eax = sub(m.cpu.regs.eax, m.cpu.regs.esi, &mut m.cpu.flags);
    // 00403a72 sub eax,18h
    m.cpu.regs.eax = sub(m.cpu.regs.eax, 0x18u32, &mut m.cpu.flags);
    // 00403a75 sar eax,3
    m.cpu.regs.eax = sar(m.cpu.regs.eax, 0x3u8, &mut m.cpu.flags);
    // 00403a78 shl eax,0Ch
    m.cpu.regs.eax = shl(m.cpu.regs.eax, 0xcu8, &mut m.cpu.flags);
    // 00403a7b add eax,edx
    m.cpu.regs.eax = add(m.cpu.regs.eax, m.cpu.regs.edx, &mut m.cpu.flags);
    // 00403a7d cmp edi,ecx
    sub(m.cpu.regs.edi, m.cpu.regs.ecx, &mut m.cpu.flags);
...
pub fn x00403a84(m: &mut Machine) -> Cont {
    ...
    sub(m.cpu.regs.ecx, m.cpu.regs.ebx, &mut m.cpu.flags);
...
pub fn x00403a8d(m: &mut Machine) -> Cont {
    ...
    sub(
        m.memory.read::<u32>(m.cpu.regs.edi.wrapping_add(0x4u32)),
        m.cpu.regs.ebx,
        &mut m.cpu.flags,
    );
...
pub fn x00403aa1(m: &mut Machine) -> Cont {
    ...
    m.memory
        .write::<u32>(m.cpu.regs.edi.wrapping_add(0x4u32), m.cpu.regs.ebx);
    // 00403aa7 add edi,8
    m.cpu.regs.edi = add(m.cpu.regs.edi, 0x8u32, &mut m.cpu.flags);
...
pub fn x00403abe(m: &mut Machine) -> Cont {
    ...
    m.cpu.regs.eax = m.memory.read::<u32>(m.cpu.regs.esi.wrapping_add(0x8u32));
    // 00403ac4 mov ecx,[esi+10h]
    m.cpu.regs.ecx = m.memory.read::<u32>(m.cpu.regs.esi.wrapping_add(0x10u32));
    // 00403ac7 lea edi,[esi+18h]
    m.cpu.regs.edi = m.cpu.regs.esi.wrapping_add(0x18u32);
...
pub fn x00403ad4(m: &mut Machine) -> Cont {
    ...
    m.cpu.regs.eax = m.memory.read::<u32>(m.cpu.regs.edi);
...
pub fn x00403b04(m: &mut Machine) -> Cont {
    ...
    m.cpu.regs.esi = m.memory.read::<u32>(m.cpu.regs.esi);
...
pub fn x00403b16(m: &mut Machine) -> Cont {
    ...
    m.memory.write::<u32>(0x409228u32, m.cpu.regs.esi);
    ...
    m.memory
        .write::<u32>(m.cpu.regs.esi.wrapping_add(0x8u32), m.cpu.regs.edi);
...
pub fn x00403b26(m: &mut Machine) -> Cont {
    ...
    sub(
        m.memory.read::<u32>(m.cpu.regs.edi.wrapping_add(0x10u32)),
        0xffffffffu32,
        &mut m.cpu.flags,
    );
...
pub fn x00403b33(m: &mut Machine) -> Cont {
    ...
    sub(
        m.memory.read::<u32>(m.cpu.regs.edi.wrapping_add(0xcu32)),
        0x0u32,
        &mut m.cpu.flags,
    );
...
pub fn x00403b45(m: &mut Machine) -> Cont {
    ...
    m.cpu.regs.ebx = m.memory.read::<u32>(m.cpu.regs.edi.wrapping_add(0xcu32));
    ...
    m.cpu.regs.esi = m.cpu.regs.ebx;
    // 00403b4e mov eax,ebx
    m.cpu.regs.eax = m.cpu.regs.ebx;
    // 00403b50 sub esi,edi
    m.cpu.regs.esi = sub(m.cpu.regs.esi, m.cpu.regs.edi, &mut m.cpu.flags);
    // 00403b52 sub esi,18h
    m.cpu.regs.esi = sub(m.cpu.regs.esi, 0x18u32, &mut m.cpu.flags);
    // 00403b55 sar esi,3
    m.cpu.regs.esi = sar(m.cpu.regs.esi, 0x3u8, &mut m.cpu.flags);
    // 00403b58 shl esi,0Ch
    m.cpu.regs.esi = shl(m.cpu.regs.esi, 0xcu8, &mut m.cpu.flags);
...
pub fn x00403bab(m: &mut Machine) -> Cont {
    ...
    m.cpu.regs.eax = m.cpu.regs.esi.wrapping_add(0x4u32);
    // 00403bae mov [ebp-4],edx
    m.memory
        .write::<u32>(m.cpu.regs.ebp.wrapping_add(0xfffffffcu32), m.cpu.regs.edx);
    // 00403bb1 or byte ptr [eax+0F4h],0FFh
    m.memory.write::<u8>(
        m.cpu.regs.eax.wrapping_add(0xf4u32),
        or(
            m.memory.read::<u8>(m.cpu.regs.eax.wrapping_add(0xf4u32)),
            0xffu8,
            &mut m.cpu.flags,
        ),
    );
    // 00403bb8 lea edx,[eax+4]
    m.cpu.regs.edx = m.cpu.regs.eax.wrapping_add(0x4u32);
    // 00403bbb mov [eax-4],edx
    m.memory
        .write::<u32>(m.cpu.regs.eax.wrapping_add(0xfffffffcu32), m.cpu.regs.edx);
    // 00403bbe mov edx,0F0h
    m.cpu.regs.edx = 0xf0u32;
    // 00403bc3 mov [eax],edx
    m.memory.write::<u32>(m.cpu.regs.eax, m.cpu.regs.edx);
    // 00403bc5 mov [ecx],edx
    m.memory.write::<u32>(m.cpu.regs.ecx, m.cpu.regs.edx);
    // 00403bc7 mov dword ptr [ecx+4],0F1h
    m.memory
        .write::<u32>(m.cpu.regs.ecx.wrapping_add(0x4u32), 0xf1u32);
    // 00403bce add eax,1000h
    m.cpu.regs.eax = add(m.cpu.regs.eax, 0x1000u32, &mut m.cpu.flags);
    // 00403bd3 add ecx,8
    m.cpu.regs.ecx = add(m.cpu.regs.ecx, 0x8u32, &mut m.cpu.flags);
...
pub fn x00403bdb(m: &mut Machine) -> Cont {
    ...
    m.memory.write::<u32>(0x409228u32, m.cpu.regs.edi);
    // 00403be1 lea eax,[edi+2018h]
    m.cpu.regs.eax = m.cpu.regs.edi.wrapping_add(0x2018u32);
    // 00403be7 cmp ecx,eax
    sub(m.cpu.regs.ecx, m.cpu.regs.eax, &mut m.cpu.flags);
...
pub fn x00403bf5(m: &mut Machine) -> Cont {
    ...
    m.cpu.regs.eax = and(m.cpu.regs.eax, m.cpu.regs.ecx, &mut m.cpu.flags);
    // 00403bfb mov [edi+0Ch],eax
    m.memory
        .write::<u32>(m.cpu.regs.edi.wrapping_add(0xcu32), m.cpu.regs.eax);
    // 00403bfe mov eax,[ebp+8]
    m.cpu.regs.eax = m.memory.read::<u32>(m.cpu.regs.ebp.wrapping_add(0x8u32));
    // 00403c01 mov [esi+8],al
    m.memory
        .write::<u8>(m.cpu.regs.esi.wrapping_add(0x8u32), m.cpu.regs.get_al());
    // 00403c04 mov [edi+8],ebx
    m.memory
        .write::<u32>(m.cpu.regs.edi.wrapping_add(0x8u32), m.cpu.regs.ebx);
    ...
    m.memory.write::<u32>(
        m.cpu.regs.esi.wrapping_add(0x4u32),
        sub(
            m.memory.read::<u32>(m.cpu.regs.esi.wrapping_add(0x4u32)),
            m.cpu.regs.eax,
            &mut m.cpu.flags,
        ),
    );
...
pub fn x00403c23(m: &mut Machine) -> Cont {
    ...
    m.memory
        .write::<u8>(m.cpu.regs.ecx.wrapping_add(0x8u32), m.cpu.regs.get_bl());
    ...
    m.cpu.regs.edx = sub(m.cpu.regs.edx, m.cpu.regs.ebx, &mut m.cpu.flags);
    // 00403c3b mov [ecx+4],edx
    m.memory
        .write::<u32>(m.cpu.regs.ecx.wrapping_add(0x4u32), m.cpu.regs.edx);
    // 00403c3e movzx edx,bl
    m.cpu.regs.edx = m.cpu.regs.get_bl() as _;
    // 00403c41 sub [eax+18h],edx
    m.memory.write::<u32>(
        m.cpu.regs.eax.wrapping_add(0x18u32),
        sub(
            m.memory.read::<u32>(m.cpu.regs.eax.wrapping_add(0x18u32)),
            m.cpu.regs.edx,
            &mut m.cpu.flags,
        ),
    );
    // 00403c44 lea eax,[ecx+100h]
    m.cpu.regs.eax = m.cpu.regs.ecx.wrapping_add(0x100u32);
...
pub fn x00403c53(m: &mut Machine) -> Cont {
    ...
    m.cpu.regs.edx = m.memory.read::<u32>(m.cpu.regs.ebp.wrapping_add(0x10u32));
    // 00403c5d push ebx
    push(m, m.cpu.regs.ebx);
    // 00403c5e push esi
    push(m, m.cpu.regs.esi);
    ...
    m.cpu.regs.edi = m.memory.read::<u32>(m.cpu.regs.ecx);
    // 00403c65 lea ebx,[ecx+0F8h]
    m.cpu.regs.ebx = m.cpu.regs.ecx.wrapping_add(0xf8u32);
...
pub fn x00403c77(m: &mut Machine) -> Cont {
    ...
    m.cpu.regs.eax = m.cpu.regs.edi.wrapping_add(m.cpu.regs.edx);
    // 00403c7a mov [edi],dl
    m.memory.write::<u8>(m.cpu.regs.edi, m.cpu.regs.get_dl());
...
pub fn x00403c87(m: &mut Machine) -> Cont {
    ...
    m.cpu.regs.eax = m.cpu.regs.ecx.wrapping_add(0x8u32);
...
pub fn x00403c98(m: &mut Machine) -> Cont {
    ...
    m.cpu.regs.esi = add(m.cpu.regs.esi, m.cpu.regs.edi, &mut m.cpu.flags);
    // 00403c9a cmp byte ptr [esi],0
    sub(m.memory.read::<u8>(m.cpu.regs.esi), 0x0u8, &mut m.cpu.flags);
...
pub fn x00403c9f(m: &mut Machine) -> Cont {
    ...
    m.cpu.regs.esi = m.cpu.regs.eax.wrapping_add(m.cpu.regs.edx);
...
pub fn x00403ca8(m: &mut Machine) -> Cont {
    ...
    m.cpu.regs.set_bl(m.memory.read::<u8>(m.cpu.regs.eax));
    // 00403caa test bl,bl
    and(m.cpu.regs.get_bl(), m.cpu.regs.get_bl(), &mut m.cpu.flags);
...
pub fn x00403cae(m: &mut Machine) -> Cont {
    ...
    m.cpu.regs.ebx = m.cpu.regs.eax.wrapping_add(0x1u32);
    // 00403cb3 pop esi
    m.cpu.regs.esi = pop(m);
    // 00403cb4 cmp byte ptr [ebx],0
    sub(m.memory.read::<u8>(m.cpu.regs.ebx), 0x0u8, &mut m.cpu.flags);
...
pub fn x00403ccb(m: &mut Machine) -> Cont {
    ...
    m.memory.write::<u32>(
        m.cpu.regs.ebp.wrapping_add(0xcu32),
        sub(
            m.memory.read::<u32>(m.cpu.regs.ebp.wrapping_add(0xcu32)),
            m.cpu.regs.esi,
            &mut m.cpu.flags,
        ),
    );
...
pub fn x00403cde(m: &mut Machine) -> Cont {
    ...
    m.cpu.regs.esi = m.cpu.regs.get_bl() as _;
...
pub fn x00403ceb(m: &mut Machine) -> Cont {
    ...
    m.cpu.regs.esi = m.cpu.regs.ecx.wrapping_add(0x8u32);
...
pub fn x00403cf2(m: &mut Machine) -> Cont {
    ...
    m.cpu.regs.eax = m.cpu.regs.esi.wrapping_add(m.cpu.regs.edx);
...
pub fn x00403d00(m: &mut Machine) -> Cont {
    ...
    m.cpu.regs.ebx = m.cpu.regs.esi.wrapping_add(0x1u32);
    // 00403d05 pop eax
    m.cpu.regs.eax = pop(m);
...
pub fn x00403d0f(m: &mut Machine) -> Cont {
    ...
    m.cpu.regs.ebx = m.cpu.regs.eax.wrapping_add(m.cpu.regs.edx);
...
pub fn x00403d17(m: &mut Machine) -> Cont {
    ...
    m.memory.write::<u32>(m.cpu.regs.ecx, m.cpu.regs.ebx);
...
pub fn x00403d20(m: &mut Machine) -> Cont {
    ...
    m.memory.write::<u32>(m.cpu.regs.ecx, m.cpu.regs.esi);
    // 00403d29 mov [eax],dl
    m.memory.write::<u8>(m.cpu.regs.eax, m.cpu.regs.get_dl());
    // 00403d2b add eax,8
    m.cpu.regs.eax = add(m.cpu.regs.eax, 0x8u32, &mut m.cpu.flags);
...
pub fn x00403d30(m: &mut Machine) -> Cont {
    ...
    sub(m.cpu.regs.eax, m.cpu.regs.edx, &mut m.cpu.flags);
...
pub fn x00403d40(m: &mut Machine) -> Cont {
    ...
    m.cpu.regs.esi = add(m.cpu.regs.esi, m.cpu.regs.eax, &mut m.cpu.flags);
...
pub fn x00403d47(m: &mut Machine) -> Cont {
    ...
    m.cpu.regs.ebx = m.cpu.regs.esi.wrapping_add(m.cpu.regs.edx);
...
pub fn x00403d58(m: &mut Machine) -> Cont {
    ...
    m.cpu.regs.eax = m.cpu.regs.esi.wrapping_add(0x8u32);
    // 00403d66 imul ecx,0Fh
    m.cpu.regs.ecx = imul(m.cpu.regs.ecx as i32, 0xfu32 as i32, &mut m.cpu.flags) as u32;
    // 00403d69 shl eax,4
    m.cpu.regs.eax = shl(m.cpu.regs.eax, 0x4u8, &mut m.cpu.flags);
...
pub fn x00403d77(m: &mut Machine) -> Cont {
    ...
    m.cpu.regs.ecx = m.memory.read::<u8>(m.cpu.regs.edx) as _;
    // 00403d86 push edi
    push(m, m.cpu.regs.edi);
    ...
    m.cpu.regs.eax = sar(m.cpu.regs.eax, 0xcu8, &mut m.cpu.flags);
    // 00403d96 cmp ecx,[ebp+14h]
    sub(
        m.cpu.regs.ecx,
        m.memory.read::<u32>(m.cpu.regs.ebp.wrapping_add(0x14u32)),
        &mut m.cpu.flags,
    );
...
pub fn x00403d9f(m: &mut Machine) -> Cont {
    ...
    m.cpu.regs.ecx = sub(m.cpu.regs.ecx, m.cpu.regs.eax, &mut m.cpu.flags);
    // 00403da4 mov [edx],al
    m.memory.write::<u8>(m.cpu.regs.edx, m.cpu.regs.get_al());
    ...
    m.memory
        .write::<u32>(m.cpu.regs.edi.wrapping_add(0x4u32), 0xf1u32);
...
pub fn x00403db3(m: &mut Machine) -> Cont {
    ...
    m.cpu.regs.esi = m.cpu.regs.edx.wrapping_add(m.cpu.regs.eax);
    // 00403db9 lea eax,[ebx+0F8h]
    m.cpu.regs.eax = m.cpu.regs.ebx.wrapping_add(0xf8u32);
...
pub fn x00403dc3(m: &mut Machine) -> Cont {
    ...
    m.cpu.regs.eax = m.cpu.regs.ecx.wrapping_add(m.cpu.regs.edx);
...
pub fn x00403dd6(m: &mut Machine) -> Cont {
    ...
    m.cpu
        .regs
        .set_al(m.memory.read::<u8>(m.cpu.regs.ebp.wrapping_add(0x14u32)));
    // 00403dd9 mov [edx],al
    m.memory.write::<u8>(m.cpu.regs.edx, m.cpu.regs.get_al());
    // 00403ddb mov eax,[ebx]
    m.cpu.regs.eax = m.memory.read::<u32>(m.cpu.regs.ebx);
    // 00403ddd cmp edx,eax
    sub(m.cpu.regs.edx, m.cpu.regs.eax, &mut m.cpu.flags);
...
pub fn x00403def(m: &mut Machine) -> Cont {
    ...
    m.memory.write::<u32>(m.cpu.regs.ebx, m.cpu.regs.esi);
    // 00403df3 cmp [esi],al
    sub(
        m.memory.read::<u8>(m.cpu.regs.esi),
        m.cpu.regs.get_al(),
...
pub fn x00403df7(m: &mut Machine) -> Cont {
    ...
    sub(
        m.memory
            .read::<u8>(m.cpu.regs.esi.wrapping_add(m.cpu.regs.eax)),
        0x0u8,
        &mut m.cpu.flags,
    );
...
pub fn x00403dfe(m: &mut Machine) -> Cont {
    ...
    m.memory
        .write::<u32>(m.cpu.regs.ebx.wrapping_add(0x4u32), m.cpu.regs.eax);
...
pub fn x00403e03(m: &mut Machine) -> Cont {
    ...
    m.cpu.regs.eax = m.cpu.regs.ebx.wrapping_add(0x8u32);
    ...
    m.memory
        .write::<u32>(m.cpu.regs.ebp.wrapping_add(0xfffffffcu32), 0x1u32);
...
pub fn x00403e20(m: &mut Machine) -> Cont {
    ...
    m.cpu.regs.eax = m.memory.read::<u32>(0x409708u32);
...
pub fn x00403e60(m: &mut Machine) -> Cont {
    // 00403e60 test edi,3
    and(m.cpu.regs.edi, 0x3u32, &mut m.cpu.flags);
...
pub fn x00403e68(m: &mut Machine) -> Cont {
    // 00403e68 shr ecx,2
    m.cpu.regs.ecx = shr(m.cpu.regs.ecx, 0x2u8, &mut m.cpu.flags);
    // 00403e6b and edx,3
    m.cpu.regs.edx = and(m.cpu.regs.edx, 0x3u32, &mut m.cpu.flags);
    // 00403e6e cmp ecx,8
    sub(m.cpu.regs.ecx, 0x8u32, &mut m.cpu.flags);
...
pub fn x00403e73(m: &mut Machine) -> Cont {
    ...
    indirect(
        m,
        m.memory
            .read((m.cpu.regs.edx * 4).wrapping_add(0x403f88u32)),
    )
}
...
pub fn x00403e7c(m: &mut Machine) -> Cont {
    ...
    m.cpu.regs.eax = m.cpu.regs.edi;
    // 00403e7e mov edx,3
    m.cpu.regs.edx = 0x3u32;
    // 00403e83 sub ecx,4
    m.cpu.regs.ecx = sub(m.cpu.regs.ecx, 0x4u32, &mut m.cpu.flags);
...
pub fn x00403e88(m: &mut Machine) -> Cont {
    // 00403e88 and eax,3
    m.cpu.regs.eax = and(m.cpu.regs.eax, 0x3u32, &mut m.cpu.flags);
    // 00403e8b add ecx,eax
    m.cpu.regs.ecx = add(m.cpu.regs.ecx, m.cpu.regs.eax, &mut m.cpu.flags);
    // 00403e8d jmp dword ptr [eax*4+403EA0h]
    indirect(
        m,
        m.memory
            .read((m.cpu.regs.eax * 4).wrapping_add(0x403ea0u32)),
    )
}
...
pub fn x00403e94(m: &mut Machine) -> Cont {
    ...
    indirect(
        m,
        m.memory
            .read((m.cpu.regs.ecx * 4).wrapping_add(0x403f98u32)),
    )
}
...
pub fn x00403e9c(m: &mut Machine) -> Cont {
    ...
    indirect(
        m,
        m.memory
            .read((m.cpu.regs.ecx * 4).wrapping_add(0x403f1cu32)),
    )
}
...
pub fn x00403ff3(m: &mut Machine) -> Cont {
    ...
    indirect(
        m,
        m.memory
            .read((m.cpu.regs.edx * 4).wrapping_add(0x404120u32)),
    )
}
...
pub fn x00404000(m: &mut Machine) -> Cont {
    // 00404000 neg ecx
    m.cpu.regs.ecx = neg(m.cpu.regs.ecx, &mut m.cpu.flags);
    // 00404002 jmp dword ptr [ecx*4+4040D0h]
    indirect(
        m,
        m.memory
            .read((m.cpu.regs.ecx * 4).wrapping_add(0x4040d0u32)),
    )
}
...
pub fn x0040400c(m: &mut Machine) -> Cont {
    ...
    m.cpu.regs.edx = 0x3u32;
    // 00404013 cmp ecx,4
    sub(m.cpu.regs.ecx, 0x4u32, &mut m.cpu.flags);
...
pub fn x00404018(m: &mut Machine) -> Cont {
    ...
    indirect(
        m,
        m.memory
            .read((m.cpu.regs.eax * 4).wrapping_add(0x404028u32)),
    )
}
...
pub fn x00404024(m: &mut Machine) -> Cont {
    ...
    indirect(
        m,
        m.memory
            .read((m.cpu.regs.ecx * 4).wrapping_add(0x404120u32)),
    )
}
...
pub fn x00404186(m: &mut Machine) -> Cont {
    ...
    m.cpu.regs.eax = m.memory.read::<u8>(m.cpu.regs.esp.wrapping_add(0x4u32)) as _;
    // 0040418b mov cl,[esp+0Ch]
    m.cpu
        .regs
        .set_cl(m.memory.read::<u8>(m.cpu.regs.esp.wrapping_add(0xcu32)));
    // 0040418f test [eax+409861h],cl
    and(
        m.memory
            .read::<u8>(m.cpu.regs.eax.wrapping_add(0x409861u32)),
        m.cpu.regs.get_cl(),
        &mut m.cpu.flags,
    );
...
pub fn x0040419e(m: &mut Machine) -> Cont {
    ...
    m.cpu.regs.eax = m
        .memory
        .read::<u16>((m.cpu.regs.eax * 2).wrapping_add(0x40933au32)) as _;
...
pub fn x004041b7(m: &mut Machine) -> Cont {
    ...
    m.cpu.regs.esp = sub(m.cpu.regs.esp, 0x18u32, &mut m.cpu.flags);
    // 004041bd push ebx
    push(m, m.cpu.regs.ebx);
    // 004041be push esi
    push(m, m.cpu.regs.esi);
...
pub fn x004041c8(m: &mut Machine) -> Cont {
    ...
    sub(
        m.cpu.regs.esi,
        m.memory.read::<u32>(0x409748u32),
        &mut m.cpu.flags,
    );
    // 004041d1 mov [ebp+8],esi
    m.memory
        .write::<u32>(m.cpu.regs.ebp.wrapping_add(0x8u32), m.cpu.regs.esi);
...
pub fn x004041ef(m: &mut Machine) -> Cont {
    ...
    m.cpu.regs.eax = add(m.cpu.regs.eax, 0x30u32, &mut m.cpu.flags);
    // 004041f2 inc edx
    m.cpu.regs.edx = inc(m.cpu.regs.edx, &mut m.cpu.flags);
    // 004041f3 cmp eax,409328h
    sub(m.cpu.regs.eax, 0x409328u32, &mut m.cpu.flags);
...
pub fn x004041fa(m: &mut Machine) -> Cont {
    ...
    m.cpu.regs.eax = m.cpu.regs.ebp.wrapping_add(0xffffffe8u32);
    // 004041fd push eax
    push(m, m.cpu.regs.eax);
    // 004041fe push esi
    push(m, m.cpu.regs.esi);
...
pub fn x0040420e(m: &mut Machine) -> Cont {
    ...
    m.memory.write::<u32>(0x409748u32, m.cpu.regs.esi);
    // 00404222 rep stosd
    rep(m, Rep::REP, stosd);
    // 00404224 stosb
    stosb(m);
    // 00404225 mov ds:[409964h],ebx
    m.memory.write::<u32>(0x409964u32, m.cpu.regs.ebx);
...
pub fn x00404231(m: &mut Machine) -> Cont {
    ...
    sub(
        m.memory
            .read::<u8>(m.cpu.regs.ebp.wrapping_add(0xffffffeeu32)),
        0x0u8,
        &mut m.cpu.flags,
    );
...
pub fn x0040423b(m: &mut Machine) -> Cont {
    ...
    m.cpu.regs.ecx = m.cpu.regs.ebp.wrapping_add(0xffffffefu32);
    // 0040423e mov dl,[ecx]
    m.cpu.regs.set_dl(m.memory.read::<u8>(m.cpu.regs.ecx));
    // 00404240 test dl,dl
    and(m.cpu.regs.get_dl(), m.cpu.regs.get_dl(), &mut m.cpu.flags);
...
pub fn x00404248(m: &mut Machine) -> Cont {
    ...
    m.cpu.regs.eax = m
        .memory
        .read::<u8>(m.cpu.regs.ecx.wrapping_add(0xffffffffu32)) as _;
...
pub fn x00404257(m: &mut Machine) -> Cont {
    ...
    m.memory.write::<u8>(
        m.cpu.regs.eax.wrapping_add(0x409861u32),
        or(
            m.memory
                .read::<u8>(m.cpu.regs.eax.wrapping_add(0x409861u32)),
            0x4u8,
...
pub fn x00404261(m: &mut Machine) -> Cont {
    ...
    m.cpu.regs.esi = m.cpu.regs.edx.wrapping_add((m.cpu.regs.edx * 2));
    // 00404270 mov [ebp-4],ebx
    m.memory
        .write::<u32>(m.cpu.regs.ebp.wrapping_add(0xfffffffcu32), m.cpu.regs.ebx);
    // 00404273 shl esi,4
    m.cpu.regs.esi = shl(m.cpu.regs.esi, 0x4u8, &mut m.cpu.flags);
    // 00404276 stosb
    stosb(m);
    // 00404277 lea ebx,[esi+409248h]
    m.cpu.regs.ebx = m.cpu.regs.esi.wrapping_add(0x409248u32);
...
pub fn x00404284(m: &mut Machine) -> Cont {
    ...
    m.cpu
        .regs
        .set_dl(m.memory.read::<u8>(m.cpu.regs.ecx.wrapping_add(0x1u32)));
    // 00404287 test dl,dl
    and(m.cpu.regs.get_dl(), m.cpu.regs.get_dl(), &mut m.cpu.flags);
...
pub fn x0040428b(m: &mut Machine) -> Cont {
    ...
    m.cpu.regs.eax = m.memory.read::<u8>(m.cpu.regs.ecx) as _;
    // 0040428e movzx edi,dl
    m.cpu.regs.edi = m.cpu.regs.get_dl() as _;
...
pub fn x00404295(m: &mut Machine) -> Cont {
    ...
    m.cpu.regs.set_dl(
        m.memory
            .read::<u8>(m.cpu.regs.edx.wrapping_add(0x409230u32)),
    );
...
pub fn x004042a9(m: &mut Machine) -> Cont {
    ...
    sub(m.memory.read::<u8>(m.cpu.regs.ecx), 0x0u8, &mut m.cpu.flags);
...
pub fn x004042b0(m: &mut Machine) -> Cont {
    ...
    // 004042b3 add ebx,8
    m.cpu.regs.ebx = add(m.cpu.regs.ebx, 0x8u32, &mut m.cpu.flags);
...
pub fn x004042bc(m: &mut Machine) -> Cont {
    ...
    m.memory.write::<u32>(0x40975cu32, 0x1u32);
    // 004042c9 push eax
    push(m, m.cpu.regs.eax);
    // 004042ca mov ds:[409748h],eax
    m.memory.write::<u32>(0x409748u32, m.cpu.regs.eax);
...
pub fn x004042d4(m: &mut Machine) -> Cont {
    ...
    m.cpu.regs.esi = m.cpu.regs.esi.wrapping_add(0x40923cu32);
    // 004042da mov edi,409750h
    m.cpu.regs.edi = 0x409750u32;
    // 004042df movsd
    movsd(m);
    // 004042e0 movsd
    movsd(m);
    ...
    m.memory.write::<u32>(0x409964u32, m.cpu.regs.eax);
    // 004042e7 movsd
    movsd(m);
...
pub fn x004042ea(m: &mut Machine) -> Cont {
    ...
    sub(
        m.memory
            .read::<u8>(m.cpu.regs.ecx.wrapping_add(0xffffffffu32)),
        0x0u8,
        &mut m.cpu.flags,
    );
...
pub fn x004042f6(m: &mut Machine) -> Cont {
    ...
    sub(m.cpu.regs.eax, 0xffu32, &mut m.cpu.flags);
...
pub fn x00404320(m: &mut Machine) -> Cont {
    ...
    m.memory.write::<u32>(0x40975cu32, m.cpu.regs.ebx);
...
pub fn x00404350(m: &mut Machine) -> Cont {
    ...
    m.memory.write::<u32>(
        0x409710u32,
        and(m.memory.read::<u32>(0x409710u32), 0x0u32, &mut m.cpu.flags),
    );
    // 0040435b cmp eax,0FFFFFFFEh
    sub(m.cpu.regs.eax, 0xfffffffeu32, &mut m.cpu.flags);
...
pub fn x00404370(m: &mut Machine) -> Cont {
    ...
    sub(m.cpu.regs.eax, 0xfffffffdu32, &mut m.cpu.flags);
...
pub fn x00404385(m: &mut Machine) -> Cont {
    ...
    sub(m.cpu.regs.eax, 0xfffffffcu32, &mut m.cpu.flags);
...
pub fn x0040438a(m: &mut Machine) -> Cont {
    ...
    m.cpu.regs.eax = m.memory.read::<u32>(0x409738u32);
...
pub fn x0040439a(m: &mut Machine) -> Cont {
    ...
    m.cpu.regs.eax = sub(m.cpu.regs.eax, 0x3a4u32, &mut m.cpu.flags);
...
pub fn x004043a5(m: &mut Machine) -> Cont {
    // 004043a5 sub eax,4
    m.cpu.regs.eax = sub(m.cpu.regs.eax, 0x4u32, &mut m.cpu.flags);
...
pub fn x004043aa(m: &mut Machine) -> Cont {
    ...
    m.cpu.regs.eax = sub(m.cpu.regs.eax, 0xdu32, &mut m.cpu.flags);
...
pub fn x004043cd(m: &mut Machine) -> Cont {
    ...
    m.memory.write::<u32>(0x40975cu32, m.cpu.regs.eax);
...
pub fn x004043f6(m: &mut Machine) -> Cont {
    ...
    m.cpu.regs.esp = sub(m.cpu.regs.esp, 0x514u32, &mut m.cpu.flags);
    // 004043ff lea eax,[ebp-14h]
    m.cpu.regs.eax = m.cpu.regs.ebp.wrapping_add(0xffffffecu32);
    // 00404402 push esi
    push(m, m.cpu.regs.esi);
    // 00404403 push eax
    push(m, m.cpu.regs.eax);
    // 00404404 push dword ptr ds:[409748h]
    push(m, m.memory.read::<u32>(0x409748u32));
...
pub fn x0040442c(m: &mut Machine) -> Cont {
    ...
    m.cpu.regs.set_al(
        m.memory
            .read::<u8>(m.cpu.regs.ebp.wrapping_add(0xfffffff2u32)),
    );
    // 0040442f mov byte ptr [ebp-114h],20h
    m.memory
        .write::<u8>(m.cpu.regs.ebp.wrapping_add(0xfffffeecu32), 0x20u8);
    // 00404436 test al,al
    and(m.cpu.regs.get_al(), m.cpu.regs.get_al(), &mut m.cpu.flags);
...
pub fn x0040443a(m: &mut Machine) -> Cont {
    ...
    m.cpu.regs.edx = m.cpu.regs.ebp.wrapping_add(0xfffffff3u32);
...
pub fn x00404449(m: &mut Machine) -> Cont {
    ...
    m.cpu.regs.ecx = m.cpu.regs.ebx;
    // 00404461 and ecx,3
    m.cpu.regs.ecx = and(m.cpu.regs.ecx, 0x3u32, &mut m.cpu.flags);
    // 00404464 rep stosb
    rep(m, Rep::REP, stosb);
    // 00404466 inc edx
    m.cpu.regs.edx = inc(m.cpu.regs.edx, &mut m.cpu.flags);
    ...
    m.cpu.regs.set_al(
        m.memory
            .read::<u8>(m.cpu.regs.edx.wrapping_add(0xffffffffu32)),
    );
    // 0040446b test al,al
    and(m.cpu.regs.get_al(), m.cpu.regs.get_al(), &mut m.cpu.flags);
...
pub fn x0040446f(m: &mut Machine) -> Cont {
    ...
    m.cpu.regs.eax = m.cpu.regs.ebp.wrapping_add(0xfffffaecu32);
    // 00404479 push dword ptr ds:[409964h]
    push(m, m.memory.read::<u32>(0x409964u32));
    // 0040447f push dword ptr ds:[409748h]
    push(m, m.memory.read::<u32>(0x409748u32));
    // 00404485 push eax
    push(m, m.cpu.regs.eax);
    // 00404486 lea eax,[ebp-114h]
    m.cpu.regs.eax = m.cpu.regs.ebp.wrapping_add(0xfffffeecu32);
    // 0040448c push esi
    push(m, m.cpu.regs.esi);
    // 0040448d push eax
    push(m, m.cpu.regs.eax);
...
pub fn x00404495(m: &mut Machine) -> Cont {
    ...
    m.cpu.regs.eax = m.cpu.regs.ebp.wrapping_add(0xfffffdecu32);
...
pub fn x004044b9(m: &mut Machine) -> Cont {
    ...
    m.cpu.regs.eax = m.cpu.regs.ebp.wrapping_add(0xfffffcecu32);
...
pub fn x004044e1(m: &mut Machine) -> Cont {
    ...
    m.cpu.regs.esp = add(m.cpu.regs.esp, 0x5cu32, &mut m.cpu.flags);
    // 004044e4 xor eax,eax
    m.cpu.regs.eax = xor(m.cpu.regs.eax, m.cpu.regs.eax, &mut m.cpu.flags);
    // 004044e6 lea ecx,[ebp-514h]
    m.cpu.regs.ecx = m.cpu.regs.ebp.wrapping_add(0xfffffaecu32);
    // 004044ec mov dx,[ecx]
    m.cpu.regs.set_dx(m.memory.read::<u16>(m.cpu.regs.ecx));
    // 004044ef test dl,1
    and(m.cpu.regs.get_dl(), 0x1u8, &mut m.cpu.flags);
...
pub fn x004044f4(m: &mut Machine) -> Cont {
    ...
    m.memory.write::<u8>(
        m.cpu.regs.eax.wrapping_add(0x409760u32),
        m.cpu.regs.get_dl(),
    );
...
pub fn x0040450a(m: &mut Machine) -> Cont {
    // 0040450a test dl,2
    and(m.cpu.regs.get_dl(), 0x2u8, &mut m.cpu.flags);
...
pub fn x0040451f(m: &mut Machine) -> Cont {
    ...
    m.memory.write::<u8>(
        ...
        and(
            m.memory
                .read::<u8>(m.cpu.regs.eax.wrapping_add(0x409760u32)),
            0x0u8,
            &mut m.cpu.flags,
        ),
    );
...
pub fn x0040452f(m: &mut Machine) -> Cont {
    ...
    sub(m.cpu.regs.eax, 0x41u32, &mut m.cpu.flags);
...
pub fn x0040453b(m: &mut Machine) -> Cont {
    ...
    sub(m.cpu.regs.eax, 0x5au32, &mut m.cpu.flags);
...
pub fn x00404540(m: &mut Machine) -> Cont {
    ...
    m.cpu
        .regs
        .set_cl(add(m.cpu.regs.get_cl(), 0x20u8, &mut m.cpu.flags));
...
pub fn x00404554(m: &mut Machine) -> Cont {
    ...
    sub(m.cpu.regs.eax, 0x61u32, &mut m.cpu.flags);
...
pub fn x00404559(m: &mut Machine) -> Cont {
    ...
    sub(m.cpu.regs.eax, 0x7au32, &mut m.cpu.flags);
...
pub fn x0040455e(m: &mut Machine) -> Cont {
    ...
    m.cpu
        .regs
        .set_cl(sub(m.cpu.regs.get_cl(), 0x20u8, &mut m.cpu.flags));
...
pub fn x0040458b(m: &mut Machine) -> Cont {
    ...
    m.memory.write::<u32>(0x409aa8u32, 0x1u32);
    // 00404596 ret
    ret(m, 0)
}
...
pub fn x004045a0(m: &mut Machine) -> Cont {
    ...
    m.cpu.regs.edi = m.memory.read::<u32>(m.cpu.regs.esp.wrapping_add(0x8u32));
...
pub fn x004045b0(m: &mut Machine) -> Cont {
    ...
    push(m, m.cpu.regs.edi);
    // 004045b5 test ecx,3
    and(m.cpu.regs.ecx, 0x3u32, &mut m.cpu.flags);
...
pub fn x004045cc(m: &mut Machine) -> Cont {
    ...
    m.cpu.regs.eax = m.memory.read::<u32>(m.cpu.regs.ecx);
    // 004045ce mov edx,7EFEFEFFh
    m.cpu.regs.edx = 0x7efefeffu32;
    // 004045d3 add edx,eax
    m.cpu.regs.edx = add(m.cpu.regs.edx, m.cpu.regs.eax, &mut m.cpu.flags);
    // 004045d5 xor eax,0FFFFFFFFh
    m.cpu.regs.eax = xor(m.cpu.regs.eax, 0xffffffffu32, &mut m.cpu.flags);
    // 004045d8 xor eax,edx
    m.cpu.regs.eax = xor(m.cpu.regs.eax, m.cpu.regs.edx, &mut m.cpu.flags);
    // 004045da add ecx,4
    m.cpu.regs.ecx = add(m.cpu.regs.ecx, 0x4u32, &mut m.cpu.flags);
    // 004045dd test eax,81010100h
    and(m.cpu.regs.eax, 0x81010100u32, &mut m.cpu.flags);
...
pub fn x004045eb(m: &mut Machine) -> Cont {
    // 004045eb test ah,ah
    and(m.cpu.regs.get_ah(), m.cpu.regs.get_ah(), &mut m.cpu.flags);
...
pub fn x004045ef(m: &mut Machine) -> Cont {
    ...
    and(m.cpu.regs.eax, 0xff0000u32, &mut m.cpu.flags);
...
pub fn x004045f6(m: &mut Machine) -> Cont {
    ...
    and(m.cpu.regs.eax, 0xff000000u32, &mut m.cpu.flags);
...
pub fn x004045ff(m: &mut Machine) -> Cont {
    ...
    m.cpu.regs.edi = m.cpu.regs.ecx.wrapping_add(0xffffffffu32);
...
pub fn x00404604(m: &mut Machine) -> Cont {
    ...
    m.cpu.regs.edi = m.cpu.regs.ecx.wrapping_add(0xfffffffeu32);
...
pub fn x00404609(m: &mut Machine) -> Cont {
    ...
    m.cpu.regs.edi = m.cpu.regs.ecx.wrapping_add(0xfffffffdu32);
...
pub fn x0040460e(m: &mut Machine) -> Cont {
    ...
    m.cpu.regs.edi = m.cpu.regs.ecx.wrapping_add(0xfffffffcu32);
...
pub fn x00404631(m: &mut Machine) -> Cont {
    ...
    m.memory.write::<u32>(m.cpu.regs.edi, m.cpu.regs.edx);
    // 00404633 add edi,4
    m.cpu.regs.edi = add(m.cpu.regs.edi, 0x4u32, &mut m.cpu.flags);
    ...
    m.cpu.regs.edx = m.memory.read::<u32>(m.cpu.regs.ecx);
    // 00404646 add ecx,4
    m.cpu.regs.ecx = add(m.cpu.regs.ecx, 0x4u32, &mut m.cpu.flags);
...
pub fn x00404654(m: &mut Machine) -> Cont {
    // 00404654 test dh,dh
    and(m.cpu.regs.get_dh(), m.cpu.regs.get_dh(), &mut m.cpu.flags);
...
pub fn x00404658(m: &mut Machine) -> Cont {
    ...
    and(m.cpu.regs.edx, 0xff0000u32, &mut m.cpu.flags);
...
pub fn x00404660(m: &mut Machine) -> Cont {
    ...
    and(m.cpu.regs.edx, 0xff000000u32, &mut m.cpu.flags);
...
pub fn x00404672(m: &mut Machine) -> Cont {
    // 00404672 mov [edi],dx
    m.memory.write::<u16>(m.cpu.regs.edi, m.cpu.regs.get_dx());
    // 00404675 mov eax,[esp+8]
    m.cpu.regs.eax = m.memory.read::<u32>(m.cpu.regs.esp.wrapping_add(0x8u32));
    // 00404679 mov byte ptr [edi+2],0
    m.memory
        .write::<u8>(m.cpu.regs.edi.wrapping_add(0x2u32), 0x0u8);
    // 0040467d pop edi
    m.cpu.regs.edi = pop(m);
    // 0040467e ret
    ret(m, 0)
...
pub fn x004046ab(m: &mut Machine) -> Cont {
    // 004046ab add eax,0
    m.cpu.regs.eax = add(m.cpu.regs.eax, 0x0u32, &mut m.cpu.flags);
...
pub fn x004046e3(m: &mut Machine) -> Cont {
    ...
    m.cpu.regs.eax = m.cpu.regs.ecx.wrapping_add(0xffffffffu32);
...
pub fn x004046ed(m: &mut Machine) -> Cont {
    ...
    m.cpu.regs.eax = m.cpu.regs.ecx.wrapping_add(0xfffffffeu32);
...
pub fn x004046f7(m: &mut Machine) -> Cont {
    ...
    m.cpu.regs.eax = m.cpu.regs.ecx.wrapping_add(0xfffffffdu32);
...
pub fn x00404701(m: &mut Machine) -> Cont {
    ...
    m.cpu.regs.eax = m.cpu.regs.ecx.wrapping_add(0xfffffffcu32);
...
pub fn x00404722(m: &mut Machine) -> Cont {
    ...
    m.cpu.regs.edi = m.memory.read::<u32>(m.cpu.regs.ebp.wrapping_add(0x8u32));
    // 00404732 mov bl,[edi]
    m.cpu.regs.set_bl(m.memory.read::<u8>(m.cpu.regs.edi));
    // 00404734 lea esi,[edi+1]
    m.cpu.regs.esi = m.cpu.regs.edi.wrapping_add(0x1u32);
    // 00404737 mov [ebp-4],esi
    m.memory
        .write::<u32>(m.cpu.regs.ebp.wrapping_add(0xfffffffcu32), m.cpu.regs.esi);
    // 0040473a cmp dword ptr ds:[40953Ch],1
    sub(m.memory.read::<u32>(0x40953cu32), 0x1u32, &mut m.cpu.flags);
...
pub fn x00404743(m: &mut Machine) -> Cont {
    ...
    m.cpu.regs.eax = m.cpu.regs.get_bl() as _;
    // 00404746 push 8
    push(m, 0x8u32);
    // 00404748 push eax
    push(m, m.cpu.regs.eax);
...
pub fn x00404752(m: &mut Machine) -> Cont {
    ...
    m.cpu.regs.ecx = m.memory.read::<u32>(0x409330u32);
    // 00404758 movzx eax,bl
    m.cpu.regs.eax = m.cpu.regs.get_bl() as _;
    // 0040475b mov al,[ecx+eax*2]
    m.cpu.regs.set_al(
        m.memory
            .read::<u8>(m.cpu.regs.ecx.wrapping_add((m.cpu.regs.eax * 2))),
    );
    // 0040475e and eax,8
    m.cpu.regs.eax = and(m.cpu.regs.eax, 0x8u32, &mut m.cpu.flags);
...
pub fn x00404765(m: &mut Machine) -> Cont {
    // 00404765 mov bl,[esi]
    m.cpu.regs.set_bl(m.memory.read::<u8>(m.cpu.regs.esi));
    // 00404767 inc esi
    m.cpu.regs.esi = inc(m.cpu.regs.esi, &mut m.cpu.flags);
...
pub fn x0040476a(m: &mut Machine) -> Cont {
    // 0040476a cmp bl,2Dh
    sub(m.cpu.regs.get_bl(), 0x2du8, &mut m.cpu.flags);
...
pub fn x00404772(m: &mut Machine) -> Cont {
    ...
    m.memory.write::<u32>(
        m.cpu.regs.ebp.wrapping_add(0x14u32),
        or(
            m.memory.read::<u32>(m.cpu.regs.ebp.wrapping_add(0x14u32)),
            0x2u32,
            &mut m.cpu.flags,
...
pub fn x00404778(m: &mut Machine) -> Cont {
    // 00404778 cmp bl,2Bh
    sub(m.cpu.regs.get_bl(), 0x2bu8, &mut m.cpu.flags);
...
pub fn x00404797(m: &mut Machine) -> Cont {
    ...
    sub(m.cpu.regs.eax, 0x24u32, &mut m.cpu.flags);
...
pub fn x004047a7(m: &mut Machine) -> Cont {
    // 004047a7 cmp bl,30h
    sub(m.cpu.regs.get_bl(), 0x30u8, &mut m.cpu.flags);
...
pub fn x004047ac(m: &mut Machine) -> Cont {
    ...
    m.memory
        .write::<u32>(m.cpu.regs.ebp.wrapping_add(0x10u32), 0xau32);
...
pub fn x004047b5(m: &mut Machine) -> Cont {
    ...
    m.cpu.regs.set_al(m.memory.read::<u8>(m.cpu.regs.esi));
    // 004047b7 cmp al,78h
    sub(m.cpu.regs.get_al(), 0x78u8, &mut m.cpu.flags);
...
pub fn x004047bb(m: &mut Machine) -> Cont {
    // 004047bb cmp al,58h
    sub(m.cpu.regs.get_al(), 0x58u8, &mut m.cpu.flags);
...
pub fn x004047bf(m: &mut Machine) -> Cont {
    ...
    m.memory
        .write::<u32>(m.cpu.regs.ebp.wrapping_add(0x10u32), 0x8u32);
...
pub fn x004047df(m: &mut Machine) -> Cont {
    ...
    m.cpu
        .regs
        .set_bl(m.memory.read::<u8>(m.cpu.regs.esi.wrapping_add(0x1u32)));
    // 004047e2 inc esi
    m.cpu.regs.esi = inc(m.cpu.regs.esi, &mut m.cpu.flags);
    // 004047e3 inc esi
    m.cpu.regs.esi = inc(m.cpu.regs.esi, &mut m.cpu.flags);
    ...
    m.cpu.regs.edi = 0x103u32;
    // 004047f4 mov [ebp-0Ch],eax
    m.memory
        .write::<u32>(m.cpu.regs.ebp.wrapping_add(0xfffffff4u32), m.cpu.regs.eax);
...
pub fn x0040480f(m: &mut Machine) -> Cont {
    ...
    m.cpu.regs.eax = m.memory.read::<u32>(0x409330u32);
    // 00404814 mov al,[eax+esi*2]
    m.cpu.regs.set_al(
        m.memory
            .read::<u8>(m.cpu.regs.eax.wrapping_add((m.cpu.regs.esi * 2))),
    );
    // 00404817 and eax,4
    m.cpu.regs.eax = and(m.cpu.regs.eax, 0x4u32, &mut m.cpu.flags);
...
pub fn x0040481e(m: &mut Machine) -> Cont {
    ...
    m.cpu.regs.ecx = m.cpu.regs.get_bl() as i8 as i32 as u32;
    // 00404821 sub ecx,30h
    m.cpu.regs.ecx = sub(m.cpu.regs.ecx, 0x30u32, &mut m.cpu.flags);
...
pub fn x0040483a(m: &mut Machine) -> Cont {
    ...
    m.cpu.regs.set_ax(
        m.memory
            .read::<u16>(m.cpu.regs.eax.wrapping_add((m.cpu.regs.esi * 2))),
    );
    // 00404843 and eax,edi
    m.cpu.regs.eax = and(m.cpu.regs.eax, m.cpu.regs.edi, &mut m.cpu.flags);
...
pub fn x00404849(m: &mut Machine) -> Cont {
    ...
    m.cpu.regs.eax = m.cpu.regs.get_bl() as i8 as i32 as u32;
    // 0040484c push eax
    push(m, m.cpu.regs.eax);
...
pub fn x00404852(m: &mut Machine) -> Cont {
    ...
    m.cpu.regs.ecx = sub(m.cpu.regs.ecx, 0x37u32, &mut m.cpu.flags);
...
pub fn x0040487d(m: &mut Machine) -> Cont {
    ...
    m.cpu.regs.esi = imul(
        m.cpu.regs.esi as i32,
        m.memory.read::<u32>(m.cpu.regs.ebp.wrapping_add(0x10u32)) as i32,
        &mut m.cpu.flags,
    ) as u32;
    // 00404881 add esi,ecx
    m.cpu.regs.esi = add(m.cpu.regs.esi, m.cpu.regs.ecx, &mut m.cpu.flags);
    // 00404883 mov [ebp-8],esi
    m.memory
        .write::<u32>(m.cpu.regs.ebp.wrapping_add(0xfffffff8u32), m.cpu.regs.esi);
...
pub fn x00404893(m: &mut Machine) -> Cont {
    ...
    m.cpu.regs.ecx = m.memory.read::<u32>(m.cpu.regs.ebp.wrapping_add(0x14u32));
...
pub fn x004048b1(m: &mut Machine) -> Cont {
    // 004048b1 test cl,4
    and(m.cpu.regs.get_cl(), 0x4u8, &mut m.cpu.flags);
    // 004048b4 mov eax,7FFFFFFFh
    m.cpu.regs.eax = 0x7fffffffu32;
...
pub fn x004048c0(m: &mut Machine) -> Cont {
    // 004048c0 and ecx,2
    m.cpu.regs.ecx = and(m.cpu.regs.ecx, 0x2u32, &mut m.cpu.flags);
...
pub fn x004048d7(m: &mut Machine) -> Cont {
    ...
    and(
        m.memory.read::<u8>(m.cpu.regs.ebp.wrapping_add(0x14u32)),
        0x1u8,
        &mut m.cpu.flags,
    );
    // 004048db mov dword ptr ds:[4095A8h],22h
    m.memory.write::<u32>(0x4095a8u32, 0x22u32);
...
pub fn x004048ed(m: &mut Machine) -> Cont {
    ...
    m.cpu
        .regs
        .set_cl(and(m.cpu.regs.get_cl(), 0x2u8, &mut m.cpu.flags));
    // 004048f3 neg cl
    m.cpu
        .regs
        .set_cl(neg(m.cpu.regs.get_cl(), &mut m.cpu.flags));
    // 004048f5 sbb ecx,ecx
    m.cpu.regs.ecx = sbb(m.cpu.regs.ecx, m.cpu.regs.ecx, &mut m.cpu.flags);
    // 004048f7 neg ecx
    m.cpu.regs.ecx = neg(m.cpu.regs.ecx, &mut m.cpu.flags);
...
pub fn x00404902(m: &mut Machine) -> Cont {
    ...
    m.memory.write::<u32>(m.cpu.regs.edx, m.cpu.regs.eax);
...
pub fn x0040491a(m: &mut Machine) -> Cont {
    ...
    m.cpu.regs.eax = m.memory.read::<u32>(m.cpu.regs.ebp.wrapping_add(0xcu32));
...
pub fn x00404921(m: &mut Machine) -> Cont {
    ...
    m.memory.write::<u32>(m.cpu.regs.eax, m.cpu.regs.edi);
...
pub fn x00404930(m: &mut Machine) -> Cont {
    ...
    m.cpu.regs.eax = m.cpu.regs.edx.wrapping_add(0xffffffffu32);
    // 00404933 pop ebx
    m.cpu.regs.ebx = pop(m);
    // 00404934 ret
    ret(m, 0)
...
pub fn x00404940(m: &mut Machine) -> Cont {
    ...
    m.cpu
        .regs
        .set_al(m.memory.read::<u8>(m.cpu.regs.esp.wrapping_add(0x8u32)));
    // 00404946 push ebx
    push(m, m.cpu.regs.ebx);
    // 00404947 mov ebx,eax
    m.cpu.regs.ebx = m.cpu.regs.eax;
    // 00404949 shl eax,8
    m.cpu.regs.eax = shl(m.cpu.regs.eax, 0x8u8, &mut m.cpu.flags);
    // 0040494c mov edx,[esp+8]
    m.cpu.regs.edx = m.memory.read::<u32>(m.cpu.regs.esp.wrapping_add(0x8u32));
    // 00404950 test edx,3
    and(m.cpu.regs.edx, 0x3u32, &mut m.cpu.flags);
...
pub fn x00404958(m: &mut Machine) -> Cont {
    // 00404958 mov cl,[edx]
    m.cpu.regs.set_cl(m.memory.read::<u8>(m.cpu.regs.edx));
    // 0040495a inc edx
    m.cpu.regs.edx = inc(m.cpu.regs.edx, &mut m.cpu.flags);
    // 0040495b cmp cl,bl
    sub(m.cpu.regs.get_cl(), m.cpu.regs.get_bl(), &mut m.cpu.flags);
...
pub fn x0040495f(m: &mut Machine) -> Cont {
    // 0040495f test cl,cl
    and(m.cpu.regs.get_cl(), m.cpu.regs.get_cl(), &mut m.cpu.flags);
...
pub fn x0040496b(m: &mut Machine) -> Cont {
    // 0040496b or ebx,eax
    m.cpu.regs.ebx = or(m.cpu.regs.ebx, m.cpu.regs.eax, &mut m.cpu.flags);
    // 0040496d push edi
    push(m, m.cpu.regs.edi);
    // 0040496e mov eax,ebx
    m.cpu.regs.eax = m.cpu.regs.ebx;
    // 00404970 shl ebx,10h
    m.cpu.regs.ebx = shl(m.cpu.regs.ebx, 0x10u8, &mut m.cpu.flags);
    // 00404973 push esi
    push(m, m.cpu.regs.esi);
    // 00404974 or ebx,eax
    m.cpu.regs.ebx = or(m.cpu.regs.ebx, m.cpu.regs.eax, &mut m.cpu.flags);
    ...
    m.cpu.regs.edi = 0x7efefeffu32;
    // 0040497d mov eax,ecx
    m.cpu.regs.eax = m.cpu.regs.ecx;
    // 0040497f mov esi,edi
    m.cpu.regs.esi = m.cpu.regs.edi;
    // 00404981 xor ecx,ebx
    m.cpu.regs.ecx = xor(m.cpu.regs.ecx, m.cpu.regs.ebx, &mut m.cpu.flags);
    // 00404983 add esi,eax
    m.cpu.regs.esi = add(m.cpu.regs.esi, m.cpu.regs.eax, &mut m.cpu.flags);
    // 00404985 add edi,ecx
    m.cpu.regs.edi = add(m.cpu.regs.edi, m.cpu.regs.ecx, &mut m.cpu.flags);
    // 00404987 xor ecx,0FFFFFFFFh
    m.cpu.regs.ecx = xor(m.cpu.regs.ecx, 0xffffffffu32, &mut m.cpu.flags);
    // 0040498a xor eax,0FFFFFFFFh
    m.cpu.regs.eax = xor(m.cpu.regs.eax, 0xffffffffu32, &mut m.cpu.flags);
    // 0040498d xor ecx,edi
    m.cpu.regs.ecx = xor(m.cpu.regs.ecx, m.cpu.regs.edi, &mut m.cpu.flags);
    // 0040498f xor eax,esi
    m.cpu.regs.eax = xor(m.cpu.regs.eax, m.cpu.regs.esi, &mut m.cpu.flags);
    // 00404991 add edx,4
    m.cpu.regs.edx = add(m.cpu.regs.edx, 0x4u32, &mut m.cpu.flags);
    // 00404994 and ecx,81010100h
    m.cpu.regs.ecx = and(m.cpu.regs.ecx, 0x81010100u32, &mut m.cpu.flags);
...
pub fn x0040499c(m: &mut Machine) -> Cont {
    ...
    m.cpu.regs.eax = and(m.cpu.regs.eax, 0x81010100u32, &mut m.cpu.flags);
...
pub fn x004049a3(m: &mut Machine) -> Cont {
    ...
    m.cpu.regs.eax = and(m.cpu.regs.eax, 0x1010100u32, &mut m.cpu.flags);
...
pub fn x004049aa(m: &mut Machine) -> Cont {
    ...
    m.cpu.regs.esi = and(m.cpu.regs.esi, 0x80000000u32, &mut m.cpu.flags);
...
pub fn x004049b8(m: &mut Machine) -> Cont {
    ...
    m.cpu.regs.eax = m
        .memory
        .read::<u32>(m.cpu.regs.edx.wrapping_add(0xfffffffcu32));
    // 004049bb cmp al,bl
    sub(m.cpu.regs.get_al(), m.cpu.regs.get_bl(), &mut m.cpu.flags);
...
pub fn x004049c3(m: &mut Machine) -> Cont {
    // 004049c3 cmp ah,bl
    sub(m.cpu.regs.get_ah(), m.cpu.regs.get_bl(), &mut m.cpu.flags);
...
pub fn x004049e7(m: &mut Machine) -> Cont {
    ...
    m.cpu.regs.eax = m.cpu.regs.edx.wrapping_add(0xfffffffeu32);
    // 004049ea pop esi
    m.cpu.regs.esi = pop(m);
    // 004049eb pop edi
    m.cpu.regs.edi = pop(m);
...
pub fn x004049ee(m: &mut Machine) -> Cont {
    ...
    m.cpu.regs.eax = m.cpu.regs.edx.wrapping_add(0xfffffffdu32);
    // 004049f1 pop esi
    m.cpu.regs.esi = pop(m);
    // 004049f2 pop edi
    m.cpu.regs.edi = pop(m);
...
pub fn x004049f5(m: &mut Machine) -> Cont {
    ...
    m.cpu.regs.eax = m.cpu.regs.edx.wrapping_add(0xfffffffcu32);
    // 004049f8 pop esi
    m.cpu.regs.esi = pop(m);
    // 004049f9 pop edi
    m.cpu.regs.edi = pop(m);
...
pub fn x00404a00(m: &mut Machine) -> Cont {
    ...
    m.cpu.regs.edi = m.memory.read::<u32>(m.cpu.regs.esp.wrapping_add(0x10u32));
    // 00404a0d test dl,dl
    and(m.cpu.regs.get_dl(), m.cpu.regs.get_dl(), &mut m.cpu.flags);
...
pub fn x00404a11(m: &mut Machine) -> Cont {
    ...
    m.cpu
        .regs
        .set_dh(m.memory.read::<u8>(m.cpu.regs.ecx.wrapping_add(0x1u32)));
    // 00404a14 test dh,dh
    and(m.cpu.regs.get_dh(), m.cpu.regs.get_dh(), &mut m.cpu.flags);
...
pub fn x00404a18(m: &mut Machine) -> Cont {
    ...
    m.cpu.regs.ecx = m.memory.read::<u32>(m.cpu.regs.esp.wrapping_add(0x14u32));
    // 00404a1e mov al,[edi]
    m.cpu.regs.set_al(m.memory.read::<u8>(m.cpu.regs.edi));
    // 00404a20 inc esi
    m.cpu.regs.esi = inc(m.cpu.regs.esi, &mut m.cpu.flags);
    // 00404a21 cmp al,dl
    sub(m.cpu.regs.get_al(), m.cpu.regs.get_dl(), &mut m.cpu.flags);
...
pub fn x00404a3a(m: &mut Machine) -> Cont {
    ...
    m.cpu.regs.esi = inc(m.cpu.regs.esi, &mut m.cpu.flags);
    // 00404a3d cmp al,dh
    sub(m.cpu.regs.get_al(), m.cpu.regs.get_dh(), &mut m.cpu.flags);
...
pub fn x00404a41(m: &mut Machine) -> Cont {
    ...
    m.cpu.regs.edi = m.cpu.regs.esi.wrapping_add(0xffffffffu32);
    // 00404a44 mov ah,[ecx+2]
    m.cpu
        .regs
        .set_ah(m.memory.read::<u8>(m.cpu.regs.ecx.wrapping_add(0x2u32)));
    // 00404a47 test ah,ah
    and(m.cpu.regs.get_ah(), m.cpu.regs.get_ah(), &mut m.cpu.flags);
...
pub fn x00404a4b(m: &mut Machine) -> Cont {
    ...
    m.cpu.regs.set_al(m.memory.read::<u8>(m.cpu.regs.esi));
    // 00404a4d add esi,2
    m.cpu.regs.esi = add(m.cpu.regs.esi, 0x2u32, &mut m.cpu.flags);
    // 00404a50 cmp al,ah
    sub(m.cpu.regs.get_al(), m.cpu.regs.get_ah(), &mut m.cpu.flags);
...
pub fn x00404a54(m: &mut Machine) -> Cont {
    ...
    m.cpu
        .regs
        .set_al(m.memory.read::<u8>(m.cpu.regs.ecx.wrapping_add(0x3u32)));
    // 00404a57 test al,al
    and(m.cpu.regs.get_al(), m.cpu.regs.get_al(), &mut m.cpu.flags);
...
pub fn x00404a5b(m: &mut Machine) -> Cont {
    ...
    // 00404a5e add ecx,2
    m.cpu.regs.ecx = add(m.cpu.regs.ecx, 0x2u32, &mut m.cpu.flags);
    // 00404a61 cmp al,ah
    sub(m.cpu.regs.get_al(), m.cpu.regs.get_ah(), &mut m.cpu.flags);
...
pub fn x00404a67(m: &mut Machine) -> Cont {
    ...
    m.cpu.regs.edi = pop(m);
    // 00404a6c mov al,dl
    m.cpu.regs.set_al(m.cpu.regs.get_dl());
...
pub fn x00404a73(m: &mut Machine) -> Cont {
    ...
    m.cpu.regs.eax = m.cpu.regs.edi.wrapping_add(0xffffffffu32);
    // 00404a76 pop esi
    m.cpu.regs.esi = pop(m);
    // 00404a77 pop ebx
    m.cpu.regs.ebx = pop(m);
...
pub fn x00404a8b(m: &mut Machine) -> Cont {
    ...
    m.cpu.regs.ecx = add(m.cpu.regs.ecx, m.cpu.regs.ebx, &mut m.cpu.flags);
    ...
    sub(
        m.cpu.regs.get_al(),
        m.memory
            .read::<u8>(m.cpu.regs.edi.wrapping_add(0xffffffffu32)),
        &mut m.cpu.flags,
    );
...
pub fn x00404ac0(m: &mut Machine) -> Cont {
    ...
    sub(m.cpu.regs.eax, 0x1000u32, &mut m.cpu.flags);
    // 00404ac6 lea ecx,[esp+8]
    m.cpu.regs.ecx = m.cpu.regs.esp.wrapping_add(0x8u32);
...
pub fn x00404acc(m: &mut Machine) -> Cont {
    ...
    m.cpu.regs.ecx = sub(m.cpu.regs.ecx, 0x1000u32, &mut m.cpu.flags);
    // 00404ad2 sub eax,1000h
    m.cpu.regs.eax = sub(m.cpu.regs.eax, 0x1000u32, &mut m.cpu.flags);
...
pub fn x00404ae0(m: &mut Machine) -> Cont {
    ...
    m.cpu.regs.esp = m.cpu.regs.ecx;
    // 00404ae8 mov ecx,[eax]
    m.cpu.regs.ecx = m.memory.read::<u32>(m.cpu.regs.eax);
    // 00404aea mov eax,[eax+4]
    m.cpu.regs.eax = m.memory.read::<u32>(m.cpu.regs.eax.wrapping_add(0x4u32));
    // 00404aed push eax
    push(m, m.cpu.regs.eax);
    // 00404aee ret
    ret(m, 0)
...
pub fn x00404b0d(m: &mut Machine) -> Cont {
    ...
    m.cpu.regs.esi = m.memory.read::<u32>(0x40604cu32);
...
pub fn x00404b1b(m: &mut Machine) -> Cont {
    ...
    m.memory.write::<u32>(0x409714u32, m.cpu.regs.eax);
...
pub fn x00404b2c(m: &mut Machine) -> Cont {
    ...
    m.memory.write::<u32>(0x409718u32, m.cpu.regs.eax);
    // 00404b37 call esi
    let dst = indirect(m, m.cpu.regs.esi);
    call(m, 0x404b39, dst)
}
...
pub fn x00404b39(m: &mut Machine) -> Cont {
    ...
    m.memory.write::<u32>(0x40971cu32, m.cpu.regs.eax);
    // 00404b3e mov eax,ds:[409718h]
    m.cpu.regs.eax = m.memory.read::<u32>(0x409718u32);
...
pub fn x00404b4f(m: &mut Machine) -> Cont {
    ...
    m.cpu.regs.eax = m.memory.read::<u32>(0x40971cu32);
...
pub fn x00404b5b(m: &mut Machine) -> Cont {
    ...
    push(
        m,
        m.memory.read::<u32>(m.cpu.regs.esp.wrapping_add(0x18u32)),
    );
    ...
    let dst = indirect(m, m.memory.read(0x409714u32));
    call(m, 0x404b70, dst)
}
...
pub fn x00404b89(m: &mut Machine) -> Cont {
    ...
    m.cpu.regs.esi = m.memory.read::<u32>(m.cpu.regs.esp.wrapping_add(0x14u32));
    // 00404b91 test esi,3
    and(m.cpu.regs.esi, 0x3u32, &mut m.cpu.flags);
...
pub fn x00404ba4(m: &mut Machine) -> Cont {
    ...
    m.cpu.regs.esi = inc(m.cpu.regs.esi, &mut m.cpu.flags);
    // 00404ba7 mov [edi],al
    m.memory.write::<u8>(m.cpu.regs.edi, m.cpu.regs.get_al());
    // 00404ba9 inc edi
    m.cpu.regs.edi = inc(m.cpu.regs.edi, &mut m.cpu.flags);
    // 00404baa dec ecx
    m.cpu.regs.ecx = dec(m.cpu.regs.ecx, &mut m.cpu.flags);
...
pub fn x00404bc0(m: &mut Machine) -> Cont {
    // 00404bc0 and ebx,3
    m.cpu.regs.ebx = and(m.cpu.regs.ebx, 0x3u32, &mut m.cpu.flags);
...
pub fn x00404bd2(m: &mut Machine) -> Cont {
    ...
    m.cpu.regs.eax = m.memory.read::<u32>(m.cpu.regs.esp.wrapping_add(0x10u32));
    // 00404bd6 pop ebx
    m.cpu.regs.ebx = pop(m);
    // 00404bd7 pop esi
    m.cpu.regs.esi = pop(m);
...
pub fn x00404c11(m: &mut Machine) -> Cont {
    ...
    m.cpu.regs.edx = m.memory.read::<u32>(m.cpu.regs.esi);
    // 00404c21 add esi,4
    m.cpu.regs.esi = add(m.cpu.regs.esi, 0x4u32, &mut m.cpu.flags);
...
pub fn x00404c47(m: &mut Machine) -> Cont {
    ...
    m.cpu.regs.edx = and(m.cpu.regs.edx, 0xffffu32, &mut m.cpu.flags);
...
pub fn x00404c51(m: &mut Machine) -> Cont {
    ...
    m.cpu.regs.edx = and(m.cpu.regs.edx, 0xffu32, &mut m.cpu.flags);
...
pub fn x00404cb3(m: &mut Machine) -> Cont {
    ...
    indirect(
        m,
        m.memory
            .read((m.cpu.regs.edx * 4).wrapping_add(0x404dc8u32)),
    )
}
...
pub fn x00404cc8(m: &mut Machine) -> Cont {
    ...
    indirect(
        m,
        m.memory
            .read((m.cpu.regs.eax * 4).wrapping_add(0x404ce0u32)),
    )
}
...
pub fn x00404cd4(m: &mut Machine) -> Cont {
    ...
    indirect(
        m,
        m.memory
            .read((m.cpu.regs.ecx * 4).wrapping_add(0x404dd8u32)),
    )
}
...
pub fn x00404cdc(m: &mut Machine) -> Cont {
    ...
    indirect(
        m,
        m.memory
            .read((m.cpu.regs.ecx * 4).wrapping_add(0x404d5cu32)),
    )
}
...
pub fn x00404e33(m: &mut Machine) -> Cont {
    ...
    indirect(
        m,
        m.memory
            .read((m.cpu.regs.edx * 4).wrapping_add(0x404f60u32)),
    )
}
...
pub fn x00404e40(m: &mut Machine) -> Cont {
    ...
    indirect(
        m,
        m.memory
            .read((m.cpu.regs.ecx * 4).wrapping_add(0x404f10u32)),
    )
}
...
pub fn x00404e58(m: &mut Machine) -> Cont {
    ...
    indirect(
        m,
        m.memory
            .read((m.cpu.regs.eax * 4).wrapping_add(0x404e68u32)),
    )
}
...
pub fn x00404e64(m: &mut Machine) -> Cont {
    ...
    indirect(
        m,
        m.memory
            .read((m.cpu.regs.ecx * 4).wrapping_add(0x404f60u32)),
    )
}
...
pub fn x00404fc0(m: &mut Machine) -> Cont {
    ...
    m.cpu.regs.edx = m.memory.read::<u32>(m.cpu.regs.esp.wrapping_add(0xcu32));
...
pub fn x00404fcc(m: &mut Machine) -> Cont {
    ...
    m.cpu.regs.edi = m.cpu.regs.ecx;
    // 00404fd5 cmp edx,4
    sub(m.cpu.regs.edx, 0x4u32, &mut m.cpu.flags);
...
pub fn x00404fe9(m: &mut Machine) -> Cont {
    ...
    m.cpu.regs.eax = shl(m.cpu.regs.eax, 0x10u8, &mut m.cpu.flags);
...
pub fn x00405064(m: &mut Machine) -> Cont {
    ...
    m.memory.write::<u32>(0x409740u32, m.cpu.regs.ebx);
...
pub fn x0040509e(m: &mut Machine) -> Cont {
    ...
    m.memory
        .write::<u32>(m.cpu.regs.ebp.wrapping_add(0x14u32), m.cpu.regs.eax);
    // 004050a3 mov eax,ds:[409740h]
    m.cpu.regs.eax = m.memory.read::<u32>(0x409740u32);
    // 004050a8 cmp eax,2
    sub(m.cpu.regs.eax, 0x2u32, &mut m.cpu.flags);
...
pub fn x004050ad(m: &mut Machine) -> Cont {
    ...
    push(
        m,
        m.memory.read::<u32>(m.cpu.regs.ebp.wrapping_add(0x1cu32)),
    );
...
pub fn x004050d3(m: &mut Machine) -> Cont {
    ...
    sub(
        m.memory.read::<u32>(m.cpu.regs.ebp.wrapping_add(0x20u32)),
        m.cpu.regs.edi,
        &mut m.cpu.flags,
    );
...
pub fn x004050d8(m: &mut Machine) -> Cont {
    ...
    m.memory
        .write::<u32>(m.cpu.regs.ebp.wrapping_add(0x20u32), m.cpu.regs.eax);
    // 004050e0 push edi
    push(m, m.cpu.regs.edi);
    // 004050e1 push edi
    push(m, m.cpu.regs.edi);
    ...
    m.cpu.regs.eax = m.memory.read::<u32>(m.cpu.regs.ebp.wrapping_add(0x24u32));
    // 004050eb neg eax
    m.cpu.regs.eax = neg(m.cpu.regs.eax, &mut m.cpu.flags);
...
pub fn x004050fd(m: &mut Machine) -> Cont {
    ...
    m.memory
        .write::<u32>(m.cpu.regs.ebp.wrapping_add(0xffffffe4u32), m.cpu.regs.ebx);
...
pub fn x0040510a(m: &mut Machine) -> Cont {
    ...
    m.cpu.regs.eax = m.cpu.regs.ebx.wrapping_add(m.cpu.regs.ebx);
    // 00405110 add eax,3
    m.cpu.regs.eax = add(m.cpu.regs.eax, 0x3u32, &mut m.cpu.flags);
    // 00405113 and al,0FCh
    m.cpu
        .regs
        .set_al(and(m.cpu.regs.get_al(), 0xfcu8, &mut m.cpu.flags));
...
pub fn x0040511a(m: &mut Machine) -> Cont {
    ...
    m.memory
        .write::<u32>(m.cpu.regs.ebp.wrapping_add(0xffffffdcu32), m.cpu.regs.eax);
...
pub fn x0040512c(m: &mut Machine) -> Cont {
    ...
    m.memory
        .write::<u32>(m.cpu.regs.ebp.wrapping_add(0xffffffdcu32), m.cpu.regs.edi);
    ...
    m.cpu.regs.ebx = m
        .memory
        .read::<u32>(m.cpu.regs.ebp.wrapping_add(0xffffffe4u32));
    // 0040513b cmp [ebp-24h],edi
    sub(
        m.memory
            .read::<u32>(m.cpu.regs.ebp.wrapping_add(0xffffffdcu32)),
        m.cpu.regs.edi,
        &mut m.cpu.flags,
    );
...
pub fn x0040516b(m: &mut Machine) -> Cont {
    ...
    m.memory
        .write::<u32>(m.cpu.regs.ebp.wrapping_add(0xffffffd8u32), m.cpu.regs.esi);
...
pub fn x00405174(m: &mut Machine) -> Cont {
    ...
    and(
        m.memory.read::<u8>(m.cpu.regs.ebp.wrapping_add(0xdu32)),
        0x4u8,
        &mut m.cpu.flags,
    );
...
pub fn x004051a6(m: &mut Machine) -> Cont {
    ...
    m.cpu.regs.esp = m.cpu.regs.ebp.wrapping_add(0xffffffc8u32);
    // 004051ab mov ecx,[ebp-10h]
    m.cpu.regs.ecx = m
        .memory
        .read::<u32>(m.cpu.regs.ebp.wrapping_add(0xfffffff0u32));
    // 004051ae mov fs:[0],ecx
    m.memory.write::<u32>(m.cpu.regs.fs_base, m.cpu.regs.ecx);
    // 004051b5 pop edi
    m.cpu.regs.edi = pop(m);
    // 004051b6 pop esi
    m.cpu.regs.esi = pop(m);
...
pub fn x004051ba(m: &mut Machine) -> Cont {
    ...
    m.cpu.regs.eax = m.cpu.regs.esi.wrapping_add(m.cpu.regs.esi);
    // 004051c4 add eax,3
    m.cpu.regs.eax = add(m.cpu.regs.eax, 0x3u32, &mut m.cpu.flags);
...
pub fn x004051ce(m: &mut Machine) -> Cont {
    ...
    m.cpu.regs.ebx = m.cpu.regs.esp;
    // 004051d3 mov [ebp-20h],ebx
    m.memory
        .write::<u32>(m.cpu.regs.ebp.wrapping_add(0xffffffe0u32), m.cpu.regs.ebx);
...
pub fn x004051e0(m: &mut Machine) -> Cont {
    ...
    m.cpu.regs.esi = m
        .memory
        .read::<u32>(m.cpu.regs.ebp.wrapping_add(0xffffffd8u32));
...
pub fn x0040523c(m: &mut Machine) -> Cont {
    ...
    m.cpu.regs.ecx = m.cpu.regs.edx.wrapping_add(0xffffffffu32);
...
pub fn x00405267(m: &mut Machine) -> Cont {
    ...
    m.cpu.regs.eax = m.memory.read::<u32>(0x409744u32);
...
pub fn x00405298(m: &mut Machine) -> Cont {
    ...
    m.cpu.regs.eax = m.cpu.regs.ebp.wrapping_add(0xffffffe4u32);
    // 0040529b push eax
    push(m, m.cpu.regs.eax);
    // 0040529c push 1
    push(m, 0x1u32);
...
pub fn x004052ce(m: &mut Machine) -> Cont {
    ...
    m.memory.write::<u32>(0x409744u32, m.cpu.regs.eax);
    // 004052d6 cmp eax,2
    sub(m.cpu.regs.eax, 0x2u32, &mut m.cpu.flags);
...
pub fn x004052db(m: &mut Machine) -> Cont {
    ...
    m.cpu.regs.eax = m.memory.read::<u32>(m.cpu.regs.ebp.wrapping_add(0x1cu32));
...
pub fn x004052e2(m: &mut Machine) -> Cont {
    ...
    m.cpu.regs.eax = m.memory.read::<u32>(0x409728u32);
...
pub fn x0040530d(m: &mut Machine) -> Cont {
    ...
    m.memory
        .write::<u32>(m.cpu.regs.ebp.wrapping_add(0x18u32), m.cpu.regs.eax);
    // 00405315 push ebx
    push(m, m.cpu.regs.ebx);
    // 00405316 push ebx
    push(m, m.cpu.regs.ebx);
    ...
    m.cpu.regs.eax = m.memory.read::<u32>(m.cpu.regs.ebp.wrapping_add(0x20u32));
    // 00405320 neg eax
    m.cpu.regs.eax = neg(m.cpu.regs.eax, &mut m.cpu.flags);
...
pub fn x00405332(m: &mut Machine) -> Cont {
    ...
    m.memory
        .write::<u32>(m.cpu.regs.ebp.wrapping_add(0xffffffe0u32), m.cpu.regs.eax);
...
pub fn x00405339(m: &mut Machine) -> Cont {
    ...
    m.cpu.regs.edi = m.cpu.regs.eax.wrapping_add(m.cpu.regs.eax);
...
pub fn x0040534b(m: &mut Machine) -> Cont {
    ...
    m.cpu.regs.esi = m.cpu.regs.esp;
    // 00405350 mov [ebp-24h],esi
    m.memory
        .write::<u32>(m.cpu.regs.ebp.wrapping_add(0xffffffdcu32), m.cpu.regs.esi);
    // 00405353 push edi
    push(m, m.cpu.regs.edi);
    // 00405354 push ebx
    push(m, m.cpu.regs.ebx);
...
pub fn x00405373(m: &mut Machine) -> Cont {
    ...
    push(
        m,
        m.memory
            .read::<u32>(m.cpu.regs.ebp.wrapping_add(0xffffffe0u32)),
    );
    // 00405376 push esi
    push(m, m.cpu.regs.esi);
...
pub fn x0040539c(m: &mut Machine) -> Cont {
    ...
    m.cpu.regs.esp = m.cpu.regs.ebp.wrapping_add(0xffffffccu32);
...
pub fn x004053b0(m: &mut Machine) -> Cont {
    ...
    sub(m.memory.read::<u32>(0x409728u32), 0x0u32, &mut m.cpu.flags);
    // 004053bb push ebx
    push(m, m.cpu.regs.ebx);
...
pub fn x004053d3(m: &mut Machine) -> Cont {
    ...
    m.cpu.regs.eax = sub(m.cpu.regs.eax, 0x20u32, &mut m.cpu.flags);
...
pub fn x004053db(m: &mut Machine) -> Cont {
    ...
    sub(m.cpu.regs.ebx, 0x100u32, &mut m.cpu.flags);
...
pub fn x004053fb(m: &mut Machine) -> Cont {
    ...
    m.cpu.regs.set_al(
        m.memory
            .read::<u8>(m.cpu.regs.eax.wrapping_add((m.cpu.regs.ebx * 2))),
    );
    // 00405403 and eax,2
    m.cpu.regs.eax = and(m.cpu.regs.eax, 0x2u32, &mut m.cpu.flags);
...
pub fn x0040540e(m: &mut Machine) -> Cont {
    ...
    m.cpu.regs.edx = m.memory.read::<u32>(0x409330u32);
    // 00405414 mov eax,ebx
    m.cpu.regs.eax = m.cpu.regs.ebx;
    // 00405416 sar eax,8
    m.cpu.regs.eax = sar(m.cpu.regs.eax, 0x8u8, &mut m.cpu.flags);
    // 00405419 movzx ecx,al
    m.cpu.regs.ecx = m.cpu.regs.get_al() as _;
...
pub fn x00405423(m: &mut Machine) -> Cont {
    ...
    m.memory.write::<u8>(
        m.cpu.regs.ebp.wrapping_add(0xau32),
        and(
            m.memory.read::<u8>(m.cpu.regs.ebp.wrapping_add(0xau32)),
            0x0u8,
            &mut m.cpu.flags,
        ),
    );
    ...
    m.memory
        .write::<u8>(m.cpu.regs.ebp.wrapping_add(0x8u32), m.cpu.regs.get_al());
    // 0040542a mov [ebp+9],bl
    m.memory
        .write::<u8>(m.cpu.regs.ebp.wrapping_add(0x9u32), m.cpu.regs.get_bl());
    // 0040542d push 2
    push(m, 0x2u32);
...
pub fn x00405431(m: &mut Machine) -> Cont {
    ...
    m.memory.write::<u8>(
        m.cpu.regs.ebp.wrapping_add(0x9u32),
        and(
            m.memory.read::<u8>(m.cpu.regs.ebp.wrapping_add(0x9u32)),
            0x0u8,
            &mut m.cpu.flags,
        ),
    );
    ...
    m.memory
        .write::<u8>(m.cpu.regs.ebp.wrapping_add(0x8u32), m.cpu.regs.get_bl());
    // 00405438 push 1
    push(m, 0x1u32);
    // 0040543a pop eax
    m.cpu.regs.eax = pop(m);
    // 0040543b lea ecx,[ebp-4]
    m.cpu.regs.ecx = m.cpu.regs.ebp.wrapping_add(0xfffffffcu32);
    // 0040543e push 1
    push(m, 0x1u32);
    // 00405440 push 0
    push(m, 0x0u32);
    ...
    push(m, m.memory.read::<u32>(0x409728u32));
...
pub fn x0040545a(m: &mut Machine) -> Cont {
    ...
    m.cpu.regs.esp = add(m.cpu.regs.esp, 0x20u32, &mut m.cpu.flags);
...
pub fn x00405466(m: &mut Machine) -> Cont {
    ...
    m.cpu.regs.eax = m
        .memory
        .read::<u8>(m.cpu.regs.ebp.wrapping_add(0xfffffffcu32)) as _;
...
pub fn x0040546c(m: &mut Machine) -> Cont {
    ...
    m.cpu.regs.eax = m
        .memory
        .read::<u8>(m.cpu.regs.ebp.wrapping_add(0xfffffffdu32)) as _;
    ...
    m.cpu.regs.eax = shl(m.cpu.regs.eax, 0x8u8, &mut m.cpu.flags);
    // 00405477 or eax,ecx
    m.cpu.regs.eax = or(m.cpu.regs.eax, m.cpu.regs.ecx, &mut m.cpu.flags);
    // 00405479 pop ebx
    m.cpu.regs.ebx = pop(m);
    // 0040547a leave
    leave(m);
...
pub fn x0040547c(m: &mut Machine) -> Cont {
    ...
    m.cpu.regs.ecx = m.cpu.regs.eax.wrapping_add(0x1u32);
    // 00405486 cmp ecx,100h
    sub(m.cpu.regs.ecx, 0x100u32, &mut m.cpu.flags);
...
pub fn x0040548e(m: &mut Machine) -> Cont {
    ...
    m.cpu.regs.eax = m
        .memory
        .read::<u16>(m.cpu.regs.ecx.wrapping_add((m.cpu.regs.eax * 2))) as _;
...
pub fn x0040549a(m: &mut Machine) -> Cont {
    ...
    m.cpu.regs.esi = m.memory.read::<u32>(0x409330u32);
    // 004054a3 sar ecx,8
    m.cpu.regs.ecx = sar(m.cpu.regs.ecx, 0x8u8, &mut m.cpu.flags);
    // 004054a6 movzx edx,cl
    m.cpu.regs.edx = m.cpu.regs.get_cl() as _;
...
pub fn x004054b1(m: &mut Machine) -> Cont {
    ...
    m.memory.write::<u8>(
        m.cpu.regs.ebp.wrapping_add(0xfffffffeu32),
        and(
            m.memory
                .read::<u8>(m.cpu.regs.ebp.wrapping_add(0xfffffffeu32)),
            0x0u8,
            &mut m.cpu.flags,
        ),
    );
    ...
    m.memory.write::<u8>(
        m.cpu.regs.ebp.wrapping_add(0xfffffffdu32),
        m.cpu.regs.get_al(),
    );
    // 004054bb push 2
    push(m, 0x2u32);
...
pub fn x004054bf(m: &mut Machine) -> Cont {
    ...
    m.memory.write::<u8>(
        ...
        and(
            m.memory
                .read::<u8>(m.cpu.regs.ebp.wrapping_add(0xfffffffdu32)),
            0x0u8,
            &mut m.cpu.flags,
        ),
    );
    ...
    m.cpu.regs.ecx = m.cpu.regs.ebp.wrapping_add(0xau32);
    // 004054cc push 1
    push(m, 0x1u32);
    // 004054ce push 0
    push(m, 0x0u32);
...
pub fn x004054e8(m: &mut Machine) -> Cont {
    ...
    m.cpu.regs.eax = m.memory.read::<u16>(m.cpu.regs.ebp.wrapping_add(0xau32)) as _;
