...
pub fn x00401040() -> Cont {
    ...
    m.regs.esp = sub(m.regs.esp, 0x1cu32);
    // 0040104b mov ds:[40957Ch],eax
    m.memory.write::<u32>(0x40957cu32, m.regs.eax);
    // 00401050 push ecx
    push(m.regs.ecx);
...
pub fn x00401056() -> Cont {
    ...
    m.memory.write::<u32>(0x409580u32, m.regs.eax);
...
pub fn x00401062() -> Cont {
    ...
    m.regs.eax = or(m.regs.eax, 0xffffffffu32);
    // 00401065 add esp,1Ch
    m.regs.esp = add(m.regs.esp, 0x1cu32);
    // 00401068 ret 10h
    ret(16)
}
...
pub fn x004010da() -> Cont {
    ...
    m.regs.edi = m.memory.read::<u32>(0x4060d0u32);
    // 004010e6 mov ebx,ds:[4060CCh]
    m.regs.ebx = m.memory.read::<u32>(0x4060ccu32);
    // 004010ec push 1
    push(0x1u32);
    // 004010ee push 0
    push(0x0u32);
    ...
    m.regs.edx = m.regs.esp.wrapping_add(0x18u32);
    // 004010f6 push 0
    push(0x0u32);
    // 004010f8 push edx
    push(m.regs.edx);
    // 004010f9 call esi
    call(0x4010fb, indirect(m.regs.esi))
}
...
pub fn x00401106() -> Cont {
    ...
    push(m.regs.eax);
    // 0040110b call edi
    call(0x40110d, indirect(m.regs.edi))
}
...
pub fn x0040110d() -> Cont {
    ...
    push(m.regs.ecx);
    // 00401112 call ebx
    call(0x401114, indirect(m.regs.ebx))
}
...
pub fn x00401130() -> Cont {
    ...
    m.regs.edi = m.memory.read::<u32>(0x406080u32);
    // 00401137 call edi
    call(0x401139, indirect(m.regs.edi))
}
...
pub fn x00401139() -> Cont {
    ...
    m.regs.eax = sub(m.regs.eax, m.memory.read::<u32>(0x409548u32));
    // 0040113f cmp eax,32h
    sub(m.regs.eax, 0x32u32);
...
pub fn x00401148() -> Cont {
    ...
    m.regs.ecx = m.memory.read::<u32>(0x409590u32);
    // 00401153 mov edx,ds:[40958Ch]
    m.regs.edx = m.memory.read::<u32>(0x40958cu32);
    // 00401159 push 8Ch
    push(0x8cu32);
    // 0040115e push 96h
    push(0x96u32);
...
pub fn x0040117a() -> Cont {
    ...
    call(
        0x401189,
        indirect(m.memory.read(m.regs.ecx.wrapping_add(0x2cu32))),
    )
}
...
pub fn x0040119d() -> Cont {
    ...
    call(
        0x4011a8,
        indirect(m.memory.read(m.regs.edx.wrapping_add(0x6cu32))),
    )
}
...
pub fn x004011a8() -> Cont {
    ...
    m.regs.eax = add(m.regs.eax, 0x96u32);
    // 004011b2 cmp eax,5DCh
    sub(m.regs.eax, 0x5dcu32);
    // 004011b7 mov ds:[409590h],eax
    m.memory.write::<u32>(0x409590u32, m.regs.eax);
...
pub fn x004011be() -> Cont {
    ...
    m.regs.eax = add(m.regs.eax, 0x8cu32);
    // 004011d2 cmp eax,118h
    sub(m.regs.eax, 0x118u32);
    // 004011d7 mov ds:[409594h],eax
    m.memory.write::<u32>(0x409594u32, m.regs.eax);
...
pub fn x004011de() -> Cont {
    ...
    // 004011e8 call edi
    call(0x4011ea, indirect(m.regs.edi))
}
...
pub fn x00401200() -> Cont {
    ...
    m.regs.esp = sub(m.regs.esp, 0x28u32);
    // 00401203 mov eax,ds:[40957Ch]
    m.regs.eax = m.memory.read::<u32>(0x40957cu32);
    // 00401208 push esi
    push(m.regs.esi);
    // 00401209 push 7F00h
    push(0x7f00u32);
    ...
    m.memory
        .write::<u32>(m.regs.esp.wrapping_add(0xcu32), 0x3u32);
    // 00401217 mov dword ptr [esp+10h],4012D0h
    m.memory
        .write::<u32>(m.regs.esp.wrapping_add(0x10u32), 0x4012d0u32);
    // 0040121f mov dword ptr [esp+14h],0
    m.memory
        .write::<u32>(m.regs.esp.wrapping_add(0x14u32), 0x0u32);
    // 00401227 mov dword ptr [esp+18h],0
    m.memory
        .write::<u32>(m.regs.esp.wrapping_add(0x18u32), 0x0u32);
    // 0040122f mov [esp+1Ch],eax
    m.memory
        .write::<u32>(m.regs.esp.wrapping_add(0x1cu32), m.regs.eax);
...
pub fn x00401256() -> Cont {
    ...
    m.regs.eax = m.regs.esp.wrapping_add(0x4u32);
    // 0040125e push eax
    push(m.regs.eax);
    // 0040125f mov dword ptr [esp+28h],409598h
    m.memory
        .write::<u32>(m.regs.esp.wrapping_add(0x28u32), 0x409598u32);
    // 00401267 mov dword ptr [esp+2Ch],4070A4h
    m.memory
        .write::<u32>(m.regs.esp.wrapping_add(0x2cu32), 0x4070a4u32);
...
pub fn x00401275() -> Cont {
    ...
    m.regs.esi = m.memory.read::<u32>(0x4060ecu32);
    // 00401281 push 0
    push(0x0u32);
    // 00401283 push ecx
    push(m.regs.ecx);
    ...
    push(0x1u32);
    // 0040128a call esi
    call(0x40128c, indirect(m.regs.esi))
}
...
pub fn x0040128c() -> Cont {
    ...
    push(0x0u32);
    // 0040128f call esi
    call(0x401291, indirect(m.regs.esi))
}
...
pub fn x004012c9() -> Cont {
    ...
    m.regs.esp = add(m.regs.esp, 0x28u32);
    // 004012cf ret
    ret(0)
}
...
pub fn x00401310() -> Cont {
    ...
    m.regs.esp = sub(m.regs.esp, 0x8cu32);
    // 00401316 push 0
    push(0x0u32);
...
pub fn x0040132d() -> Cont {
    ...
    m.regs.esp = add(m.regs.esp, 0x8cu32);
    // 00401336 ret
    ret(0)
}
...
pub fn x00401337() -> Cont {
    ...
    call(
        0x40134b,
        indirect(m.memory.read(m.regs.ecx.wrapping_add(0x50u32))),
    )
}
...
pub fn x0040135b() -> Cont {
    ...
    call(
        0x401376,
        indirect(m.memory.read(m.regs.ecx.wrapping_add(0x54u32))),
    )
}
...
pub fn x00401386() -> Cont {
    ...
    m.regs.ecx = m.regs.esp.wrapping_add(0x18u32);
    // 0040139f mov dword ptr [esp+18h],7Ch
    m.memory
        .write::<u32>(m.regs.esp.wrapping_add(0x18u32), 0x7cu32);
    // 004013a7 mov dword ptr [esp+1Ch],21h
    m.memory
        .write::<u32>(m.regs.esp.wrapping_add(0x1cu32), 0x21u32);
    // 004013af mov dword ptr [esp+80h],218h
    m.memory
        .write::<u32>(m.regs.esp.wrapping_add(0x80u32), 0x218u32);
    // 004013ba mov dword ptr [esp+2Ch],1
    m.memory
        .write::<u32>(m.regs.esp.wrapping_add(0x2cu32), 0x1u32);
...
pub fn x004013dd() -> Cont {
    ...
    m.memory.write::<u32>(m.regs.esp, m.regs.edx);
    // 004013e8 mov dword ptr [esp],4
    m.memory.write::<u32>(m.regs.esp, 0x4u32);
    // 004013f0 mov [esp+4],edx
    m.memory
        .write::<u32>(m.regs.esp.wrapping_add(0x4u32), m.regs.edx);
    // 004013f4 push 40958Ch
    push(0x40958cu32);
    // 004013f9 mov [esp+0Ch],edx
    m.memory
        .write::<u32>(m.regs.esp.wrapping_add(0xcu32), m.regs.edx);
    // 004013fd mov [esp+10h],edx
    m.memory
        .write::<u32>(m.regs.esp.wrapping_add(0x10u32), m.regs.edx);
    // 00401401 mov ecx,[eax]
    m.regs.ecx = m.memory.read::<u32>(m.regs.eax);
    // 00401403 lea edx,[esp+4]
    m.regs.edx = m.regs.esp.wrapping_add(0x4u32);
    // 00401407 push edx
    push(m.regs.edx);
    // 00401408 push eax
    push(m.regs.eax);
    ...
    call(
        0x40140c,
        indirect(m.memory.read(m.regs.ecx.wrapping_add(0x30u32))),
    )
}
...
pub fn x00401433() -> Cont {
    ...
    call(
        0x401439,
        indirect(m.memory.read(m.regs.ecx.wrapping_add(0x8u32))),
    )
}
...
pub fn x00401460() -> Cont {
    ...
    m.memory.write::<u32>(m.regs.eax, 0x406110u32);
    // 00401468 mov dword ptr [eax+28h],0
    m.memory
        .write::<u32>(m.regs.eax.wrapping_add(0x28u32), 0x0u32);
    // 0040146f mov dword ptr [eax+1Ch],0FFFFFFFFh
    m.memory
        .write::<u32>(m.regs.eax.wrapping_add(0x1cu32), 0xffffffffu32);
    // 00401476 ret
    ret(0)
}
...
pub fn x00401488() -> Cont {
    ...
    and(m.memory.read::<u8>(m.regs.esp.wrapping_add(0x8u32)), 0x1u8);
...
pub fn x004014a0() -> Cont {
    ...
    m.memory.write::<u32>(m.regs.esi, 0x406110u32);
...
pub fn x004014d0() -> Cont {
    ...
    m.regs.esp = sub(m.regs.esp, 0x98u32);
    // 004014da mov edx,[esp+9Ch]
    m.regs.edx = m.memory.read::<u32>(m.regs.esp.wrapping_add(0x9cu32));
    // 004014e1 push ebx
    push(m.regs.ebx);
    // 004014e2 mov ebx,[esp+0B0h]
    m.regs.ebx = m.memory.read::<u32>(m.regs.esp.wrapping_add(0xb0u32));
    // 004014e9 push ebp
    push(m.regs.ebp);
    // 004014ea push esi
    push(m.regs.esi);
    ...
    m.regs.ecx = m.memory.read::<u32>(m.regs.esp.wrapping_add(0xb0u32));
    // 004014f5 push 0
    push(0x0u32);
    // 004014f7 push eax
    push(m.regs.eax);
    ...
    m.regs.ecx = and(m.regs.ecx, 0xffffu32);
    // 004014ff push 0
    push(0x0u32);
    // 00401501 push ecx
    push(m.regs.ecx);
...
pub fn x0040151e() -> Cont {
    ...
    call(
        0x401524,
        indirect(m.memory.read(m.regs.ecx.wrapping_add(0x6cu32))),
    )
}
...
pub fn x0040155f() -> Cont {
    ...
    m.memory
        .write::<u32>(m.regs.esp.wrapping_add(0xc0u32), m.regs.eax);
    // 0040156a mov eax,[esi+28h]
    m.regs.eax = m.memory.read::<u32>(m.regs.esi.wrapping_add(0x28u32));
    // 0040156d lea edx,[esp+2Ch]
    m.regs.edx = m.regs.esp.wrapping_add(0x2cu32);
    // 00401571 mov dword ptr [esp+2Ch],7Ch
    m.memory
        .write::<u32>(m.regs.esp.wrapping_add(0x2cu32), 0x7cu32);
    // 00401579 mov dword ptr [esp+30h],6
    m.memory
        .write::<u32>(m.regs.esp.wrapping_add(0x30u32), 0x6u32);
    ...
    call(
        0x401588,
        indirect(m.memory.read(m.regs.ecx.wrapping_add(0x58u32))),
    )
}
...
pub fn x00401588() -> Cont {
    ...
    m.regs.edx = m.regs.esp.wrapping_add(0x10u32);
    // 0040158f push edx
    push(m.regs.edx);
    // 00401590 push eax
    push(m.regs.eax);
    ...
    call(
        0x401596,
        indirect(m.memory.read(m.regs.ecx.wrapping_add(0x44u32))),
    )
}
...
pub fn x004015a1() -> Cont {
    ...
    m.regs.ecx = m.memory.read::<u32>(m.regs.esp.wrapping_add(0xb4u32));
    // 004015af mov edx,[esp+34h]
    m.regs.edx = m.memory.read::<u32>(m.regs.esp.wrapping_add(0x34u32));
    // 004015b3 push 0CC0020h
    push(0xcc0020u32);
    // 004015b8 push eax
    push(m.regs.eax);
    // 004015b9 mov eax,[esp+40h]
    m.regs.eax = m.memory.read::<u32>(m.regs.esp.wrapping_add(0x40u32));
    // 004015bd push ebx
    push(m.regs.ebx);
    // 004015be push ebp
    push(m.regs.ebp);
    ...
    m.regs.ecx = m.memory.read::<u32>(m.regs.esp.wrapping_add(0x24u32));
    // 004015c4 push edi
    push(m.regs.edi);
    // 004015c5 push edx
    push(m.regs.edx);
...
pub fn x004015d2() -> Cont {
    ...
    call(
        0x4015e0,
        indirect(m.memory.read(m.regs.edx.wrapping_add(0x68u32))),
    )
}
...
pub fn x004015e7() -> Cont {
    ...
    m.regs.eax = m.memory.read::<u32>(m.regs.esp.wrapping_add(0xb0u32));
    // 004015f5 mov ecx,[esp+0B4h]
    m.regs.ecx = m.memory.read::<u32>(m.regs.esp.wrapping_add(0xb4u32));
    // 004015fc mov [esi+4],edx
    m.memory
        .write::<u32>(m.regs.esi.wrapping_add(0x4u32), m.regs.edx);
    // 004015ff mov edx,[esp+0C0h]
    m.regs.edx = m.memory.read::<u32>(m.regs.esp.wrapping_add(0xc0u32));
    // 00401606 mov [esi+8],eax
    m.memory
        .write::<u32>(m.regs.esi.wrapping_add(0x8u32), m.regs.eax);
    // 00401609 mov [esi+0Ch],ecx
    m.memory
        .write::<u32>(m.regs.esi.wrapping_add(0xcu32), m.regs.ecx);
    // 0040160c mov [esi+10h],ebp
    m.memory
        .write::<u32>(m.regs.esi.wrapping_add(0x10u32), m.regs.ebp);
    // 0040160f mov [esi+14h],ebx
    m.memory
        .write::<u32>(m.regs.esi.wrapping_add(0x14u32), m.regs.ebx);
    // 00401612 mov [esi+18h],edx
    m.memory
        .write::<u32>(m.regs.esi.wrapping_add(0x18u32), m.regs.edx);
    // 00401615 pop edi
    m.regs.edi = pop();
    // 00401616 pop esi
    m.regs.esi = pop();
    ...
    m.regs.esp = add(m.regs.esp, 0x98u32);
    // 00401624 ret 18h
    ret(24)
}
...
pub fn x00401640() -> Cont {
    ...
    m.regs.esp = sub(m.regs.esp, 0x84u32);
    // 00401646 push ebx
    push(m.regs.ebx);
    // 00401647 push ebp
    push(m.regs.ebp);
    ...
    m.regs.esi = m.memory.read::<u32>(m.regs.esp.wrapping_add(0x94u32));
    // 00401650 mov ebx,ecx
    m.regs.ebx = m.regs.ecx;
    // 00401652 push edi
    push(m.regs.edi);
    // 00401653 mov ebp,[esp+9Ch]
    m.regs.ebp = m.memory.read::<u32>(m.regs.esp.wrapping_add(0x9cu32));
    ...
    m.regs.ecx = m.memory.read::<u32>(m.regs.esi);
    // 00401670 lea edi,[ebx+28h]
    m.regs.edi = m.regs.ebx.wrapping_add(0x28u32);
    // 00401673 push 0
    push(0x0u32);
    // 00401675 lea edx,[esp+1Ch]
    m.regs.edx = m.regs.esp.wrapping_add(0x1cu32);
    // 00401679 push edi
    push(m.regs.edi);
    // 0040167a push edx
    push(m.regs.edx);
    ...
    m.memory
        .write::<u32>(m.regs.esp.wrapping_add(0x28u32), 0x7cu32);
    // 00401684 mov dword ptr [esp+2Ch],7
    m.memory
        .write::<u32>(m.regs.esp.wrapping_add(0x2cu32), 0x7u32);
    // 0040168c mov dword ptr [esp+90h],4040h
    m.memory
        .write::<u32>(m.regs.esp.wrapping_add(0x90u32), 0x4040u32);
    // 00401697 mov [esp+34h],ebp
    m.memory
        .write::<u32>(m.regs.esp.wrapping_add(0x34u32), m.regs.ebp);
    // 0040169b mov [esp+30h],eax
    m.memory
        .write::<u32>(m.regs.esp.wrapping_add(0x30u32), m.regs.eax);
    // 0040169f call dword ptr [ecx+18h]
    call(
        0x4016a2,
        indirect(m.memory.read(m.regs.ecx.wrapping_add(0x18u32))),
    )
}
...
pub fn x004016ad() -> Cont {
    ...
    m.regs.ecx = m.regs.esp.wrapping_add(0x1cu32);
    // 004016b5 push edi
    push(m.regs.edi);
    // 004016b6 push ecx
    push(m.regs.ecx);
    ...
    m.memory
        .write::<u32>(m.regs.esp.wrapping_add(0x90u32), 0x840u32);
    // 004016c3 call dword ptr [eax+18h]
    call(
        0x4016c6,
        indirect(m.memory.read(m.regs.eax.wrapping_add(0x18u32))),
    )
}
...
pub fn x004016ca() -> Cont {
    ...
    m.regs.esp = add(m.regs.esp, 0x84u32);
    // 004016d6 ret 10h
    ret(16)
}
...
pub fn x004016e5() -> Cont {
    ...
    m.memory
        .write::<u32>(m.regs.esp.wrapping_add(0x10u32), m.regs.esi);
    // 004016ef mov dword ptr [esp+14h],0
    m.memory
        .write::<u32>(m.regs.esp.wrapping_add(0x14u32), 0x0u32);
    // 004016f7 mov edx,[edi]
    m.regs.edx = m.memory.read::<u32>(m.regs.edi);
    // 004016f9 push eax
    push(m.regs.eax);
    // 004016fa push 8
    push(0x8u32);
    ...
    call(
        0x401700,
        indirect(m.memory.read(m.regs.edx.wrapping_add(0x74u32))),
    )
}
...
pub fn x00401700() -> Cont {
    ...
    m.memory
        .write::<u32>(m.regs.ebx.wrapping_add(0x1cu32), m.regs.esi);
    // 0040170a pop edi
    m.regs.edi = pop();
    // 0040170b mov [ebx+24h],ebp
    m.memory
        .write::<u32>(m.regs.ebx.wrapping_add(0x24u32), m.regs.ebp);
    // 0040170e pop esi
    m.regs.esi = pop();
    // 0040170f mov [ebx+20h],ecx
    m.memory
        .write::<u32>(m.regs.ebx.wrapping_add(0x20u32), m.regs.ecx);
    // 00401712 pop ebp
    m.regs.ebp = pop();
    // 00401713 mov eax,1
    m.regs.eax = 0x1u32;
...
pub fn x00401730() -> Cont {
    ...
    m.regs.esi = m.memory.read::<u32>(m.regs.esp.wrapping_add(0x34u32));
    // 0040173a push edi
    push(m.regs.edi);
...
pub fn x0040174c() -> Cont {
    ...
    m.regs.ecx = m.memory.read::<u32>(m.regs.esp.wrapping_add(0x34u32));
    // 00401757 mov ebx,[esp+2Ch]
    m.regs.ebx = m.memory.read::<u32>(m.regs.esp.wrapping_add(0x2cu32));
    // 0040175b mov ebp,[esp+28h]
    m.regs.ebp = m.memory.read::<u32>(m.regs.esp.wrapping_add(0x28u32));
    // 0040175f mov [esp+10h],eax
    m.memory
        .write::<u32>(m.regs.esp.wrapping_add(0x10u32), m.regs.eax);
    // 00401763 mov [esp+14h],ecx
    m.memory
        .write::<u32>(m.regs.esp.wrapping_add(0x14u32), m.regs.ecx);
    // 00401767 add eax,esi
    m.regs.eax = add(m.regs.eax, m.regs.esi);
    // 00401769 mov esi,[esp+24h]
    m.regs.esi = m.memory.read::<u32>(m.regs.esp.wrapping_add(0x24u32));
    // 0040176d add ecx,edx
    m.regs.ecx = add(m.regs.ecx, m.regs.edx);
    // 0040176f mov [esp+18h],eax
    m.memory
        .write::<u32>(m.regs.esp.wrapping_add(0x18u32), m.regs.eax);
    // 00401773 mov [esp+1Ch],ecx
    m.memory
        .write::<u32>(m.regs.esp.wrapping_add(0x1cu32), m.regs.ecx);
...
pub fn x00401784() -> Cont {
    ...
    m.regs.ecx = m.regs.esp.wrapping_add(0x14u32);
    // 0040178d push ecx
    push(m.regs.ecx);
    // 0040178e push edx
    push(m.regs.edx);
    ...
    call(
        0x401795,
        indirect(m.memory.read(m.regs.eax.wrapping_add(0x1cu32))),
    )
}
...
pub fn x004017b0() -> Cont {
    ...
    m.regs.esp = add(m.regs.esp, 0x10u32);
    // 004017b9 ret 1Ch
    ret(28)
}
...
pub fn x00401806() -> Cont {
    ...
    push(m.memory.read::<u32>(0x409ab0u32));
...
pub fn x00401831() -> Cont {
    ...
    m.regs.eax = add(m.regs.eax, 0x10u32);
    // 00401834 push eax
    push(m.regs.eax);
...
pub fn x00401840() -> Cont {
    ...
    m.regs.esp = add(m.regs.esp, 0xcu32);
...
pub fn x00401848() -> Cont {
    ...
    m.regs.ecx = sub(m.regs.ecx, m.memory.read::<u32>(0x409ab0u32));
    ...
    m.memory.write::<u32>(0x409aacu32, m.regs.ecx);
    // 00401865 mov eax,[esp+4]
    m.regs.eax = m.memory.read::<u32>(m.regs.esp.wrapping_add(0x4u32));
    // 00401869 mov [ecx],eax
    m.memory.write::<u32>(m.regs.ecx, m.regs.eax);
    // 0040186b add dword ptr ds:[409AACh],4
    m.memory
        .write::<u32>(0x409aacu32, add(m.memory.read::<u32>(0x409aacu32), 0x4u32));
    // 00401872 ret
    ret(0)
}
...
pub fn x00401873() -> Cont {
    ...
    push(m.memory.read::<u32>(m.regs.esp.wrapping_add(0x4u32)));
...
pub fn x004018a0() -> Cont {
    ...
    m.memory
        .write::<u32>(m.regs.eax, and(m.memory.read::<u32>(m.regs.eax), 0x0u32));
    // 004018a9 mov eax,ds:[409AB0h]
    m.regs.eax = m.memory.read::<u32>(0x409ab0u32);
    // 004018ae mov ds:[409AACh],eax
    m.memory.write::<u32>(0x409aacu32, m.regs.eax);
    // 004018b3 ret
    ret(0)
}
...
pub fn x004018bf() -> Cont {
    ...
    m.regs.eax = m.memory.read::<u32>(m.regs.fs_base);
    // 004018d4 push eax
    push(m.regs.eax);
    // 004018d5 mov fs:[0],esp
    m.memory.write::<u32>(m.regs.fs_base, m.regs.esp);
    // 004018dc sub esp,58h
    m.regs.esp = sub(m.regs.esp, 0x58u32);
    // 004018df push ebx
    push(m.regs.ebx);
    // 004018e0 push esi
    push(m.regs.esi);
...
pub fn x004018eb() -> Cont {
    ...
    m.regs.edx = xor(m.regs.edx, m.regs.edx);
    // 004018ed mov dl,ah
    m.regs.set_dl(m.regs.get_ah());
    // 004018ef mov ds:[4095C0h],edx
    m.memory.write::<u32>(0x4095c0u32, m.regs.edx);
...
pub fn x00401957() -> Cont {
    ...
    m.regs.eax = m.regs.ebp.wrapping_add(0xffffffa4u32);
    // 0040195d push eax
    push(m.regs.eax);
...
pub fn x00401969() -> Cont {
    ...
    and(
        m.memory.read::<u8>(m.regs.ebp.wrapping_add(0xffffffd0u32)),
        0x1u8,
    );
...
pub fn x00401978() -> Cont {
    ...
    push(m.memory.read::<u32>(m.regs.ebp.wrapping_add(0xffffff9cu32)));
    // 0040197f push esi
    push(m.regs.esi);
    // 00401980 push esi
    push(m.regs.esi);
...
pub fn x00401996() -> Cont {
    ...
    m.memory
        .write::<u32>(m.regs.ebp.wrapping_add(0xffffff98u32), m.regs.ecx);
    // 004019a0 push eax
    push(m.regs.eax);
    // 004019a1 push ecx
    push(m.regs.ecx);
...
pub fn x004019aa() -> Cont {
    ...
    push(m.memory.read::<u32>(m.regs.ebp.wrapping_add(0xffffff98u32)));
...
pub fn x004019b5() -> Cont {
    ...
    sub(m.memory.read::<u32>(0x4095a4u32), 0x1u32);
...
pub fn x004019cc() -> Cont {
    ...
    call(0x4019d7, indirect(m.memory.read(0x4070c4u32)))
}
...
pub fn x00401a5a() -> Cont {
    ...
    sub(m.regs.esi, m.memory.read::<u32>(0x409980u32));
...
pub fn x00401a81() -> Cont {
    ...
    m.regs.eax = m.memory.read::<u32>(m.regs.ebx.wrapping_add(0xfffffffcu32));
    // 00401a87 dec eax
    m.regs.eax = dec(m.regs.eax);
...
pub fn x00401aa7() -> Cont {
    ...
    m.regs.esp = add(m.regs.esp, 0x18u32);
...
pub fn x00401ab2() -> Cont {
    ...
    m.regs.esi = add(m.regs.esi, 0xfu32);
    ...
    push(m.memory.read::<u32>(0x409984u32));
...
pub fn x00401aee() -> Cont {
    ...
    m.regs.esp = add(m.regs.esp, 0x14u32);
...
pub fn x00401b1a() -> Cont {
    ...
    sub(m.memory.read::<u32>(0x40970cu32), 0x0u32);
...
pub fn x00401b83() -> Cont {
    ...
    sub(m.regs.esi, m.memory.read::<u32>(0x40922cu32));
...
pub fn x00401ca7() -> Cont {
    ...
    let m = unsafe { &mut MACHINE };
    // 00401ca7 call eax
    call(0x401ca9, indirect(m.regs.eax))
}
...
pub fn x00401ccb() -> Cont {
    ...
    push(m.memory.read::<u32>(m.regs.esp.wrapping_add(0xcu32)));
...
pub fn x00401ced() -> Cont {
    ...
    sub(m.memory.read::<u32>(0x4095f0u32), m.regs.edi);
...
pub fn x00401cf9() -> Cont {
    ...
    push(m.memory.read::<u32>(m.regs.esp.wrapping_add(0x8u32)));
...
pub fn x00401d0a() -> Cont {
    ...
    m.regs.ebx = m.memory.read::<u32>(m.regs.esp.wrapping_add(0x14u32));
    // 00401d14 mov ds:[4095ECh],edi
    m.memory.write::<u32>(0x4095ecu32, m.regs.edi);
    // 00401d1a mov ds:[4095E8h],bl
    m.memory.write::<u8>(0x4095e8u32, m.regs.get_bl());
...
pub fn x00401d2b() -> Cont {
    ...
    m.regs.esi = m.regs.ecx.wrapping_add(0xfffffffcu32);
...
pub fn x00401d3f() -> Cont {
    ...
    let m = unsafe { &mut MACHINE };
    // 00401d3f call eax
    call(0x401d41, indirect(m.regs.eax))
}
...
pub fn x00401d41() -> Cont {
    ...
    let m = unsafe { &mut MACHINE };
    // 00401d41 sub esi,4
    m.regs.esi = sub(m.regs.esi, 0x4u32);
    // 00401d44 cmp esi,ds:[409AB0h]
    sub(m.regs.esi, m.memory.read::<u32>(0x409ab0u32));
...
pub fn x00401d74() -> Cont {
    ...
    m.memory.write::<u32>(0x4095f0u32, m.regs.edi);
...
pub fn x00401d86() -> Cont {
    ...
    m.regs.esi = m.memory.read::<u32>(m.regs.esp.wrapping_add(0x8u32));
...
pub fn x00401d97() -> Cont {
    ...
    let m = unsafe { &mut MACHINE };
    // 00401d97 call eax
    call(0x401d99, indirect(m.regs.eax))
}
...
pub fn x00401dbe() -> Cont {
    ...
    // 00401dc1 sub eax,9
    m.regs.eax = sub(m.regs.eax, 0x9u32);
...
pub fn x00401e01() -> Cont {
    ...
    push(m.memory.read::<u32>(0x40970cu32));
...
pub fn x00401f56() -> Cont {
    ...
    m.memory
        .write::<u32>(m.regs.ebp.wrapping_add(0x8u32), m.regs.ecx);
    // 00401f5f mov ecx,[ebp+0Ch]
    m.regs.ecx = m.memory.read::<u32>(m.regs.ebp.wrapping_add(0xcu32));
    // 00401f62 mov ds:[4095F4h],ecx
    m.memory.write::<u32>(0x4095f4u32, m.regs.ecx);
    // 00401f68 mov ecx,[eax+4]
    m.regs.ecx = m.memory.read::<u32>(m.regs.eax.wrapping_add(0x4u32));
    // 00401f6b cmp ecx,8
...
pub fn x00401f74() -> Cont {
    ...
    m.regs.edx = m.memory.read::<u32>(0x40714cu32);
...
pub fn x00401f87() -> Cont {
    ...
    m.regs.edx = sub(m.regs.edx, m.regs.ecx);
    // 00401f8c lea esi,[esi*4+4070D8h]
    m.regs.esi = (m.regs.esi * 4).wrapping_add(0x4070d8u32);
    // 00401f93 and dword ptr [esi],0
    m.memory
        .write::<u32>(m.regs.esi, and(m.memory.read::<u32>(m.regs.esi), 0x0u32));
    // 00401f96 add esi,0Ch
    m.regs.esi = add(m.regs.esi, 0xcu32);
    // 00401f99 dec edx
...
pub fn x00401f9c() -> Cont {
    ...
    m.regs.esi = m.memory.read::<u32>(0x407154u32);
    // 00401fa4 cmp eax,0C000008Eh
    sub(m.regs.eax, 0xc000008eu32);
...
pub fn x0040201d() -> Cont {
    ...
    push(m.memory.read::<u32>(0x407154u32));
    // 0040202d push 8
    push(0x8u32);
    // 0040202f call ebx
    call(0x402031, indirect(m.regs.ebx))
}
...
pub fn x00402031() -> Cont {
    ...
    m.memory.write::<u32>(0x407154u32, m.regs.esi);
    // 00402038 pop ecx
    m.regs.ecx = pop();
    // 00402039 pop esi
    m.regs.esi = pop();
...
pub fn x0040203c() -> Cont {
    ...
    push(m.regs.ecx);
    // 00402041 call ebx
    call(0x402043, indirect(m.regs.ebx))
}
...
pub fn x00402043() -> Cont {
    ...
    m.memory.write::<u32>(0x4095f4u32, m.regs.eax);
...
pub fn x0040205d() -> Cont {
    ...
    m.regs.ecx = m.memory.read::<u32>(0x407150u32);
    // 00402067 cmp ds:[4070D0h],edx
    sub(m.memory.read::<u32>(0x4070d0u32), m.regs.edx);
    // 0040206d push esi
    push(m.regs.esi);
    // 0040206e mov eax,4070D0h
    m.regs.eax = 0x4070d0u32;
...
pub fn x00402075() -> Cont {
    ...
    m.regs.esi = (m.regs.esi * 4).wrapping_add(0x4070d0u32);
    // 0040207f add eax,0Ch
    m.regs.eax = add(m.regs.eax, 0xcu32);
...
pub fn x00402086() -> Cont {
    ...
    sub(m.memory.read::<u32>(m.regs.eax), m.regs.edx);
...
pub fn x0040208a() -> Cont {
    ...
    m.regs.ecx = (m.regs.ecx * 4).wrapping_add(0x4070d0u32);
    // 00402095 cmp eax,ecx
    sub(m.regs.eax, m.regs.ecx);
...
pub fn x004020a0() -> Cont {
    ...
    sub(m.memory.read::<u32>(0x409aa8u32), 0x0u32);
...
pub fn x004020ae() -> Cont {
    ...
    m.regs.esi = m.memory.read::<u32>(0x409ab8u32);
    // 004020b5 mov al,[esi]
    m.regs.set_al(m.memory.read::<u8>(m.regs.esi));
    // 004020b7 cmp al,22h
    sub(m.regs.get_al(), 0x22u8);
...
pub fn x004020c3() -> Cont {
    ...
    let m = unsafe { &mut MACHINE };
    // 004020c3 test al,al
    and(m.regs.get_al(), m.regs.get_al());
...
pub fn x004020d8() -> Cont {
    ...
    sub(m.memory.read::<u8>(m.regs.esi), 0x22u8);
...
pub fn x004020e4() -> Cont {
    ...
    sub(m.memory.read::<u8>(m.regs.esi), 0x20u8);
...
pub fn x004020f8() -> Cont {
    ...
    sub(m.memory.read::<u32>(0x409aa8u32), m.regs.ebx);
    // 00402101 push esi
    push(m.regs.esi);
    // 00402102 push edi
    push(m.regs.edi);
...
pub fn x00402123() -> Cont {
    ...
    m.regs.esi = m.regs.esi.wrapping_add(m.regs.eax).wrapping_add(0x1u32);
...
pub fn x00402137() -> Cont {
    ...
    sub(m.regs.esi, m.regs.ebx);
    // 0040213c mov ds:[4095D0h],esi
    m.memory.write::<u32>(0x4095d0u32, m.regs.esi);
...
pub fn x0040214b() -> Cont {
    ...
    // 00402152 cmp [edi],bl
    sub(m.memory.read::<u8>(m.regs.edi), m.regs.get_bl());
...
pub fn x0040215d() -> Cont {
    ...
    m.regs.ecx = pop();
    // 00402160 inc ebp
    m.regs.ebp = inc(m.regs.ebp);
    // 00402161 cmp byte ptr [edi],3Dh
    sub(m.memory.read::<u8>(m.regs.edi), 0x3du8);
...
pub fn x0040217a() -> Cont {
    ...
    push(m.memory.read::<u32>(m.regs.esi));
...
pub fn x00402183() -> Cont {
    ...
    m.regs.edi = add(m.regs.edi, m.regs.ebp);
    // 0040218a cmp [edi],bl
    sub(m.memory.read::<u8>(m.regs.edi), m.regs.get_bl());
...
pub fn x0040218e() -> Cont {
    ...
    push(m.memory.read::<u32>(0x40959cu32));
...
pub fn x0040219a() -> Cont {
    ...
    m.memory.write::<u32>(0x40959cu32, m.regs.ebx);
    // 004021a1 mov [esi],ebx
    m.memory.write::<u32>(m.regs.esi, m.regs.ebx);
    // 004021a3 pop edi
    m.regs.edi = pop();
    // 004021a4 pop esi
    m.regs.esi = pop();
...
pub fn x004021da() -> Cont {
    ...
    m.memory.write::<u32>(0x4095e0u32, m.regs.esi);
    // 004021e5 mov edi,esi
    m.regs.edi = m.regs.esi;
    // 004021e7 cmp [eax],bl
    sub(m.memory.read::<u8>(m.regs.eax), m.regs.get_bl());
...
pub fn x004021fd() -> Cont {
    ...
    m.regs.eax = m.regs.eax.wrapping_add((m.regs.ecx * 4));
    // 00402206 push eax
    push(m.regs.eax);
...
pub fn x0040221c() -> Cont {
    ...
    m.regs.eax = m.regs.esi.wrapping_add((m.regs.eax * 4));
    // 0040222b push eax
    push(m.regs.eax);
    // 0040222c push esi
    push(m.regs.esi);
...
pub fn x00402233() -> Cont {
    ...
    m.memory.write::<u32>(0x4095c8u32, m.regs.esi);
    // 00402240 pop edi
    m.regs.edi = pop();
    // 00402241 pop esi
    m.regs.esi = pop();
    // 00402242 mov ds:[4095C4h],eax
    m.memory.write::<u32>(0x4095c4u32, m.regs.eax);
    // 00402247 pop ebx
    m.regs.ebx = pop();
    // 00402248 leave
    leave();
...
pub fn x0040224a() -> Cont {
    ...
    m.regs.ecx = m.memory.read::<u32>(m.regs.ebp.wrapping_add(0x18u32));
    ...
    m.memory
        .write::<u32>(m.regs.ecx, and(m.memory.read::<u32>(m.regs.ecx), 0x0u32));
    // 00402258 mov esi,[ebp+10h]
    m.regs.esi = m.memory.read::<u32>(m.regs.ebp.wrapping_add(0x10u32));
    // 0040225b push edi
    push(m.regs.edi);
    // 0040225c mov edi,[ebp+0Ch]
    m.regs.edi = m.memory.read::<u32>(m.regs.ebp.wrapping_add(0xcu32));
    // 0040225f mov dword ptr [eax],1
    m.memory.write::<u32>(m.regs.eax, 0x1u32);
...
pub fn x0040226c() -> Cont {
    ...
    m.memory
        .write::<u32>(m.regs.ebp.wrapping_add(0xcu32), m.regs.edi);
    // 00402274 cmp byte ptr [eax],22h
    sub(m.memory.read::<u8>(m.regs.eax), 0x22u8);
...
pub fn x00402282() -> Cont {
    ...
    let m = unsafe { &mut MACHINE };
    // 00402282 test dl,dl
    and(m.regs.get_dl(), m.regs.get_dl());
...
pub fn x00402286() -> Cont {
    ...
    and(
        m.memory.read::<u8>(m.regs.edx.wrapping_add(0x409861u32)),
        0x4u8,
    );
...
pub fn x00402292() -> Cont {
    ...
    m.memory
        .write::<u32>(m.regs.ecx, inc(m.memory.read::<u32>(m.regs.ecx)));
...
pub fn x004022b1() -> Cont {
    ...
    m.memory
        .write::<u8>(m.regs.esi, and(m.memory.read::<u8>(m.regs.esi), 0x0u8));
    // 004022b4 inc esi
    m.regs.esi = inc(m.regs.esi);
...
pub fn x004022c3() -> Cont {
    ...
    and(
        m.memory.read::<u8>(m.regs.ebx.wrapping_add(0x409861u32)),
        0x4u8,
    );
...
pub fn x004022dd() -> Cont {
    ...
    // 004022df mov [esi],bl
    m.memory.write::<u8>(m.regs.esi, m.regs.get_bl());
    // 004022e1 inc esi
    m.regs.esi = inc(m.regs.esi);
    // 004022e2 inc eax
    m.regs.eax = inc(m.regs.eax);
    // 004022e3 cmp dl,20h
    sub(m.regs.get_dl(), 0x20u8);
...
pub fn x004022fc() -> Cont {
    ...
    m.memory.write::<u8>(
        ...
        and(
            m.memory.read::<u8>(m.regs.esi.wrapping_add(0xffffffffu32)),
            0x0u8,
        ),
    );
...
pub fn x00402329() -> Cont {
    ...
    m.memory
        .write::<u32>(m.regs.edx, inc(m.memory.read::<u32>(m.regs.edx)));
    ...
    sub(m.memory.read::<u8>(m.regs.eax), 0x5cu8);
...
pub fn x00402359() -> Cont {
    ...
    sub(m.memory.read::<u8>(m.regs.eax.wrapping_add(0x1u32)), 0x22u8);
...
pub fn x004023f1() -> Cont {
    ...
    m.memory
        .write::<u32>(m.regs.edi, and(m.memory.read::<u32>(m.regs.edi), 0x0u32));
    ...
    m.memory
        .write::<u32>(m.regs.eax, inc(m.memory.read::<u32>(m.regs.eax)));
    // 004023fc pop ebp
    m.regs.ebp = pop();
    // 004023fd ret
    ret(0)
...
pub fn x004023fe() -> Cont {
    ...
    m.regs.eax = m.memory.read::<u32>(0x4096fcu32);
    // 00402405 push ebx
    push(m.regs.ebx);
    // 00402406 push ebp
    push(m.regs.ebp);
    // 00402407 mov ebp,ds:[4060ACh]
    m.regs.ebp = m.memory.read::<u32>(0x4060acu32);
    // 0040240d push esi
    push(m.regs.esi);
    // 0040240e push edi
    push(m.regs.edi);
...
pub fn x00402419() -> Cont {
    ...
    let m = unsafe { &mut MACHINE };
    // 00402419 call ebp
    call(0x40241b, indirect(m.regs.ebp))
}
...
pub fn x00402459() -> Cont {
    ...
    let m = unsafe { &mut MACHINE };
    // 00402459 call ebp
    call(0x40245b, indirect(m.regs.ebp))
}
...
pub fn x00402465() -> Cont {
    ...
    let m = unsafe { &mut MACHINE };
    // 00402465 cmp [esi],bx
    sub(m.memory.read::<u16>(m.regs.esi), m.regs.get_bx());
...
pub fn x0040246c() -> Cont {
    ...
    m.regs.eax = inc(m.regs.eax);
    // 0040246e cmp [eax],bx
    sub(m.memory.read::<u16>(m.regs.eax), m.regs.get_bx());
...
pub fn x0040247a() -> Cont {
    ...
    m.memory
        .write::<u32>(m.regs.esp.wrapping_add(0x34u32), m.regs.eax);
    // 00402491 call edi
    call(0x402493, indirect(m.regs.edi))
}
...
pub fn x004024a8() -> Cont {
    ...
    push(m.memory.read::<u32>(m.regs.esp.wrapping_add(0x24u32)));
    // 004024b0 push esi
    push(m.regs.esi);
    // 004024b1 push ebx
    push(m.regs.ebx);
    ...
    push(m.regs.ebx);
    // 004024b3 call edi
    call(0x4024b5, indirect(m.regs.edi))
}
...
pub fn x004024b9() -> Cont {
    ...
    push(m.memory.read::<u32>(m.regs.esp.wrapping_add(0x10u32)));
...
pub fn x004024c2() -> Cont {
    ...
    m.memory
        .write::<u32>(m.regs.esp.wrapping_add(0x10u32), m.regs.ebx);
...
pub fn x00402530() -> Cont {
    ...
    m.regs.esp = sub(m.regs.esp, 0x44u32);
    // 00402533 push ebx
    push(m.regs.ebx);
    // 00402534 push ebp
    push(m.regs.ebp);
...
pub fn x0040254f() -> Cont {
    ...
    m.regs.eax = m.regs.esi.wrapping_add(0x100u32);
...
pub fn x0040256a() -> Cont {
    ...
    m.memory.write::<u8>(
        ...
        and(m.memory.read::<u8>(m.regs.esi.wrapping_add(0x4u32)), 0x0u8),
    );
    // 0040256e or dword ptr [esi],0FFFFFFFFh
    m.memory.write::<u32>(
        m.regs.esi,
        or(m.memory.read::<u32>(m.regs.esi), 0xffffffffu32),
    );
    // 00402571 mov byte ptr [esi+5],0Ah
    m.memory.write::<u8>(m.regs.esi.wrapping_add(0x5u32), 0xau8);
    // 00402575 mov eax,ds:[4099A0h]
    m.regs.eax = m.memory.read::<u32>(0x4099a0u32);
    // 0040257a add esi,8
    m.regs.esi = add(m.regs.esi, 0x8u32);
...
pub fn x004025a7() -> Cont {
    ...
    m.regs.ebp = m.regs.eax.wrapping_add(0x4u32);
    // 004025ac mov eax,800h
    m.regs.eax = 0x800u32;
    // 004025b1 cmp esi,eax
    sub(m.regs.esi, m.regs.eax);
    // 004025b3 lea ebx,[esi+ebp]
    m.regs.ebx = m.regs.esi.wrapping_add(m.regs.ebp);
...
pub fn x004025b8() -> Cont {
    ...
    sub(m.memory.read::<u32>(0x409aa0u32), m.regs.esi);
...
pub fn x004025d6() -> Cont {
    ...
    m.memory
        .write::<u32>(0x409aa0u32, add(m.memory.read::<u32>(0x409aa0u32), 0x20u32));
    // 004025dd mov [edi],eax
    m.memory.write::<u32>(m.regs.edi, m.regs.eax);
    // 004025df lea ecx,[eax+100h]
    m.regs.ecx = m.regs.eax.wrapping_add(0x100u32);
...
pub fn x004025e9() -> Cont {
    ...
    m.memory.write::<u8>(
        ...
        and(m.memory.read::<u8>(m.regs.eax.wrapping_add(0x4u32)), 0x0u8),
    );
    // 004025ed or dword ptr [eax],0FFFFFFFFh
    m.memory.write::<u32>(
        m.regs.eax,
        or(m.memory.read::<u32>(m.regs.eax), 0xffffffffu32),
    );
    // 004025f0 mov byte ptr [eax+5],0Ah
    m.memory.write::<u8>(m.regs.eax.wrapping_add(0x5u32), 0xau8);
    // 004025f4 mov ecx,[edi]
    m.regs.ecx = m.memory.read::<u32>(m.regs.edi);
    // 004025f6 add eax,8
    m.regs.eax = add(m.regs.eax, 0x8u32);
    // 004025f9 add ecx,100h
    m.regs.ecx = add(m.regs.ecx, 0x100u32);
...
pub fn x00402639() -> Cont {
    ...
    m.regs.eax = m
        .memory
        .read::<u32>((m.regs.eax * 4).wrapping_add(0x4099a0u32));
    // 0040264a lea eax,[eax+ecx*8]
    m.regs.eax = m.regs.eax.wrapping_add((m.regs.ecx * 8));
    // 0040264d mov ecx,[ebx]
    m.regs.ecx = m.memory.read::<u32>(m.regs.ebx);
    ...
    m.memory
        .write::<u8>(m.regs.eax.wrapping_add(0x4u32), m.regs.get_cl());
    // 00402657 inc edi
    m.regs.edi = inc(m.regs.edi);
    // 00402658 inc ebp
    m.regs.ebp = inc(m.regs.ebp);
    // 00402659 add ebx,4
    m.regs.ebx = add(m.regs.ebx, 0x4u32);
...
pub fn x00402660() -> Cont {
    ...
    sub(
        m.memory
            .read::<u32>(m.regs.eax.wrapping_add((m.regs.ebx * 8))),
        0xffffffffu32,
    );
    // 0040266b lea esi,[eax+ebx*8]
    m.regs.esi = m.regs.eax.wrapping_add((m.regs.ebx * 8));
...
pub fn x00402670() -> Cont {
    ...
    m.memory
        .write::<u8>(m.regs.esi.wrapping_add(0x4u32), 0x81u8);
...
pub fn x0040267d() -> Cont {
    ...
    m.regs.eax = add(m.regs.eax, 0xfffffff5u32);
    // 00402687 push eax
    push(m.regs.eax);
...
pub fn x004026ac() -> Cont {
    ...
    m.memory.write::<u8>(
        m.regs.esi.wrapping_add(0x4u32),
        or(m.memory.read::<u8>(m.regs.esi.wrapping_add(0x4u32)), 0x40u8),
    );
...
pub fn x004026b7() -> Cont {
    ...
    m.memory.write::<u8>(
        m.regs.esi.wrapping_add(0x4u32),
        or(m.memory.read::<u8>(m.regs.esi.wrapping_add(0x4u32)), 0x8u8),
    );
...
pub fn x004026bd() -> Cont {
    ...
    m.memory.write::<u8>(
        m.regs.esi.wrapping_add(0x4u32),
        or(m.memory.read::<u8>(m.regs.esi.wrapping_add(0x4u32)), 0x80u8),
    );
    // 004026c1 inc ebx
    m.regs.ebx = inc(m.regs.ebx);
    // 004026c2 cmp ebx,3
    sub(m.regs.ebx, 0x3u32);
...
pub fn x004026c7() -> Cont {
    ...
    push(m.memory.read::<u32>(0x409aa0u32));
...
pub fn x004026d3() -> Cont {
    ...
    m.regs.esp = add(m.regs.esp, 0x44u32);
    // 004026da ret
    ret(0)
}
...
pub fn x004026eb() -> Cont {
    ...
    sub(m.memory.read::<u16>(m.regs.eax), 0x5a4du16);
...
pub fn x004026f9() -> Cont {
    ...
    m.regs
        .set_cl(m.memory.read::<u8>(m.regs.eax.wrapping_add(0x1au32)));
    // 004026fe mov [esi],cl
    m.memory.write::<u8>(m.regs.esi, m.regs.get_cl());
    // 00402700 mov al,[eax+1Bh]
    m.regs
        .set_al(m.memory.read::<u8>(m.regs.eax.wrapping_add(0x1bu32)));
    // 00402703 mov [esi+1],al
    m.memory
        .write::<u8>(m.regs.esi.wrapping_add(0x1u32), m.regs.get_al());
    // 00402706 pop esi
    m.regs.esi = pop();
    // 00402707 ret
    ret(0)
...
pub fn x00402715() -> Cont {
    ...
    m.memory
        .write::<u32>(m.regs.ebp.wrapping_add(0xffffff68u32), 0x94u32);
...
pub fn x0040276a() -> Cont {
    ...
    m.regs.ecx = m.regs.ebp.wrapping_add(0xffffedd4u32);
    // 00402772 cmp [ebp-122Ch],bl
    sub(
        m.memory.read::<u8>(m.regs.ebp.wrapping_add(0xffffedd4u32)),
        m.regs.get_bl(),
    );
...
pub fn x00402784() -> Cont {
    ...
    let m = unsafe { &mut MACHINE };
    // 00402784 sub al,20h
    m.regs.set_al(sub(m.regs.get_al(), 0x20u8));
    // 00402786 mov [ecx],al
    m.memory.write::<u8>(m.regs.ecx, m.regs.get_al());
    // 00402788 inc ecx
    m.regs.ecx = inc(m.regs.ecx);
    // 00402789 cmp [ecx],bl
    sub(m.memory.read::<u8>(m.regs.ecx), m.regs.get_bl());
...
pub fn x004027c2() -> Cont {
    ...
    m.regs.ecx = m.regs.ebp.wrapping_add(0xfffffe64u32);
...
pub fn x00402811() -> Cont {
    ...
    sub(m.memory.read::<u8>(m.regs.ecx), 0x3bu8);
...
pub fn x00402843() -> Cont {
    ...
    m.regs.eax = sbb(m.regs.eax, m.regs.eax);
    // 0040284a add eax,3
    m.regs.eax = add(m.regs.eax, 0x3u32);
    // 0040284d pop ebx
    m.regs.ebx = pop();
    // 0040284e leave
    leave();
...
pub fn x00402867() -> Cont {
    ...
    m.memory.write::<u32>(0x409984u32, m.regs.eax);
...
pub fn x00402875() -> Cont {
    ...
    m.memory.write::<u32>(0x409988u32, m.regs.eax);
...
pub fn x00402a8e() -> Cont {
    ...
    sub(m.memory.read::<u32>(0x4070c8u32), 0x1u32);
...
pub fn x00402aab() -> Cont {
    ...
    let m = unsafe { &mut MACHINE };
    // 00402aab call eax
    call(0x402aad, indirect(m.regs.eax))
}
...
pub fn x00402ab9() -> Cont {
    ...
    m.regs.esp = sub(m.regs.esp, 0x1a4u32);
    // 00402ac2 mov edx,[ebp+8]
    m.regs.edx = m.memory.read::<u32>(m.regs.ebp.wrapping_add(0x8u32));
    // 00402ac5 xor ecx,ecx
    m.regs.ecx = xor(m.regs.ecx, m.regs.ecx);
    // 00402ac7 mov eax,407178h
    m.regs.eax = 0x407178u32;
    // 00402acc cmp edx,[eax]
    sub(m.regs.edx, m.memory.read::<u32>(m.regs.eax));
...
pub fn x00402adb() -> Cont {
    ...
    sub(
        m.regs.edx,
        m.memory.read::<u32>(m.regs.esi.wrapping_add(0x407178u32)),
    );
...
pub fn x00402b41() -> Cont {
    ...
    m.regs.edi = m.regs.ebp.wrapping_add(0xfffffe5cu32);
...
pub fn x00402b69() -> Cont {
    ...
    m.regs.eax = sub(m.regs.eax, 0x3bu32);
    // 00402b74 push 3
    push(0x3u32);
...
pub fn x00402bb5() -> Cont {
    ...
    push(m.memory.read::<u32>(m.regs.esi.wrapping_add(0x40717cu32)));
...
pub fn x00402bdd() -> Cont {
    ...
    m.regs.esp = add(m.regs.esp, 0x2cu32);
    // 00402be0 pop edi
    m.regs.edi = pop();
...
pub fn x00402be3() -> Cont {
    ...
    m.regs.esi = m.regs.esi.wrapping_add(0x40717cu32);
    // 00402bec push 0
    push(0x0u32);
    // 00402bee push eax
    push(m.regs.eax);
...
pub fn x00402c1f() -> Cont {
    ...
    m.memory.write::<u32>(0x40997cu32, m.regs.eax);
...
pub fn x00402c29() -> Cont {
    ...
    m.memory
        .write::<u32>(0x409974u32, and(m.memory.read::<u32>(0x409974u32), 0x0u32));
    // 00402c34 and dword ptr ds:[409978h],0
    m.memory
        .write::<u32>(0x409978u32, and(m.memory.read::<u32>(0x409978u32), 0x0u32));
    // 00402c3b push 1
    push(0x1u32);
    // 00402c3d mov ds:[409970h],eax
    m.memory.write::<u32>(0x409970u32, m.regs.eax);
    // 00402c42 mov ds:[409980h],ecx
    m.memory.write::<u32>(0x409980u32, m.regs.ecx);
...
pub fn x00402c54() -> Cont {
    ...
    m.regs.ecx = m.regs.eax.wrapping_add((m.regs.eax * 4));
...
pub fn x00402c68() -> Cont {
    ...
    m.regs.edx = sub(
        m.regs.edx,
        m.memory.read::<u32>(m.regs.eax.wrapping_add(0xcu32)),
    );
    // 00402c6f cmp edx,100000h
    sub(m.regs.edx, 0x100000u32);
...
pub fn x00402c77() -> Cont {
    ...
    m.regs.eax = add(m.regs.eax, 0x14u32);
...
pub fn x00402c7f() -> Cont {
    ...
    m.regs.eax = m.memory.read::<u32>(m.regs.ecx.wrapping_add(0x10u32));
    // 00402c90 push edi
    push(m.regs.edi);
    // 00402c91 mov edi,esi
    m.regs.edi = m.regs.esi;
    // 00402c93 add esi,0FFFFFFFCh
    m.regs.esi = add(m.regs.esi, 0xfffffffcu32);
    ...
    m.regs.ecx = imul(m.regs.ecx as i32, 0x204u32 as i32) as u32;
    // 00402ca4 lea ecx,[ecx+eax+144h]
    m.regs.ecx = m.regs.ecx.wrapping_add(m.regs.eax).wrapping_add(0x144u32);
...
pub fn x00402cbd() -> Cont {
    ...
    m.regs.ebx = m.regs.ecx.wrapping_add(m.regs.esi);
    // 00402cc3 mov [ebp-0Ch],edx
    m.memory
        .write::<u32>(m.regs.ebp.wrapping_add(0xfffffff4u32), m.regs.edx);
    // 00402cc6 mov edx,[esi-4]
    m.regs.edx = m.memory.read::<u32>(m.regs.esi.wrapping_add(0xfffffffcu32));
...
pub fn x00402cf0() -> Cont {
    ...
    m.memory
        .write::<u8>(m.regs.ecx, dec(m.memory.read::<u8>(m.regs.ecx)));
...
pub fn x00402d07() -> Cont {
    ...
    m.memory.write::<u32>(
        m.regs.ecx,
        and(m.memory.read::<u32>(m.regs.ecx), m.regs.ebx),
    );
...
pub fn x00402d37() -> Cont {
    ...
    m.regs.ebx = m.memory.read::<u32>(m.regs.ebx.wrapping_add(0x4u32));
    ...
    m.memory
        .write::<u32>(m.regs.edx.wrapping_add(0x4u32), m.regs.ebx);
    ...
    m.regs.ebx = m.memory.read::<u32>(m.regs.edx.wrapping_add(0x4u32));
    // 00402d4f mov edx,[edx+8]
    m.regs.edx = m.memory.read::<u32>(m.regs.edx.wrapping_add(0x8u32));
    // 00402d52 mov [ebx+8],edx
    m.memory
        .write::<u32>(m.regs.ebx.wrapping_add(0x8u32), m.regs.edx);
...
pub fn x00402d60() -> Cont {
    ...
    // 00402d66 and ebx,1
    m.regs.ebx = and(m.regs.ebx, 0x1u32);
    // 00402d69 mov [ebp-0Ch],ebx
    m.memory
        .write::<u32>(m.regs.ebp.wrapping_add(0xfffffff4u32), m.regs.ebx);
...
pub fn x00402d72() -> Cont {
    ...
    m.memory
        .write::<u32>(m.regs.ebp.wrapping_add(0xcu32), m.regs.esi);
    // 00402d80 dec ebx
    m.regs.ebx = dec(m.regs.ebx);
    // 00402d81 pop esi
    m.regs.esi = pop();
...
pub fn x00402d9e() -> Cont {
    ...
    m.regs.esi = m.memory.read::<u32>(m.regs.ecx.wrapping_add(0x4u32));
    // 00402da4 cmp esi,[ecx+8]
    sub(
        m.regs.esi,
        m.memory.read::<u32>(m.regs.ecx.wrapping_add(0x8u32)),
    );
...
pub fn x00402dae() -> Cont {
    ...
    m.memory.write::<u8>(
        m.regs.ebx.wrapping_add(m.regs.eax).wrapping_add(0x4u32),
        dec(m
            .memory
            .read::<u8>(m.regs.ebx.wrapping_add(m.regs.eax).wrapping_add(0x4u32))),
    );
...
pub fn x00402dc3() -> Cont {
    ...
    m.memory.write::<u32>(
        m.regs.ecx,
        and(m.memory.read::<u32>(m.regs.ecx), m.regs.esi),
    );
...
pub fn x00402de3() -> Cont {
    ...
    m.regs.esi = m.memory.read::<u32>(m.regs.ecx.wrapping_add(0x8u32));
    // 00402def mov ecx,[ecx+4]
    m.regs.ecx = m.memory.read::<u32>(m.regs.ecx.wrapping_add(0x4u32));
    // 00402df2 mov [esi+4],ecx
    m.memory
        .write::<u32>(m.regs.esi.wrapping_add(0x4u32), m.regs.ecx);
    // 00402df5 mov ecx,[ebp+0Ch]
    m.regs.ecx = m.memory.read::<u32>(m.regs.ebp.wrapping_add(0xcu32));
    // 00402df8 mov esi,[ecx+4]
    m.regs.esi = m.memory.read::<u32>(m.regs.ecx.wrapping_add(0x4u32));
    // 00402dfb mov ecx,[ecx+8]
    m.regs.ecx = m.memory.read::<u32>(m.regs.ecx.wrapping_add(0x8u32));
    // 00402dfe mov [esi+8],ecx
    m.memory
        .write::<u32>(m.regs.esi.wrapping_add(0x8u32), m.regs.ecx);
...
pub fn x00402e17() -> Cont {
    ...
    m.regs.ebx = m.memory.read::<u32>(
        m.regs
            .ecx
            .wrapping_add((m.regs.edx * 8))
            .wrapping_add(0x4u32),
    );
    // 00402e1e lea ecx,[ecx+edx*8]
    m.regs.ecx = m.regs.ecx.wrapping_add((m.regs.edx * 8));
    // 00402e21 mov [esi+4],ebx
    m.memory
        .write::<u32>(m.regs.esi.wrapping_add(0x4u32), m.regs.ebx);
    ...
    m.regs.ecx = m.memory.read::<u32>(m.regs.esi.wrapping_add(0x4u32));
    ...
    sub(
        m.regs.ecx,
        m.memory.read::<u32>(m.regs.esi.wrapping_add(0x8u32)),
    );
...
pub fn x00402e38() -> Cont {
    ...
    m.regs.set_cl(
        m.memory
            .read::<u8>(m.regs.edx.wrapping_add(m.regs.eax).wrapping_add(0x4u32)),
    );
    // 00402e3c cmp edx,20h
    sub(m.regs.edx, 0x20u32);
    // 00402e3f mov [ebp+0Fh],cl
    m.memory
        .write::<u8>(m.regs.ebp.wrapping_add(0xfu32), m.regs.get_cl());
    // 00402e42 inc cl
    m.regs.set_cl(inc(m.regs.get_cl()));
    // 00402e44 mov [edx+eax+4],cl
    m.memory.write::<u8>(
        m.regs.edx.wrapping_add(m.regs.eax).wrapping_add(0x4u32),
        m.regs.get_cl(),
    );
...
pub fn x00402e4a() -> Cont {
    ...
    sub(m.memory.read::<u8>(m.regs.ebp.wrapping_add(0xfu32)), 0x0u8);
...
pub fn x00402e50() -> Cont {
    ...
    // 00402e5c or [ecx],ebx
    m.memory
        .write::<u32>(m.regs.ecx, or(m.memory.read::<u32>(m.regs.ecx), m.regs.ebx));
    ...
    // 00402e6b or [eax],ebx
    m.memory
        .write::<u32>(m.regs.eax, or(m.memory.read::<u32>(m.regs.eax), m.regs.ebx));
...
pub fn x00402e75() -> Cont {
    ...
    m.memory
        .write::<u32>(m.regs.eax, dec(m.memory.read::<u32>(m.regs.eax)));
...
pub fn x00402eb9() -> Cont {
    ...
    push(m.regs.ecx);
    // 00402ed7 call esi
    call(0x402ed9, indirect(m.regs.esi))
}
...
pub fn x00402ed9() -> Cont {
    ...
    m.memory.write::<u8>(
        m.regs.eax.wrapping_add(0x43u32),
        dec(m.memory.read::<u8>(m.regs.eax.wrapping_add(0x43u32))),
    );
    ...
    sub(m.memory.read::<u8>(m.regs.ecx.wrapping_add(0x43u32)), 0x0u8);
...
pub fn x00402f2c() -> Cont {
    ...
    push(m.memory.read::<u32>(m.regs.eax.wrapping_add(0xcu32)));
    // 00402f32 call esi
    call(0x402f34, indirect(m.regs.esi))
}
...
pub fn x00402f34() -> Cont {
    ...
    push(m.memory.read::<u32>(m.regs.eax.wrapping_add(0x10u32)));
    // 00402f3c push 0
    push(0x0u32);
...
pub fn x00402f4a() -> Cont {
    ...
    m.regs.edx = m.memory.read::<u32>(0x40997cu32);
    ...
    m.regs.ecx = sub(m.regs.ecx, m.regs.eax);
    // 00402f64 lea ecx,[ecx+edx-14h]
    m.regs.ecx = m
        .regs
        .ecx
        .wrapping_add(m.regs.edx)
        .wrapping_add(0xffffffecu32);
    // 00402f68 push ecx
    push(m.regs.ecx);
    // 00402f69 lea ecx,[eax+14h]
    m.regs.ecx = m.regs.eax.wrapping_add(0x14u32);
    // 00402f6c push ecx
    push(m.regs.ecx);
    // 00402f6d push eax
    push(m.regs.eax);
...
pub fn x00402f73() -> Cont {
    ...
    m.memory
        .write::<u32>(0x409978u32, dec(m.memory.read::<u32>(0x409978u32)));
    // 00402f7f cmp eax,ds:[409974h]
    sub(m.regs.eax, m.memory.read::<u32>(0x409974u32));
...
pub fn x00402f87() -> Cont {
    ...
    m.memory.write::<u32>(0x40996cu32, m.regs.edi);
    // 00402f9e mov ds:[409974h],eax
    m.memory.write::<u32>(0x409974u32, m.regs.eax);
    // 00402fa3 pop edi
    m.regs.edi = pop();
    // 00402fa4 pop esi
    m.regs.esi = pop();
...
pub fn x00402fa8() -> Cont {
    ...
    m.regs.esp = sub(m.regs.esp, 0x14u32);
    ...
    m.regs.edi = m.regs.edx.wrapping_add((m.regs.eax * 4));
    ...
    m.regs.ecx = m.regs.eax.wrapping_add(0x17u32);
    // 00402fcb and ecx,0FFFFFFF0h
    m.regs.ecx = and(m.regs.ecx, 0xfffffff0u32);
...
pub fn x00402fe8() -> Cont {
    ...
    m.regs.ecx = add(m.regs.ecx, 0xffffffe0u32);
    ...
    sub(m.regs.ebx, m.regs.edi);
    // 00403001 mov [ebp+8],ebx
    m.memory
        .write::<u32>(m.regs.ebp.wrapping_add(0x8u32), m.regs.ebx);
...
pub fn x00403006() -> Cont {
    ...
    m.regs.edi = m.memory.read::<u32>(m.regs.ebx);
    ...
    m.regs.edi = and(m.regs.edi, m.regs.esi);
    // 00403010 or ecx,edi
    m.regs.ecx = or(m.regs.ecx, m.regs.edi);
...
pub fn x00403014() -> Cont {
    ...
    m.regs.ebx = add(m.regs.ebx, 0x14u32);
...
pub fn x00403088() -> Cont {
    ...
    m.regs.ecx = m.memory.read::<u32>(m.regs.ebx.wrapping_add(0x10u32));
    ...
    sub(m.memory.read::<u32>(m.regs.eax), 0xffffffffu32);
...
pub fn x004030b0() -> Cont {
    ...
    m.regs.ecx = m.memory.read::<u32>(
        m.regs
            .eax
            .wrapping_add((m.regs.edx * 4))
            .wrapping_add(0xc4u32),
    );
    // 004030b7 mov edi,[eax+edx*4+44h]
    m.regs.edi = m.memory.read::<u32>(
        m.regs
            .eax
            .wrapping_add((m.regs.edx * 4))
            .wrapping_add(0x44u32),
...
pub fn x004030c4() -> Cont {
    ...
    m.regs.esi = m.memory.read::<u32>(m.regs.eax.wrapping_add(0x44u32));
    ...
    m.regs.ecx = m.regs.eax.wrapping_add(0x44u32);
    // 004030da or edx,esi
    m.regs.edx = or(m.regs.edx, m.regs.esi);
...
pub fn x004030e1() -> Cont {
    ...
    m.regs.edi = and(m.regs.edi, m.memory.read::<u32>(m.regs.ecx));
    // 004030f4 or edx,edi
    m.regs.edx = or(m.regs.edx, m.regs.edi);
...
pub fn x004030f8() -> Cont {
    ...
    m.memory
        .write::<u32>(m.regs.ebp.wrapping_add(0xfffffff4u32), m.regs.ecx);
    ...
    m.regs.ecx = and(m.regs.ecx, m.regs.esi);
...
pub fn x0040312d() -> Cont {
    ...
    m.regs.edx = m.memory.read::<u32>(
        m.regs
            .ecx
            .wrapping_add((m.regs.edi * 8))
            .wrapping_add(0x4u32),
    );
...
pub fn x00403152() -> Cont {
    ...
    sub(
        m.regs.ecx,
        m.memory.read::<u32>(m.regs.edx.wrapping_add(0x8u32)),
    );
...
pub fn x0040315f() -> Cont {
    ...
    m.regs.edi = m.regs.eax.wrapping_add(m.regs.edi).wrapping_add(0x4u32);
    // 0040316f not ebx
    not();
    ...
    m.memory
        .write::<u8>(m.regs.edi, dec(m.memory.read::<u8>(m.regs.edi)));
...
pub fn x00403180() -> Cont {
    ...
    m.memory.write::<u32>(
        m.regs.ebx,
        and(m.memory.read::<u32>(m.regs.ebx), m.regs.ecx),
    );
...
pub fn x004031b8() -> Cont {
    ...
    m.regs.edi = m.memory.read::<u32>(m.regs.edx.wrapping_add(0x4u32));
    ...
    m.memory
        .write::<u32>(m.regs.ecx.wrapping_add(0x4u32), m.regs.edi);
    // 004031c8 mov ecx,[edx+4]
    m.regs.ecx = m.memory.read::<u32>(m.regs.edx.wrapping_add(0x4u32));
    // 004031cb mov edi,[edx+8]
    m.regs.edi = m.memory.read::<u32>(m.regs.edx.wrapping_add(0x8u32));
    // 004031ce mov [ecx+8],edi
    m.memory
        .write::<u32>(m.regs.ecx.wrapping_add(0x8u32), m.regs.edi);
...
pub fn x004031d7() -> Cont {
    ...
    m.regs.edi = m.memory.read::<u32>(
        m.regs
            .ecx
            .wrapping_add((m.regs.esi * 8))
            .wrapping_add(0x4u32),
    );
    // 004031de lea ecx,[ecx+esi*8]
    m.regs.ecx = m.regs.ecx.wrapping_add((m.regs.esi * 8));
    // 004031e1 mov [edx+4],edi
    m.memory
        .write::<u32>(m.regs.edx.wrapping_add(0x4u32), m.regs.edi);
    // 004031e4 mov [edx+8],ecx
    m.memory
        .write::<u32>(m.regs.edx.wrapping_add(0x8u32), m.regs.ecx);
    // 004031e7 mov [ecx+4],edx
    m.memory
        .write::<u32>(m.regs.ecx.wrapping_add(0x4u32), m.regs.edx);
    // 004031ea mov ecx,[edx+4]
    m.regs.ecx = m.memory.read::<u32>(m.regs.edx.wrapping_add(0x4u32));
    // 004031ed mov [ecx+8],edx
    m.memory
        .write::<u32>(m.regs.ecx.wrapping_add(0x8u32), m.regs.edx);
...
pub fn x004031f8() -> Cont {
    ...
    m.regs.set_cl(
        m.memory
            .read::<u8>(m.regs.esi.wrapping_add(m.regs.eax).wrapping_add(0x4u32)),
    );
    // 004031fc cmp esi,20h
    sub(m.regs.esi, 0x20u32);
    // 004031ff mov [ebp+0Bh],cl
    m.memory
        .write::<u8>(m.regs.ebp.wrapping_add(0xbu32), m.regs.get_cl());
...
pub fn x00403204() -> Cont {
    ...
    sub(m.memory.read::<u8>(m.regs.ebp.wrapping_add(0xbu32)), 0x0u8);
    // 0040320a mov [esi+eax+4],cl
    m.memory.write::<u8>(
        m.regs.esi.wrapping_add(m.regs.eax).wrapping_add(0x4u32),
        m.regs.get_cl(),
    );
...
pub fn x0040326b() -> Cont {
    ...
    m.regs.ecx = m.regs.esi.wrapping_add(0x1u32);
    ...
    m.regs.edi = m.regs.ecx.wrapping_add(0x1u32);
...
pub fn x0040328a() -> Cont {
    ...
    sub(m.regs.ebx, m.memory.read::<u32>(0x409974u32));
...
pub fn x00403292() -> Cont {
    ...
    sub(m.regs.ecx, m.memory.read::<u32>(0x40996cu32));
...
pub fn x0040329d() -> Cont {
    ...
    m.regs.eax = m.regs.edx.wrapping_add(0x4u32);
    // 004032ac pop edi
    m.regs.edi = pop();
    // 004032ad pop esi
    m.regs.esi = pop();
...
pub fn x004032b1() -> Cont {
    ...
    m.regs.ecx = m.memory.read::<u32>(0x409968u32);
    // 004032bc push esi
    push(m.regs.esi);
    // 004032bd push edi
    push(m.regs.edi);
...
pub fn x004032c4() -> Cont {
    ...
    push(m.memory.read::<u32>(0x40997cu32));
    // 004032d2 push edi
    push(m.regs.edi);
...
pub fn x004032e3() -> Cont {
    ...
    m.memory
        .write::<u32>(0x409968u32, add(m.memory.read::<u32>(0x409968u32), 0x10u32));
    ...
    m.regs.esi = m.regs.ecx.wrapping_add((m.regs.eax * 4));
...
pub fn x00403313() -> Cont {
    ...
    m.memory
        .write::<u32>(m.regs.esi.wrapping_add(0x10u32), m.regs.eax);
...
pub fn x0040332d() -> Cont {
    ...
    m.memory
        .write::<u32>(m.regs.esi.wrapping_add(0xcu32), m.regs.eax);
...
pub fn x00403334() -> Cont {
    ...
    push(m.memory.read::<u32>(m.regs.esi.wrapping_add(0x10u32)));
    // 00403337 push edi
    push(m.regs.edi);
...
pub fn x00403348() -> Cont {
    ...
    m.memory
        .write::<u32>(m.regs.esi.wrapping_add(0x4u32), m.regs.edi);
    // 00403351 inc dword ptr ds:[409978h]
    m.memory
        .write::<u32>(0x409978u32, inc(m.memory.read::<u32>(0x409978u32)));
...
pub fn x00403362() -> Cont {
    ...
    m.regs.esi = m.memory.read::<u32>(m.regs.ecx.wrapping_add(0x10u32));
    // 0040336f mov eax,[ecx+8]
    m.regs.eax = m.memory.read::<u32>(m.regs.ecx.wrapping_add(0x8u32));
...
pub fn x0040337d() -> Cont {
    ...
    m.regs.eax = imul(m.regs.eax as i32, 0x204u32 as i32) as u32;
    // 00403387 pop edx
    m.regs.edx = pop();
    // 00403388 lea eax,[eax+esi+144h]
    m.regs.eax = m.regs.eax.wrapping_add(m.regs.esi).wrapping_add(0x144u32);
    ...
    m.memory
        .write::<u32>(m.regs.eax.wrapping_add(0x4u32), m.regs.eax);
    // 00403398 add eax,8
    m.regs.eax = add(m.regs.eax, 0x8u32);
    // 0040339b dec edx
    m.regs.edx = dec(m.regs.edx);
...
pub fn x004033cf() -> Cont {
    ...
    m.memory.write::<u32>(
        ...
        or(
            m.memory.read::<u32>(m.regs.eax.wrapping_add(0xfffffff8u32)),
            0xffffffffu32,
        ),
    );
    // 004033d6 or dword ptr [eax+0FECh],0FFFFFFFFh
    m.memory.write::<u32>(
        m.regs.eax.wrapping_add(0xfecu32),
        or(
            m.memory.read::<u32>(m.regs.eax.wrapping_add(0xfecu32)),
            0xffffffffu32,
        ),
    );
    // 004033dd lea ecx,[eax+0FFCh]
    m.regs.ecx = m.regs.eax.wrapping_add(0xffcu32);
    // 004033e3 mov dword ptr [eax-4],0FF0h
    m.memory
        .write::<u32>(m.regs.eax.wrapping_add(0xfffffffcu32), 0xff0u32);
    // 004033ea mov [eax],ecx
    m.memory.write::<u32>(m.regs.eax, m.regs.ecx);
    // 004033ec lea ecx,[eax-1004h]
    m.regs.ecx = m.regs.eax.wrapping_add(0xffffeffcu32);
    // 004033f2 mov [eax+4],ecx
    m.memory
        .write::<u32>(m.regs.eax.wrapping_add(0x4u32), m.regs.ecx);
    // 004033f5 mov dword ptr [eax+0FE8h],0FF0h
    m.memory
        .write::<u32>(m.regs.eax.wrapping_add(0xfe8u32), 0xff0u32);
    // 004033ff add eax,1000h
    m.regs.eax = add(m.regs.eax, 0x1000u32);
    // 00403404 lea ecx,[eax-10h]
    m.regs.ecx = m.regs.eax.wrapping_add(0xfffffff0u32);
...
pub fn x0040340b() -> Cont {
    ...
    m.regs.ecx = m.regs.edi.wrapping_add(0xcu32);
    // 00403411 add eax,1F8h
    m.regs.eax = add(m.regs.eax, 0x1f8u32);
    // 00403416 push 1
    push(0x1u32);
    // 00403418 pop edi
    m.regs.edi = pop();
    ...
    m.memory
        .write::<u32>(m.regs.ecx.wrapping_add(0x8u32), m.regs.eax);
    // 0040341f lea ecx,[edx+0Ch]
    m.regs.ecx = m.regs.edx.wrapping_add(0xcu32);
    // 00403422 mov [eax+8],ecx
    m.memory
        .write::<u32>(m.regs.eax.wrapping_add(0x8u32), m.regs.ecx);
    // 00403425 mov [ecx+4],eax
    m.memory
        .write::<u32>(m.regs.ecx.wrapping_add(0x4u32), m.regs.eax);
    // 00403428 and dword ptr [esi+ebx*4+44h],0
    m.memory.write::<u32>(
        m.regs
            .esi
            .wrapping_add((m.regs.ebx * 4))
            .wrapping_add(0x44u32),
        and(
            m.memory.read::<u32>(
                m.regs
    ...
    m.regs
        .set_al(m.memory.read::<u8>(m.regs.esi.wrapping_add(0x43u32)));
    // 00403437 mov cl,al
    ...
    m.memory
        .write::<u8>(m.regs.esi.wrapping_add(0x43u32), m.regs.get_cl());
...
pub fn x0040345d() -> Cont {
    ...
    m.regs.esp = sub(m.regs.esp, 0xcu32);
    ...
    m.regs.esi = m.regs.eax.wrapping_add(0x17u32);
    ...
    m.regs.ecx = m.memory.read::<u32>(m.regs.edi.wrapping_add(0xfffffffcu32));
    // 00403495 dec ecx
    m.regs.ecx = dec(m.regs.ecx);
    // 00403496 cmp esi,ecx
    sub(m.regs.esi, m.regs.ecx);
...
pub fn x004034ce() -> Cont {
    ...
    sub(
        m.regs.ebx,
        m.memory.read::<u32>(m.regs.edi.wrapping_add(0x8u32)),
    );
...
pub fn x004034e1() -> Cont {
    ...
    m.regs.ecx = m.regs.ecx.wrapping_add(m.regs.eax).wrapping_add(0x4u32);
    // 004034ef not ebx
    not();
...
pub fn x0040351e() -> Cont {
    ...
    m.memory
        .write::<u32>(m.regs.ecx.wrapping_add(0x4u32), m.regs.ebx);
    // 0040352d mov ecx,[edi+4]
    m.regs.ecx = m.memory.read::<u32>(m.regs.edi.wrapping_add(0x4u32));
    // 00403530 mov edi,[edi+8]
    m.regs.edi = m.memory.read::<u32>(m.regs.edi.wrapping_add(0x8u32));
    // 00403533 mov [ecx+8],edi
    m.memory
        .write::<u32>(m.regs.ecx.wrapping_add(0x8u32), m.regs.edi);
    // 00403536 mov ecx,[ebp+10h]
    m.regs.ecx = m.memory.read::<u32>(m.regs.ebp.wrapping_add(0x10u32));
...
pub fn x0040355b() -> Cont {
    ...
    m.regs.ebx = m.regs.ebx.wrapping_add((m.regs.edi * 8));
    // 00403564 mov [ebp+10h],ebx
    m.memory
        .write::<u32>(m.regs.ebp.wrapping_add(0x10u32), m.regs.ebx);
    ...
    m.memory
        .write::<u32>(m.regs.ecx.wrapping_add(0x8u32), m.regs.ebx);
    // 00403573 mov [ebx+4],ecx
    m.memory
        .write::<u32>(m.regs.ebx.wrapping_add(0x4u32), m.regs.ecx);
    // 00403576 mov ebx,[ecx+4]
    m.regs.ebx = m.memory.read::<u32>(m.regs.ecx.wrapping_add(0x4u32));
    // 00403579 mov [ebx+8],ecx
    m.memory
        .write::<u32>(m.regs.ebx.wrapping_add(0x8u32), m.regs.ecx);
...
pub fn x00403584() -> Cont {
    ...
    m.regs.set_cl(
        m.memory
            .read::<u8>(m.regs.edi.wrapping_add(m.regs.eax).wrapping_add(0x4u32)),
    );
    // 00403588 cmp edi,20h
    sub(m.regs.edi, 0x20u32);
    // 0040358b mov [ebp+13h],cl
    m.memory
        .write::<u8>(m.regs.ebp.wrapping_add(0x13u32), m.regs.get_cl());
    // 0040358e inc cl
    m.regs.set_cl(inc(m.regs.get_cl()));
    // 00403590 mov [edi+eax+4],cl
    m.memory.write::<u8>(
        m.regs.edi.wrapping_add(m.regs.eax).wrapping_add(0x4u32),
        m.regs.get_cl(),
    );
...
pub fn x00403596() -> Cont {
    ...
    sub(m.memory.read::<u8>(m.regs.ebp.wrapping_add(0x13u32)), 0x0u8);
...
pub fn x004035f2() -> Cont {
    ...
    m.memory
        .write::<u32>(m.regs.edx.wrapping_add(0xfffffffcu32), m.regs.eax);
...
pub fn x00403611() -> Cont {
    ...
    m.memory.write::<u32>(
        m.regs.ebp.wrapping_add(0x10u32),
        sub(
    ...
    m.memory
        .write::<u32>(m.regs.ebx.wrapping_add(0xfffffffcu32), m.regs.ecx);
...
pub fn x0040365c() -> Cont {
    ...
    m.memory
        .write::<u8>(m.regs.esi, dec(m.memory.read::<u8>(m.regs.esi)));
...
pub fn x00403695() -> Cont {
    ...
    m.regs.esi = m.memory.read::<u32>(m.regs.edi.wrapping_add(0x4u32));
    ...
    m.regs.esi = m.memory.read::<u32>(m.regs.edi.wrapping_add(0x8u32));
...
pub fn x004036c2() -> Cont {
    ...
    m.memory
        .write::<u32>(m.regs.ebx.wrapping_add(0x4u32), m.regs.edi);
...
pub fn x004036fe() -> Cont {
    ...
    // 0040370a or [ecx],edi
    m.memory
        .write::<u32>(m.regs.ecx, or(m.memory.read::<u32>(m.regs.ecx), m.regs.edi));
...
pub fn x0040371f() -> Cont {
    ...
    m.memory.write::<u32>(m.regs.ebx, m.regs.eax);
    // 00403747 mov [eax+ebx-4],eax
    m.memory.write::<u32>(
        m.regs
            .eax
            .wrapping_add(m.regs.ebx)
            .wrapping_add(0xfffffffcu32),
        m.regs.eax,
    );
    // 0040374b push 1
...
pub fn x00403753() -> Cont {
    ...
    sub(m.memory.read::<u32>(0x407218u32), 0xffffffffu32);
    // 0040375a push ebx
    push(m.regs.ebx);
    // 0040375b push ebp
    push(m.regs.ebp);
...
pub fn x00403784() -> Cont {
    ...
    push(0x0u32);
    // 00403798 call ebp
    call(0x40379a, indirect(m.regs.ebp))
}
...
pub fn x004037a4() -> Cont {
    ...
    push(m.regs.edi);
    // 004037b2 call ebp
    call(0x4037b4, indirect(m.regs.ebp))
}
...
pub fn x004037c5() -> Cont {
    ...
    sub(m.memory.read::<u32>(0x407208u32), 0x0u32);
...
pub fn x004037ce() -> Cont {
    ...
    sub(m.memory.read::<u32>(0x40720cu32), 0x0u32);
...
pub fn x0040384c() -> Cont {
    ...
    m.memory.write::<u8>(
        ...
        or(
            m.memory.read::<u8>(m.regs.edi.wrapping_add(0xf8u32)),
            0xffu8,
        ),
    );
    ...
    m.memory
        .write::<u32>(m.regs.edi.wrapping_add(0x4u32), 0xf0u32);
    // 0040385f add edi,1000h
    m.regs.edi = add(m.regs.edi, 0x1000u32);
...
pub fn x004038ac() -> Cont {
    ...
    sub(m.memory.read::<u32>(0x409228u32), m.regs.esi);
...
pub fn x004038b4() -> Cont {
    ...
    m.memory.write::<u32>(0x409228u32, m.regs.eax);
...
pub fn x004038e4() -> Cont {
    ...
    m.memory.write::<u32>(
        0x407218u32,
        or(m.memory.read::<u32>(0x407218u32), 0xffffffffu32),
    );
    // 004038eb pop esi
    m.regs.esi = pop();
    // 004038ec ret
...
pub fn x004038ed() -> Cont {
    ...
    m.regs.esi = m.memory.read::<u32>(0x40720cu32);
    // 004038f9 push edi
    push(m.regs.edi);
...
pub fn x00403904() -> Cont {
    ...
    m.regs.edi = m.regs.esi.wrapping_add(0x2010u32);
    // 0040390e mov ebx,3FF000h
    m.regs.ebx = 0x3ff000u32;
    // 00403913 cmp dword ptr [edi],0F0h
    sub(m.memory.read::<u32>(m.regs.edi), 0xf0u32);
...
pub fn x00403935() -> Cont {
    ...
    m.memory.write::<u32>(
        m.regs.edi,
        or(m.memory.read::<u32>(m.regs.edi), 0xffffffffu32),
    );
    // 00403938 dec dword ptr ds:[409704h]
    m.memory
        .write::<u32>(0x409704u32, dec(m.memory.read::<u32>(0x409704u32)));
    // 0040393e mov eax,[esi+0Ch]
    m.regs.eax = m.memory.read::<u32>(m.regs.esi.wrapping_add(0xcu32));
...
pub fn x00403949() -> Cont {
    ...
    m.memory.write::<u32>(
        m.regs.ebp.wrapping_add(0x8u32),
        dec(m.memory.read::<u32>(m.regs.ebp.wrapping_add(0x8u32))),
    );
...
pub fn x00403954() -> Cont {
    ...
    m.regs.ebx = sub(m.regs.ebx, 0x1000u32);
    // 0040395a sub edi,8
    m.regs.edi = sub(m.regs.edi, 0x8u32);
...
pub fn x00403961() -> Cont {
    ...
    m.regs.esi = m.memory.read::<u32>(m.regs.esi.wrapping_add(0x4u32));
...
pub fn x00403972() -> Cont {
    ...
    m.regs.eax = m.regs.ecx.wrapping_add(0x20u32);
    // 00403977 pop edx
    m.regs.edx = pop();
...
pub fn x00403997() -> Cont {
    ...
    sub(m.regs.esi, m.memory.read::<u32>(0x40720cu32));
...
pub fn x004039af() -> Cont {
    ...
    sub(
        m.regs.eax,
        m.memory.read::<u32>(m.regs.ecx.wrapping_add(0x10u32)),
    );
...
pub fn x004039c0() -> Cont {
    ...
    sub(
        m.regs.eax,
        m.memory.read::<u32>(m.regs.ecx.wrapping_add(0x14u32)),
    );
...
pub fn x004039d1() -> Cont {
    ...
    m.regs.esi = and(m.regs.esi, 0xfffu32);
    // 004039de cmp esi,edx
    sub(m.regs.esi, m.regs.edx);
...
pub fn x004039e2() -> Cont {
    ...
    m.memory.write::<u32>(m.regs.esi, m.regs.ecx);
    // 004039e8 mov esi,[esp+10h]
    m.regs.esi = m.memory.read::<u32>(m.regs.esp.wrapping_add(0x10u32));
    // 004039ec mov ecx,eax
    m.regs.ecx = m.regs.eax;
    // 004039ee and cx,0F000h
    m.regs.set_cx(and(m.regs.get_cx(), 0xf000u16));
...
pub fn x00403a06() -> Cont {
    ...
    m.regs.edx = m.memory.read::<u8>(m.regs.ecx) as _;
    // 00403a1f add [eax],edx
    m.memory.write::<u32>(
        m.regs.eax,
        add(m.memory.read::<u32>(m.regs.eax), m.regs.edx),
    );
    // 00403a21 and byte ptr [ecx],0
    m.memory
        .write::<u8>(m.regs.ecx, and(m.memory.read::<u8>(m.regs.ecx), 0x0u8));
    // 00403a24 cmp dword ptr [eax],0F0h
    sub(m.memory.read::<u32>(m.regs.eax), 0xf0u32);
    // 00403a2a mov dword ptr [eax+4],0F1h
    m.memory
        .write::<u32>(m.regs.eax.wrapping_add(0x4u32), 0xf1u32);
...
pub fn x00403a33() -> Cont {
    ...
    m.memory
        .write::<u32>(0x409704u32, inc(m.memory.read::<u32>(0x409704u32)));
    // 00403a39 cmp dword ptr ds:[409704h],20h
    sub(m.memory.read::<u32>(0x409704u32), 0x20u32);
...
pub fn x00403a4b() -> Cont {
    ...
    m.regs.esi = m.memory.read::<u32>(0x409228u32);
    // 00403a58 push edi
    push(m.regs.edi);
...
pub fn x00403a65() -> Cont {
    ...
    m.regs.ecx = m.regs.esi.wrapping_add(0x2018u32);
...
pub fn x00403aa1() -> Cont {
    ...
    // 00403aa7 add edi,8
    m.regs.edi = add(m.regs.edi, 0x8u32);
...
pub fn x00403abe() -> Cont {
    ...
    m.regs.ecx = m.memory.read::<u32>(m.regs.esi.wrapping_add(0x10u32));
    // 00403ac7 lea edi,[esi+18h]
    m.regs.edi = m.regs.esi.wrapping_add(0x18u32);
...
pub fn x00403b04() -> Cont {
    ...
    sub(m.regs.esi, m.memory.read::<u32>(0x409228u32));
...
pub fn x00403b16() -> Cont {
    ...
    m.memory.write::<u32>(
        m.regs.edi,
        sub(m.memory.read::<u32>(m.regs.edi), m.regs.ebx),
    );
    // 00403b1e mov [esi+8],edi
    m.memory
        .write::<u32>(m.regs.esi.wrapping_add(0x8u32), m.regs.edi);
...
pub fn x00403b45() -> Cont {
    ...
    sub(m.memory.read::<u32>(m.regs.ebx), 0xffffffffu32);
...
pub fn x00403bab() -> Cont {
    ...
    m.memory.write::<u8>(
        ...
        or(
            m.memory.read::<u8>(m.regs.eax.wrapping_add(0xf4u32)),
            0xffu8,
        ),
    );
    // 00403bb8 lea edx,[eax+4]
    m.regs.edx = m.regs.eax.wrapping_add(0x4u32);
    // 00403bbb mov [eax-4],edx
    m.memory
        .write::<u32>(m.regs.eax.wrapping_add(0xfffffffcu32), m.regs.edx);
    // 00403bbe mov edx,0F0h
    m.regs.edx = 0xf0u32;
    // 00403bc3 mov [eax],edx
    m.memory.write::<u32>(m.regs.eax, m.regs.edx);
    // 00403bc5 mov [ecx],edx
    m.memory.write::<u32>(m.regs.ecx, m.regs.edx);
    // 00403bc7 mov dword ptr [ecx+4],0F1h
    m.memory
        .write::<u32>(m.regs.ecx.wrapping_add(0x4u32), 0xf1u32);
    // 00403bce add eax,1000h
    m.regs.eax = add(m.regs.eax, 0x1000u32);
    // 00403bd3 add ecx,8
    m.regs.ecx = add(m.regs.ecx, 0x8u32);
    // 00403bd6 dec dword ptr [ebp-4]
    m.memory.write::<u32>(
        m.regs.ebp.wrapping_add(0xfffffffcu32),
        dec(m.memory.read::<u32>(m.regs.ebp.wrapping_add(0xfffffffcu32))),
    );
...
pub fn x00403bdb() -> Cont {
    ...
    m.regs.eax = m.regs.edi.wrapping_add(0x2018u32);
...
pub fn x00403beb() -> Cont {
    ...
    sub(m.memory.read::<u32>(m.regs.ecx), 0xffffffffu32);
...
pub fn x00403bf5() -> Cont {
    ...
    m.regs.eax = and(m.regs.eax, m.regs.ecx);
    // 00403bfb mov [edi+0Ch],eax
    m.memory
        .write::<u32>(m.regs.edi.wrapping_add(0xcu32), m.regs.eax);
    // 00403bfe mov eax,[ebp+8]
    m.regs.eax = m.memory.read::<u32>(m.regs.ebp.wrapping_add(0x8u32));
    // 00403c01 mov [esi+8],al
    m.memory
        .write::<u8>(m.regs.esi.wrapping_add(0x8u32), m.regs.get_al());
    // 00403c04 mov [edi+8],ebx
    m.memory
        .write::<u32>(m.regs.edi.wrapping_add(0x8u32), m.regs.ebx);
    // 00403c07 sub [ebx],eax
    m.memory.write::<u32>(
        m.regs.ebx,
        sub(m.memory.read::<u32>(m.regs.ebx), m.regs.eax),
    );
    // 00403c09 sub [esi+4],eax
    m.memory.write::<u32>(
        m.regs.esi.wrapping_add(0x4u32),
        sub(
            m.memory.read::<u32>(m.regs.esi.wrapping_add(0x4u32)),
            m.regs.eax,
        ),
    );
    // 00403c0c lea ecx,[esi+eax+8]
    m.regs.ecx = m.regs.esi.wrapping_add(m.regs.eax).wrapping_add(0x8u32);
...
pub fn x00403c23() -> Cont {
    ...
    m.memory
        .write::<u8>(m.regs.ecx.wrapping_add(0x8u32), m.regs.get_bl());
    // 00403c29 lea edx,[ecx+ebx+8]
    m.regs.edx = m.regs.ecx.wrapping_add(m.regs.ebx).wrapping_add(0x8u32);
    ...
    m.regs.edx = sub(m.regs.edx, m.regs.ebx);
    // 00403c3b mov [ecx+4],edx
    m.memory
        .write::<u32>(m.regs.ecx.wrapping_add(0x4u32), m.regs.edx);
    // 00403c3e movzx edx,bl
    m.regs.edx = m.regs.get_bl() as _;
    // 00403c41 sub [eax+18h],edx
    m.memory.write::<u32>(
        m.regs.eax.wrapping_add(0x18u32),
        sub(
            m.memory.read::<u32>(m.regs.eax.wrapping_add(0x18u32)),
            m.regs.edx,
        ),
    );
    // 00403c44 lea eax,[ecx+100h]
    m.regs.eax = m.regs.ecx.wrapping_add(0x100u32);
...
pub fn x00403c53() -> Cont {
    ...
    m.regs.edi = m.memory.read::<u32>(m.regs.ecx);
    // 00403c65 lea ebx,[ecx+0F8h]
    m.regs.ebx = m.regs.ecx.wrapping_add(0xf8u32);
...
pub fn x00403c80() -> Cont {
    ...
    m.memory.write::<u32>(
        m.regs.ecx,
        add(m.memory.read::<u32>(m.regs.ecx), m.regs.edx),
    );
...
pub fn x00403c87() -> Cont {
    ...
    m.regs.eax = m.regs.ecx.wrapping_add(0x8u32);
...
pub fn x00403c98() -> Cont {
    ...
    sub(m.memory.read::<u8>(m.regs.esi), 0x0u8);
...
pub fn x00403ca8() -> Cont {
    ...
    m.regs.set_bl(m.memory.read::<u8>(m.regs.eax));
    // 00403caa test bl,bl
    and(m.regs.get_bl(), m.regs.get_bl());
...
pub fn x00403cae() -> Cont {
    ...
    m.regs.ebx = m.regs.eax.wrapping_add(0x1u32);
    // 00403cb3 pop esi
    m.regs.esi = pop();
    // 00403cb4 cmp byte ptr [ebx],0
    sub(m.memory.read::<u8>(m.regs.ebx), 0x0u8);
...
pub fn x00403d00() -> Cont {
    ...
    m.regs.ebx = m.regs.esi.wrapping_add(0x1u32);
    // 00403d05 pop eax
    m.regs.eax = pop();
...
pub fn x00403d17() -> Cont {
    ...
    m.memory.write::<u32>(m.regs.ecx, m.regs.ebx);
...
pub fn x00403d20() -> Cont {
    ...
    m.memory.write::<u32>(m.regs.ecx, m.regs.esi);
    // 00403d29 mov [eax],dl
...
pub fn x00403d58() -> Cont {
    ...
    m.regs.eax = m.regs.esi.wrapping_add(0x8u32);
...
pub fn x00403d9f() -> Cont {
    ...
    m.regs.ecx = sub(m.regs.ecx, m.regs.eax);
    // 00403da4 mov [edx],al
    m.memory.write::<u8>(m.regs.edx, m.regs.get_al());
    // 00403da6 add [edi],ecx
    m.memory.write::<u32>(
        m.regs.edi,
        add(m.memory.read::<u32>(m.regs.edi), m.regs.ecx),
    );
    // 00403da8 mov dword ptr [edi+4],0F1h
    m.memory
        .write::<u32>(m.regs.edi.wrapping_add(0x4u32), 0xf1u32);
...
pub fn x00403def() -> Cont {
    ...
    m.memory.write::<u32>(m.regs.ebx, m.regs.esi);
    // 00403df3 cmp [esi],al
    sub(m.memory.read::<u8>(m.regs.esi), m.regs.get_al());
...
pub fn x00403df7() -> Cont {
    ...
    sub(
        m.memory.read::<u8>(m.regs.esi.wrapping_add(m.regs.eax)),
        0x0u8,
    );
...
pub fn x00403e03() -> Cont {
    ...
    m.regs.eax = m.regs.ebx.wrapping_add(0x8u32);
...
pub fn x00403e29() -> Cont {
    ...
    push(m.memory.read::<u32>(m.regs.esp.wrapping_add(0x4u32)));
    // 00403e2d call eax
    call(0x403e2f, indirect(m.regs.eax))
}
...
pub fn x00403e7c() -> Cont {
    ...
    m.regs.edx = 0x3u32;
    // 00403e83 sub ecx,4
    m.regs.ecx = sub(m.regs.ecx, 0x4u32);
...
pub fn x00403e88() -> Cont {
    ...
    let m = unsafe { &mut MACHINE };
    // 00403e88 and eax,3
    m.regs.eax = and(m.regs.eax, 0x3u32);
...
pub fn x00404186() -> Cont {
    ...
    m.regs
        .set_cl(m.memory.read::<u8>(m.regs.esp.wrapping_add(0xcu32)));
    // 0040418f test [eax+409861h],cl
    and(
        m.memory.read::<u8>(m.regs.eax.wrapping_add(0x409861u32)),
        m.regs.get_cl(),
    );
...
pub fn x0040419e() -> Cont {
    ...
    m.regs.eax = m
        .memory
        .read::<u16>((m.regs.eax * 2).wrapping_add(0x40933au32)) as _;
...
pub fn x004041b7() -> Cont {
    ...
    m.regs.esp = sub(m.regs.esp, 0x18u32);
    // 004041bd push ebx
    push(m.regs.ebx);
    // 004041be push esi
    push(m.regs.esi);
...
pub fn x004041c8() -> Cont {
    ...
    sub(m.regs.esi, m.memory.read::<u32>(0x409748u32));
    // 004041d1 mov [ebp+8],esi
    m.memory
        .write::<u32>(m.regs.ebp.wrapping_add(0x8u32), m.regs.esi);
...
pub fn x004041e4() -> Cont {
    ...
    m.regs.eax = 0x409238u32;
    // 004041eb cmp [eax],esi
    sub(m.memory.read::<u32>(m.regs.eax), m.regs.esi);
...
pub fn x004041ef() -> Cont {
    ...
    m.regs.eax = add(m.regs.eax, 0x30u32);
    // 004041f2 inc edx
    m.regs.edx = inc(m.regs.edx);
    // 004041f3 cmp eax,409328h
    sub(m.regs.eax, 0x409328u32);
...
pub fn x00404295() -> Cont {
    ...
    m.regs
        .set_dl(m.memory.read::<u8>(m.regs.edx.wrapping_add(0x409230u32)));
...
pub fn x004042a9() -> Cont {
    ...
    sub(m.memory.read::<u8>(m.regs.ecx), 0x0u8);
...
pub fn x004042b0() -> Cont {
    ...
    // 004042b3 add ebx,8
    m.regs.ebx = add(m.regs.ebx, 0x8u32);
...
pub fn x004042bc() -> Cont {
    ...
    m.memory.write::<u32>(0x409748u32, m.regs.eax);
...
pub fn x004042ea() -> Cont {
    ...
    sub(
        m.memory.read::<u8>(m.regs.ecx.wrapping_add(0xffffffffu32)),
        0x0u8,
    );
...
pub fn x00404332() -> Cont {
    ...
    sub(m.memory.read::<u32>(0x409710u32), m.regs.ebx);
...
pub fn x00404350() -> Cont {
    ...
    m.memory
        .write::<u32>(0x409710u32, and(m.memory.read::<u32>(0x409710u32), 0x0u32));
    // 0040435b cmp eax,0FFFFFFFEh
    sub(m.regs.eax, 0xfffffffeu32);
...
pub fn x0040439a() -> Cont {
    ...
    m.regs.eax = sub(m.regs.eax, 0x3a4u32);
...
pub fn x004043a5() -> Cont {
    ...
    let m = unsafe { &mut MACHINE };
    // 004043a5 sub eax,4
    m.regs.eax = sub(m.regs.eax, 0x4u32);
...
pub fn x004043aa() -> Cont {
    ...
    m.regs.eax = sub(m.regs.eax, 0xdu32);
...
pub fn x004043cd() -> Cont {
    ...
    m.memory.write::<u32>(0x40975cu32, m.regs.eax);
...
pub fn x004043f6() -> Cont {
    ...
    m.regs.esp = sub(m.regs.esp, 0x514u32);
    // 004043ff lea eax,[ebp-14h]
    m.regs.eax = m.regs.ebp.wrapping_add(0xffffffecu32);
    // 00404402 push esi
    push(m.regs.esi);
    // 00404403 push eax
    push(m.regs.eax);
    // 00404404 push dword ptr ds:[409748h]
    push(m.memory.read::<u32>(0x409748u32));
...
pub fn x0040442c() -> Cont {
    ...
    m.memory
        .write::<u8>(m.regs.ebp.wrapping_add(0xfffffeecu32), 0x20u8);
    // 00404436 test al,al
    and(m.regs.get_al(), m.regs.get_al());
...
pub fn x0040443a() -> Cont {
    ...
    m.regs.edx = m.regs.ebp.wrapping_add(0xfffffff3u32);
...
pub fn x00404449() -> Cont {
    ...
    m.regs
        .set_al(m.memory.read::<u8>(m.regs.edx.wrapping_add(0xffffffffu32)));
    // 0040446b test al,al
    and(m.regs.get_al(), m.regs.get_al());
...
pub fn x0040446f() -> Cont {
    ...
    m.regs.eax = m.regs.ebp.wrapping_add(0xfffffaecu32);
    // 00404479 push dword ptr ds:[409964h]
    push(m.memory.read::<u32>(0x409964u32));
    // 0040447f push dword ptr ds:[409748h]
    push(m.memory.read::<u32>(0x409748u32));
    // 00404485 push eax
    push(m.regs.eax);
    // 00404486 lea eax,[ebp-114h]
    m.regs.eax = m.regs.ebp.wrapping_add(0xfffffeecu32);
    // 0040448c push esi
    push(m.regs.esi);
    // 0040448d push eax
    push(m.regs.eax);
...
pub fn x00404495() -> Cont {
    ...
    m.regs.eax = m.regs.ebp.wrapping_add(0xfffffdecu32);
...
pub fn x004044b9() -> Cont {
    ...
    m.regs.eax = m.regs.ebp.wrapping_add(0xfffffcecu32);
...
pub fn x004044e1() -> Cont {
    ...
    m.regs.esp = add(m.regs.esp, 0x5cu32);
    // 004044e4 xor eax,eax
    m.regs.eax = xor(m.regs.eax, m.regs.eax);
    // 004044e6 lea ecx,[ebp-514h]
    m.regs.ecx = m.regs.ebp.wrapping_add(0xfffffaecu32);
    // 004044ec mov dx,[ecx]
...
pub fn x0040451f() -> Cont {
    ...
    m.memory.write::<u8>(
        ...
        and(
            m.memory.read::<u8>(m.regs.eax.wrapping_add(0x409760u32)),
            0x0u8,
        ),
    );
    // 00404526 inc eax
...
pub fn x00404540() -> Cont {
    ...
    m.regs.set_cl(m.regs.get_al());
    // 00404549 add cl,20h
    m.regs.set_cl(add(m.regs.get_cl(), 0x20u8));
...
pub fn x0040455e() -> Cont {
    ...
    m.regs.set_cl(m.regs.get_al());
    // 00404567 sub cl,20h
    m.regs.set_cl(sub(m.regs.get_cl(), 0x20u8));
...
pub fn x004045a0() -> Cont {
    ...
    m.regs.edi = m.memory.read::<u32>(m.regs.esp.wrapping_add(0x8u32));
...
pub fn x004045eb() -> Cont {
    ...
    let m = unsafe { &mut MACHINE };
    // 004045eb test ah,ah
    and(m.regs.get_ah(), m.regs.get_ah());
...
pub fn x00404654() -> Cont {
    ...
    let m = unsafe { &mut MACHINE };
    // 00404654 test dh,dh
    and(m.regs.get_dh(), m.regs.get_dh());
...
pub fn x00404672() -> Cont {
    ...
    m.memory.write::<u8>(m.regs.edi.wrapping_add(0x2u32), 0x0u8);
    // 0040467d pop edi
    m.regs.edi = pop();
    // 0040467e ret
    ret(0)
...
pub fn x004046ab() -> Cont {
    ...
    let m = unsafe { &mut MACHINE };
    // 004046ab add eax,0
    m.regs.eax = add(m.regs.eax, 0x0u32);
...
pub fn x00404722() -> Cont {
    ...
    m.regs.edi = m.memory.read::<u32>(m.regs.ebp.wrapping_add(0x8u32));
    // 00404732 mov bl,[edi]
    m.regs.set_bl(m.memory.read::<u8>(m.regs.edi));
    // 00404734 lea esi,[edi+1]
    m.regs.esi = m.regs.edi.wrapping_add(0x1u32);
    // 00404737 mov [ebp-4],esi
    m.memory
        .write::<u32>(m.regs.ebp.wrapping_add(0xfffffffcu32), m.regs.esi);
    // 0040473a cmp dword ptr ds:[40953Ch],1
    sub(m.memory.read::<u32>(0x40953cu32), 0x1u32);
...
pub fn x00404752() -> Cont {
    ...
    m.regs.set_al(
        m.memory
            .read::<u8>(m.regs.ecx.wrapping_add((m.regs.eax * 2))),
    );
    // 0040475e and eax,8
    m.regs.eax = and(m.regs.eax, 0x8u32);
...
pub fn x0040480f() -> Cont {
    ...
    m.regs.set_al(
        m.memory
            .read::<u8>(m.regs.eax.wrapping_add((m.regs.esi * 2))),
    );
    // 00404817 and eax,4
    m.regs.eax = and(m.regs.eax, 0x4u32);
...
pub fn x0040481e() -> Cont {
    ...
    m.regs.ecx = sub(m.regs.ecx, 0x30u32);
...
pub fn x0040483a() -> Cont {
    ...
    m.regs.set_ax(
        m.memory
            .read::<u16>(m.regs.eax.wrapping_add((m.regs.esi * 2))),
    );
    // 00404843 and eax,edi
    m.regs.eax = and(m.regs.eax, m.regs.edi);
...
pub fn x00404852() -> Cont {
    ...
    m.regs.ecx = sub(m.regs.ecx, 0x37u32);
...
pub fn x004048b1() -> Cont {
    ...
    let m = unsafe { &mut MACHINE };
    // 004048b1 test cl,4
    and(m.regs.get_cl(), 0x4u8);
    // 004048b4 mov eax,7FFFFFFFh
    m.regs.eax = 0x7fffffffu32;
...
pub fn x004048c0() -> Cont {
    ...
    let m = unsafe { &mut MACHINE };
    // 004048c0 and ecx,2
    m.regs.ecx = and(m.regs.ecx, 0x2u32);
...
pub fn x004048d7() -> Cont {
    ...
    and(m.memory.read::<u8>(m.regs.ebp.wrapping_add(0x14u32)), 0x1u8);
...
pub fn x004048ed() -> Cont {
    ...
    m.regs.ecx = m.memory.read::<u32>(m.regs.ebp.wrapping_add(0x14u32));
    // 004048f0 and cl,2
    m.regs.set_cl(and(m.regs.get_cl(), 0x2u8));
    // 004048f3 neg cl
    m.regs.set_cl(neg(m.regs.get_cl()));
    // 004048f5 sbb ecx,ecx
    m.regs.ecx = sbb(m.regs.ecx, m.regs.ecx);
    // 004048f7 neg ecx
    m.regs.ecx = neg(m.regs.ecx);
...
pub fn x00404902() -> Cont {
    ...
    and(m.memory.read::<u8>(m.regs.ebp.wrapping_add(0x14u32)), 0x2u8);
...
pub fn x00404940() -> Cont {
    ...
    m.regs
        .set_al(m.memory.read::<u8>(m.regs.esp.wrapping_add(0x8u32)));
    // 00404946 push ebx
    push(m.regs.ebx);
...
pub fn x00404958() -> Cont {
    ...
    m.regs.edx = inc(m.regs.edx);
    // 0040495b cmp cl,bl
    sub(m.regs.get_cl(), m.regs.get_bl());
...
pub fn x0040495f() -> Cont {
    ...
    let m = unsafe { &mut MACHINE };
    // 0040495f test cl,cl
    and(m.regs.get_cl(), m.regs.get_cl());
...
pub fn x0040496b() -> Cont {
    ...
    let m = unsafe { &mut MACHINE };
    // 0040496b or ebx,eax
    m.regs.ebx = or(m.regs.ebx, m.regs.eax);
    // 0040496d push edi
    push(m.regs.edi);
...
pub fn x0040499c() -> Cont {
    ...
    m.regs.eax = and(m.regs.eax, 0x81010100u32);
...
pub fn x004049a3() -> Cont {
    ...
    m.regs.eax = and(m.regs.eax, 0x1010100u32);
...
pub fn x004049aa() -> Cont {
    ...
    m.regs.esi = and(m.regs.esi, 0x80000000u32);
...
pub fn x004049c3() -> Cont {
    ...
    let m = unsafe { &mut MACHINE };
    // 004049c3 cmp ah,bl
    sub(m.regs.get_ah(), m.regs.get_bl());
...
pub fn x00404a00() -> Cont {
    ...
    m.regs.edi = m.memory.read::<u32>(m.regs.esp.wrapping_add(0x10u32));
    // 00404a0d test dl,dl
    and(m.regs.get_dl(), m.regs.get_dl());
...
pub fn x00404a18() -> Cont {
    ...
    m.regs.ecx = m.memory.read::<u32>(m.regs.esp.wrapping_add(0x14u32));
    // 00404a1e mov al,[edi]
    m.regs.set_al(m.memory.read::<u8>(m.regs.edi));
    // 00404a20 inc esi
    m.regs.esi = inc(m.regs.esi);
    // 00404a21 cmp al,dl
    sub(m.regs.get_al(), m.regs.get_dl());
...
pub fn x00404a3a() -> Cont {
    ...
    m.regs.esi = inc(m.regs.esi);
    // 00404a3d cmp al,dh
    sub(m.regs.get_al(), m.regs.get_dh());
...
pub fn x00404a4b() -> Cont {
    ...
    m.regs.set_al(m.memory.read::<u8>(m.regs.esi));
    // 00404a4d add esi,2
    m.regs.esi = add(m.regs.esi, 0x2u32);
    // 00404a50 cmp al,ah
    sub(m.regs.get_al(), m.regs.get_ah());
...
pub fn x00404a5b() -> Cont {
    ...
    // 00404a5e add ecx,2
    m.regs.ecx = add(m.regs.ecx, 0x2u32);
    // 00404a61 cmp al,ah
    sub(m.regs.get_al(), m.regs.get_ah());
...
pub fn x00404a8b() -> Cont {
    ...
    sub(
        m.regs.get_al(),
        m.memory.read::<u8>(m.regs.edi.wrapping_add(0xffffffffu32)),
    );
...
pub fn x00404ac0() -> Cont {
    ...
    sub(m.regs.eax, 0x1000u32);
    // 00404ac6 lea ecx,[esp+8]
    m.regs.ecx = m.regs.esp.wrapping_add(0x8u32);
...
pub fn x00404acc() -> Cont {
    ...
    m.regs.ecx = sub(m.regs.ecx, 0x1000u32);
    // 00404ad2 sub eax,1000h
    m.regs.eax = sub(m.regs.eax, 0x1000u32);
    // 00404ad7 test [ecx],eax
    and(m.memory.read::<u32>(m.regs.ecx), m.regs.eax);
...
pub fn x00404ae0() -> Cont {
    ...
    m.regs.eax = m.regs.esp;
    // 00404ae4 test [ecx],eax
    and(m.memory.read::<u32>(m.regs.ecx), m.regs.eax);
    // 00404ae6 mov esp,ecx
    m.regs.esp = m.regs.ecx;
    // 00404ae8 mov ecx,[eax]
    m.regs.ecx = m.memory.read::<u32>(m.regs.eax);
    // 00404aea mov eax,[eax+4]
    m.regs.eax = m.memory.read::<u32>(m.regs.eax.wrapping_add(0x4u32));
    // 00404aed push eax
    push(m.regs.eax);
    // 00404aee ret
    ret(0)
...
pub fn x00404aef() -> Cont {
    ...
    sub(m.memory.read::<u32>(0x409714u32), m.regs.ebx);
    // 00404af8 push esi
    push(m.regs.esi);
    // 00404af9 push edi
    push(m.regs.edi);
...
pub fn x00404b0d() -> Cont {
    ...
    push(m.regs.edi);
    // 00404b19 call esi
    call(0x404b1b, indirect(m.regs.esi))
}
...
pub fn x00404b1b() -> Cont {
    ...
    m.memory.write::<u32>(0x409714u32, m.regs.eax);
...
pub fn x00404b24() -> Cont {
    ...
    push(m.regs.edi);
    // 00404b2a call esi
    call(0x404b2c, indirect(m.regs.esi))
}
...
pub fn x00404b2c() -> Cont {
    ...
    m.memory.write::<u32>(0x409718u32, m.regs.eax);
    // 00404b37 call esi
    call(0x404b39, indirect(m.regs.esi))
}
...
pub fn x00404b47() -> Cont {
    ...
    let m = unsafe { &mut MACHINE };
    // 00404b47 call eax
    call(0x404b49, indirect(m.regs.eax))
}
...
pub fn x00404b58() -> Cont {
    ...
    push(m.regs.ebx);
    // 00404b59 call eax
    call(0x404b5b, indirect(m.regs.eax))
}
...
pub fn x00404b5b() -> Cont {
    ...
    push(m.memory.read::<u32>(m.regs.esp.wrapping_add(0x18u32)));
    ...
    call(0x404b70, indirect(m.memory.read(0x409714u32)))
}
...
pub fn x00404b89() -> Cont {
    ...
    m.regs.esi = m.memory.read::<u32>(m.regs.esp.wrapping_add(0x14u32));
    // 00404b91 test esi,3
    and(m.regs.esi, 0x3u32);
...
pub fn x00404bc0() -> Cont {
    ...
    let m = unsafe { &mut MACHINE };
    // 00404bc0 and ebx,3
    m.regs.ebx = and(m.regs.ebx, 0x3u32);
...
pub fn x00404c11() -> Cont {
    ...
    m.regs.edx = m.memory.read::<u32>(m.regs.esi);
    // 00404c21 add esi,4
    m.regs.esi = add(m.regs.esi, 0x4u32);
...
pub fn x00404c47() -> Cont {
    ...
    m.regs.edx = and(m.regs.edx, 0xffffu32);
...
pub fn x00405018() -> Cont {
    ...
    sub(m.memory.read::<u32>(0x409740u32), m.regs.edi);
...
pub fn x0040509e() -> Cont {
    ...
    m.memory
        .write::<u32>(m.regs.ebp.wrapping_add(0x14u32), m.regs.eax);
...
pub fn x004050d8() -> Cont {
    ...
    m.memory
        .write::<u32>(m.regs.ebp.wrapping_add(0x20u32), m.regs.eax);
    // 004050e0 push edi
    push(m.regs.edi);
    // 004050e1 push edi
    push(m.regs.edi);
    ...
    m.regs.eax = m.memory.read::<u32>(m.regs.ebp.wrapping_add(0x24u32));
    // 004050eb neg eax
    m.regs.eax = neg(m.regs.eax);
...
pub fn x004050fd() -> Cont {
    ...
    m.memory
        .write::<u32>(m.regs.ebp.wrapping_add(0xffffffe4u32), m.regs.ebx);
...
pub fn x0040510a() -> Cont {
    ...
    m.regs.eax = m.regs.ebx.wrapping_add(m.regs.ebx);
    // 00405110 add eax,3
    m.regs.eax = add(m.regs.eax, 0x3u32);
    // 00405113 and al,0FCh
    m.regs.set_al(and(m.regs.get_al(), 0xfcu8));
...
pub fn x0040512c() -> Cont {
    ...
    m.regs.ebx = m.memory.read::<u32>(m.regs.ebp.wrapping_add(0xffffffe4u32));
...
pub fn x00405140() -> Cont {
    ...
    push(m.memory.read::<u32>(m.regs.ebp.wrapping_add(0xffffffdcu32)));
...
pub fn x0040516b() -> Cont {
    ...
    m.memory
        .write::<u32>(m.regs.ebp.wrapping_add(0xffffffd8u32), m.regs.esi);
...
pub fn x00405174() -> Cont {
    ...
    and(m.memory.read::<u8>(m.regs.ebp.wrapping_add(0xdu32)), 0x4u8);
...
pub fn x004051a6() -> Cont {
    ...
    m.memory.write::<u32>(m.regs.fs_base, m.regs.ecx);
    // 004051b5 pop edi
    m.regs.edi = pop();
    // 004051b6 pop esi
    m.regs.esi = pop();
...
pub fn x004051ba() -> Cont {
    ...
    m.regs.eax = m.regs.esi.wrapping_add(m.regs.esi);
    // 004051c4 add eax,3
    m.regs.eax = add(m.regs.eax, 0x3u32);
...
pub fn x004051ce() -> Cont {
    ...
    m.regs.ebx = m.regs.esp;
    // 004051d3 mov [ebp-20h],ebx
    m.memory
        .write::<u32>(m.regs.ebp.wrapping_add(0xffffffe0u32), m.regs.ebx);
...
pub fn x004051f2() -> Cont {
    ...
    push(m.memory.read::<u32>(m.regs.ebp.wrapping_add(0xffffffe4u32)));
...
pub fn x0040523c() -> Cont {
    ...
    m.regs.ecx = m.regs.edx.wrapping_add(0xffffffffu32);
...
pub fn x00405267() -> Cont {
    ...
    m.regs.eax = m.memory.read::<u32>(0x409744u32);
...
pub fn x0040530d() -> Cont {
    ...
    m.memory
        .write::<u32>(m.regs.ebp.wrapping_add(0x18u32), m.regs.eax);
    // 00405315 push ebx
    push(m.regs.ebx);
    // 00405316 push ebx
    push(m.regs.ebx);
...
pub fn x0040534b() -> Cont {
    ...
    m.regs.esi = m.regs.esp;
    // 00405350 mov [ebp-24h],esi
    m.memory
        .write::<u32>(m.regs.ebp.wrapping_add(0xffffffdcu32), m.regs.esi);
    // 00405353 push edi
    push(m.regs.edi);
    // 00405354 push ebx
    push(m.regs.ebx);
...
pub fn x00405373() -> Cont {
    ...
    push(m.memory.read::<u32>(m.regs.ebp.wrapping_add(0xffffffe0u32)));
    // 00405376 push esi
    push(m.regs.esi);
...
pub fn x004053b0() -> Cont {
    ...
    sub(m.memory.read::<u32>(0x409728u32), 0x0u32);
    // 004053bb push ebx
    push(m.regs.ebx);
...
pub fn x004053fb() -> Cont {
    ...
    m.regs.set_al(
        m.memory
            .read::<u8>(m.regs.eax.wrapping_add((m.regs.ebx * 2))),
    );
    // 00405403 and eax,2
    m.regs.eax = and(m.regs.eax, 0x2u32);
...
pub fn x00405423() -> Cont {
    ...
    m.memory.write::<u8>(
        ...
        and(m.memory.read::<u8>(m.regs.ebp.wrapping_add(0xau32)), 0x0u8),
    );
    // 00405427 mov [ebp+8],al
    m.memory
        .write::<u8>(m.regs.ebp.wrapping_add(0x8u32), m.regs.get_al());
    // 0040542a mov [ebp+9],bl
    m.memory
        .write::<u8>(m.regs.ebp.wrapping_add(0x9u32), m.regs.get_bl());
    // 0040542d push 2
    push(0x2u32);
...
pub fn x00405431() -> Cont {
    ...
    m.memory.write::<u8>(
        ...
        and(m.memory.read::<u8>(m.regs.ebp.wrapping_add(0x9u32)), 0x0u8),
    );
    // 00405435 mov [ebp+8],bl
    m.memory
        .write::<u8>(m.regs.ebp.wrapping_add(0x8u32), m.regs.get_bl());
    // 00405438 push 1
    push(0x1u32);
    // 0040543a pop eax
    m.regs.eax = pop();
    // 0040543b lea ecx,[ebp-4]
    m.regs.ecx = m.regs.ebp.wrapping_add(0xfffffffcu32);
    // 0040543e push 1
    push(0x1u32);
    // 00405440 push 0
    push(0x0u32);
    ...
    push(m.memory.read::<u32>(0x409728u32));
...
pub fn x0040545a() -> Cont {
    ...
    m.regs.esp = add(m.regs.esp, 0x20u32);
...
pub fn x0040548e() -> Cont {
    ...
    m.regs.eax = m
        .memory
        .read::<u16>(m.regs.ecx.wrapping_add((m.regs.eax * 2))) as _;
...
pub fn x004054b1() -> Cont {
    ...
    m.memory.write::<u8>(
        ...
        and(
            m.memory.read::<u8>(m.regs.ebp.wrapping_add(0xfffffffeu32)),
            0x0u8,
        ),
    );
    // 004054b5 mov [ebp-4],cl
    m.memory
        .write::<u8>(m.regs.ebp.wrapping_add(0xfffffffcu32), m.regs.get_cl());
    // 004054b8 mov [ebp-3],al
    m.memory
        .write::<u8>(m.regs.ebp.wrapping_add(0xfffffffdu32), m.regs.get_al());
    // 004054bb push 2
    push(0x2u32);
...
pub fn x004054bf() -> Cont {
    ...
    m.memory.write::<u8>(
        ...
        and(
            m.memory.read::<u8>(m.regs.ebp.wrapping_add(0xfffffffdu32)),
            0x0u8,
        ),
    );
    // 004054c3 mov [ebp-4],al
    m.memory
        .write::<u8>(m.regs.ebp.wrapping_add(0xfffffffcu32), m.regs.get_al());
    // 004054c6 push 1
    push(0x1u32);
    // 004054c8 pop eax
    m.regs.eax = pop();
    // 004054c9 lea ecx,[ebp+0Ah]
    m.regs.ecx = m.regs.ebp.wrapping_add(0xau32);
    // 004054cc push 1
    push(0x1u32);
    // 004054ce push 0
    push(0x0u32);
